<?php
/**
 * Font Awesome plugin integration for MSPress.
 *
 * @package FontAwesome
 * @textdomain mspress
...
namespace MSPress\Includes\Plugins\FontAwesome;
...
use MSPress\Includes\Plugins\FontAwesome\Includes\Core\I18n;
use MSPress\Includes\Plugins\FontAwesome\Includes\Includes;
use MSPress\Includes\Core\WP\Activator;
...
final class FontAwesome implements PluginInterface, SettingsProviderInterface, SettingsPageProviderInterface, AssetsProviderInterface, I18nProviderInterface {
    ...
    public function get_description(): string {
        return __( 'Provides Font Awesome enqueueing in Admin, Frontend, Login Page, icon picking, and styling APIs for MSPress.', 'mspress' );
    }
    /**
     * Get the plugin URI.
     *
    ...
    public function get_uri(): string {
        return 'https://trilb.dev/collection/web-extension/wordpress/mspress';
    }
    /**
     ...
     *
     * WordPress FontAwesome wins first, and MSPress reuses that namespace and

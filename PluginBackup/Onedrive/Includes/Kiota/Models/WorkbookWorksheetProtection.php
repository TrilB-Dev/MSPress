...
{
    /**
     * @var bool|null $escapedProtected Indicates whether the worksheet is protected.  Read-only.
    */
    private ?bool $escapedProtected = null;
    
    /**
     * @var WorkbookWorksheetProtectionOptions|null $options Worksheet protection options. Read-only.
    */

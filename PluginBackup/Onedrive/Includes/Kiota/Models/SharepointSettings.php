...
class SharepointSettings extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var ImageTaggingChoice|null $imageTaggingOption Specifies the image tagging option for the tenant. The possible values are: disabled, basic, enhanced.
    */
    ...
    */
    ...
    /**
     * @var bool|null $isLoopEnabled Indicates whether if Fluid Framework is allowed on SharePoint sites.
    */
    ...
    */
    ...
    /**
     * @var SharingCapabilities|null $sharingCapability Sharing capability for the tenant. The possible values are: disabled, externalUserSharingOnly, externalUserAndGuestSharing, existingExternalUserSharingOnly.
    */
    private ?SharingCapabilities $sharingCapability = null;
    
    /**
     * @var SharingDomainRestrictionMode|null $sharingDomainRestrictionMode Specifies the external sharing mode for domains. The possible values are: none, allowList, blockList.
    */
    ...
    */
    ...
    /**
     * @var string|null $tenantDefaultTimezone The default timezone of a tenant for newly created sites. For a list of possible values, see SPRegionalSettings.TimeZones property.
    */

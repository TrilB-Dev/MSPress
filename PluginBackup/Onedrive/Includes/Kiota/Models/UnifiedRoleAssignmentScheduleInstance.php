...
{
    /**
     * @var UnifiedRoleEligibilityScheduleInstance|null $activatedUsing If the request is from an eligible administrator to activate a role, this parameter shows the related eligible assignment for that activation. Otherwise, it's null. Supports $expand and $select nested in $expand.
    */
    private ?UnifiedRoleEligibilityScheduleInstance $activatedUsing = null;
    
    /**
     * @var string|null $assignmentType The type of the assignment that can either be Assigned or Activated. Supports $filter (eq, ne).
    */
    ...
    */
    ...
    /**
     * @var string|null $memberType How the assignment is inherited. It can either be Inherited, Direct, or Group. It can further imply whether the unifiedRoleAssignmentSchedule can be managed by the caller. Supports $filter (eq, ne).
    */
    private ?string $memberType = null;
    
    /**
     * @var string|null $roleAssignmentOriginId The identifier of the role assignment in Microsoft Entra. Supports $filter (eq, ne).
    */
    private ?string $roleAssignmentOriginId = null;
    
    /**
     * @var string|null $roleAssignmentScheduleId The identifier of the unifiedRoleAssignmentSchedule object from which this instance was created. Supports $filter (eq, ne).
    */

...
class EdiscoverySearch extends Search implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DataSourceScopes|null $dataSourceScopes When specified, the collection spans across a service for an entire workload. The possible values are: none, allTenantMailboxes, allTenantSites, allCaseCustodians, allCaseNoncustodialDataSources.
    */

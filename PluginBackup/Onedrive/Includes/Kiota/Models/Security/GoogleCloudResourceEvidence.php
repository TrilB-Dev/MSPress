...
{
    /**
     * @var string|null $fullResourceName The fullResourceName property
    */
    private ?string $fullResourceName = null;
    
    /**
     * @var string|null $location The zone or region where the resource is located.
    */
    private ?string $location = null;
    
    /**
     * @var GoogleCloudLocationType|null $locationType The type of location. The possible values are: unknown, regional, zonal, global, unknownFutureValue.
    */
    private ?GoogleCloudLocationType $locationType = null;
    
    /**
     * @var string|null $projectId The Google project ID as defined by the user.
    */
    private ?string $projectId = null;
    
    /**
     * @var int|null $projectNumber The project number assigned by Google.
    */

...
use MSPress\Includes\Plugins\OneDrive\Includes\Kiota\Models\Group;
...
class UnifiedGroupSource extends DataSource implements Parsable 
{
    ...
    */
    ...
    /**
     * @var SourceType|null $includedSources Specifies which sources are included in this group. The possible values are: mailbox, site.
    */

...
{
    /**
     * @var WorkbookFilter|null $filter The filter applied to the column. Read-only.
    */
    private ?WorkbookFilter $filter = null;
    
    /**
     * @var int|null $index The index of the column within the columns collection of the table. Zero-indexed. Read-only.
    */
    private ?int $index = null;
    
    /**
     * @var string|null $name The name of the table column.
    */

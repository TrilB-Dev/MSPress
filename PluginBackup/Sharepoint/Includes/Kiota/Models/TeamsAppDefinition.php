...
{
    /**
     * @var TeamsAppAuthorization|null $authorization Authorization requirements specified in the Teams app manifest.
    */
    private ?TeamsAppAuthorization $authorization = null;

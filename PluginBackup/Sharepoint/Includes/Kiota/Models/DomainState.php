...
class DomainState implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $status Current status of the operation.  Scheduled - Operation is scheduled but hasn't started.  InProgress - Task is in progress.  Failed - The operation failed.
    */

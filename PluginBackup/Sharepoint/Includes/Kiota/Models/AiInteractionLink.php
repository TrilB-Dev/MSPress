...
class AiInteractionLink implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $linkType The linkType property
    */
    private ?string $linkType = null;
    
    /**
     * @var string|null $linkUrl The linkUrl property
    */

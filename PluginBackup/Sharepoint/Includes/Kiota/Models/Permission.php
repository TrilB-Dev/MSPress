...
{
    /**
     * @var DateTime|null $expirationDateTime A format of yyyy-MM-ddTHH:mm:ssZ of DateTimeOffset indicates the expiration time of the permission. DateTime.MinValue indicates there's no expiration set for this permission. Optional.
    */
    private ?DateTime $expirationDateTime = null;
    
    /**
     * @var IdentitySet|null $grantedTo For user type permissions, the details of the users and applications for this permission. Read-only.
    */
    private ?IdentitySet $grantedTo = null;
    
    /**
     * @var array<IdentitySet>|null $grantedToIdentities For type permissions, the details of the users to whom permission was granted. Read-only.
    */
    ...
    */
    ...
    /**
     * @var ItemReference|null $inheritedFrom Provides a reference to the ancestor of the current permission, if it's inherited from an ancestor. Read-only.
    */
    ...
    */
    ...
    /**
     * @var SharingLink|null $link Provides the link details of the current permission, if it's a link type permission. Read-only.
    */

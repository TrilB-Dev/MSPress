...
{
    /**
     * @var PrivilegedAccessGroupRelationships|null $accessId The identifier of the membership or ownership eligibility to the group that is governed by PIM. Required. The possible values are: owner, member. Supports $filter (eq).
    */
    ...
    */
    ...
    /**
     * @var PrivilegedAccessGroupMemberType|null $memberType Indicates whether the assignment is derived from a group assignment. It can further imply whether the caller can manage the schedule. Required. The possible values are: direct, group, unknownFutureValue. Supports $filter (eq).
    */
    private ?PrivilegedAccessGroupMemberType $memberType = null;
    
    /**
     * @var DirectoryObject|null $principal References the principal that's in the scope of this membership or ownership eligibility request to the group that's governed by PIM. Supports $expand.
    */
    private ?DirectoryObject $principal = null;
    
    /**
     * @var string|null $principalId The identifier of the principal whose membership or ownership eligibility is granted through PIM for Groups. Required. Supports $filter (eq).
    */

...
{
    /**
     * @var string|null $primaryMailboxId The unique identifier for the user's primary mailbox.
    */
    private ?string $primaryMailboxId = null;

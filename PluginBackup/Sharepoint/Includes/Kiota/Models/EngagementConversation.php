...
class EngagementConversation extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<EngagementConversationMessage>|null $messages The messages in a Viva Engage conversation.
    */
    private ?array $messages = null;
    
    /**
     * @var EngagementConversationMessage|null $starter The starter property
    */
    private ?EngagementConversationMessage $starter = null;
    
    /**
     * @var string|null $starterId The unique ID of the first message in a Viva Engage conversation.
    */

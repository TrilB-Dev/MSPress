...
class LoginPageLayoutConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $isFooterShown Option to show the footer on the sign-in page.
    */
    private ?bool $isFooterShown = null;
    
    /**
     * @var bool|null $isHeaderShown Option to show the header on the sign-in page.
    */
    private ?bool $isHeaderShown = null;
    
    /**
     * @var LayoutTemplateType|null $layoutTemplateType Represents the layout template to be displayed on the login page for a tenant. The possible values are  default - Represents the default Microsoft layout with a centered lightbox.  verticalSplit - Represents a layout with a background on the left side and a full-height lightbox to the right.  unknownFutureValue - Evolvable enumeration sentinel value. Don't use.
    */
    private ?LayoutTemplateType $layoutTemplateType = null;

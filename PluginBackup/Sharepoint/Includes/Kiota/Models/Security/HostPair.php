...
{
    /**
     * @var Host|null $childHost The childHost property
    */
    private ?Host $childHost = null;
    
    /**
     * @var DateTime|null $firstSeenDateTime The date and time when Microsoft Defender Threat Intelligence first observed the hostPair. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $firstSeenDateTime = null;
    
    /**
     * @var DateTime|null $lastSeenDateTime The date and time when Microsoft Defender Threat Intelligence last observed the hostPair. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $lastSeenDateTime = null;
    
    /**
     * @var string|null $linkKind The reason that two hosts are identified as hostPair.
    */
    private ?string $linkKind = null;

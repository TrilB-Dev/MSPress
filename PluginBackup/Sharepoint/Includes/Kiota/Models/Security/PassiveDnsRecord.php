...
class PassiveDnsRecord extends Artifact implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $collectedDateTime The date and time that this passiveDnsRecord entry was collected by Microsoft. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $collectedDateTime = null;
    
    /**
     * @var DateTime|null $firstSeenDateTime The date and time when this passiveDnsRecord entry was first seen. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $firstSeenDateTime = null;
    
    /**
     * @var DateTime|null $lastSeenDateTime The date and time when this passiveDnsRecord entry was most recently seen. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $lastSeenDateTime = null;
    
    /**
     * @var Host|null $parentHost The parentHost property
    */
    private ?Host $parentHost = null;
    
    /**
     * @var string|null $recordType The DNS record type for this passiveDnsRecord entry.
    */

...
class ProcessEvidence extends AlertEvidence implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $parentProcessCreationDateTime Date and time when the parent of the process was created. The DateTimeOffset type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $processCreationDateTime Date and time when the process was created. The DateTimeOffset type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */

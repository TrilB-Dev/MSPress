...
{
    /**
     * @var string|null $citationJurisdiction Represents the jurisdiction or agency that published the filePlanCitation.
    */
    private ?string $citationJurisdiction = null;
    
    /**
     * @var string|null $citationUrl Represents the URL to the published filePlanCitation.
    */

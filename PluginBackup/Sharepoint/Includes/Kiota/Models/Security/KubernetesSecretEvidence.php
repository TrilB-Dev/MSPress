...
{
    /**
     * @var KubernetesNamespaceEvidence|null $escapedNamespace The secret namespace.
    */
    private ?KubernetesNamespaceEvidence $escapedNamespace = null;
    
    /**
     * @var string|null $name The secret name.
    */
    private ?string $name = null;
    
    /**
     * @var string|null $secretType The secret type can include both built-in types and custom ones. Examples of built-in types are: Opaque, kubernetes.io/service-account-token, kubernetes.io/dockercfg, kubernetes.io/dockerconfigjson, kubernetes.io/basic-auth, kubernetes.io/ssh-auth, kubernetes.io/tls, bootstrap.kubernetes.io/token.
    */

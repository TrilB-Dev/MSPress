...
class AddIn implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $id The unique identifier for the addIn object.
    */
    ...
    */
    ...
    /**
     * @var array<KeyValue>|null $properties The collection of key-value pairs that define parameters that the consuming service can use or call. You must specify this property when performing a POST or a PATCH operation on the addIns collection. Required.
    */
    private ?array $properties = null;
    
    /**
     * @var string|null $type The unique name for the functionality exposed by the app.
    */

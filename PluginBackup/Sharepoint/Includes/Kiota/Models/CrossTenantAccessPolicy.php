...
class CrossTenantAccessPolicy extends PolicyBase implements Parsable 
{
    ...
    */
    ...
    /**
     * @var CrossTenantAccessPolicyConfigurationDefault|null $escapedDefault Defines the default configuration for how your organization interacts with external Microsoft Entra organizations.
    */
    private ?CrossTenantAccessPolicyConfigurationDefault $escapedDefault = null;
    
    /**
     * @var array<CrossTenantAccessPolicyConfigurationPartner>|null $partners Defines partner-specific configurations for external Microsoft Entra organizations.
    */
    private ?array $partners = null;
    
    /**
     * @var PolicyTemplate|null $templates Represents the base policy in the directory for multitenant organization settings.
    */
    private ?PolicyTemplate $templates = null;

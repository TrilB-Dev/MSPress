...
class Call extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $callbackUri The callback URL on which callbacks are delivered. Must be an HTTPS URL.
    */
    private ?string $callbackUri = null;
    
    /**
     * @var string|null $callChainId A unique identifier for all the participant calls in a conference or a unique identifier for two participant calls in a P2P call.  This identifier must be copied over from Microsoft.Graph.Call.CallChainId.
    */
    ...
    */
    ...
    /**
     * @var CallDirection|null $direction The direction of the call. The possible values are incoming or outgoing. Read-only.
    */
    ...
    */
    ...
    /**
     * @var array<Modality>|null $requestedModalities The list of requested modalities. The possible values are: unknown, audio, video, videoBasedScreenSharing, data.
    */
    private ?array $requestedModalities = null;
    
    /**
     * @var ResultInfo|null $resultInfo The result information. For example, the result can hold termination reason. Read-only.
    */
    ...
    */
    ...
    /**
     * @var CallState|null $state The call state. The possible values are: incoming, establishing, ringing, established, hold, transferring, transferAccepted, redirecting, terminating, terminated. Read-only.
    */

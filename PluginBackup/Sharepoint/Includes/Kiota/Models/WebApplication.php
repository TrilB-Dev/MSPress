...
class WebApplication implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $logoutUrl Specifies the URL that is used by Microsoft's authorization service to log out a user using front-channel, back-channel or SAML logout protocols.
    */

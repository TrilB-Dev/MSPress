...
{
    /**
     * @var OnAuthenticationMethodLoadStartHandler|null $handler Required. Configuration for what to invoke if the event resolves to this listener. This property lets us define potential handler configurations per-event.
    */
    private ?OnAuthenticationMethodLoadStartHandler $handler = null;

...
{
    /**
     * @var array<UserExperienceAnalyticsInsight>|null $insights The insights for the category. Read-only.
    */
    private ?array $insights = null;
    
    /**
     * @var array<UserExperienceAnalyticsMetric>|null $metricValues The metric values for the user experience analytics category. Read-only.
    */

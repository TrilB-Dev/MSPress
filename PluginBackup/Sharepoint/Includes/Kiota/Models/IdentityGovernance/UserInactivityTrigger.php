...
{
    /**
     * @var int|null $inactivityPeriodInDays The number of days a user must be inactive before triggering workflow execution.
    */
    private ?int $inactivityPeriodInDays = null;
    ...
    */
    public function getInactivityPeriodInDays(): ?int {
        return $this->inactivityPeriodInDays;
    }
    ...
    */
    public function setInactivityPeriodInDays(?int $value): void {
        $this->inactivityPeriodInDays = $value;
    }

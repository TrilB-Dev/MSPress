...
{
    /**
     * @var int|null $artifactCount This property will be deprecated soon. Don't use.
    */
    private ?int $artifactCount = null;
    
    /**
     * @var string|null $searchResponseId .
    */
    private ?string $searchResponseId = null;

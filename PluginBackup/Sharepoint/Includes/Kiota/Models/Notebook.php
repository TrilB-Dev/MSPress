...
class Notebook extends OnenoteEntityHierarchyModel implements Parsable 
{
    ...
    */
    ...
    /**
     * @var OnenoteUserRole|null $userRole The possible values are: Owner, Contributor, Reader, None. Owner represents owner-level access to the notebook. Contributor represents read/write access to the notebook. Reader represents read-only access to the notebook. Read-only.
    */

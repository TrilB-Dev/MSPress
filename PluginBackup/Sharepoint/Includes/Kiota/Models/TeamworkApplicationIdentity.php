...
{
    /**
     * @var TeamworkApplicationIdentityType|null $applicationIdentityType Type of application that is referenced. The possible values are: aadApplication, bot, tenantBot, office365Connector, outgoingWebhook, and unknownFutureValue.
    */

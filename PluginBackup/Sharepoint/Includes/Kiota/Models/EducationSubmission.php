...
{
    /**
     * @var string|null $assignmentId The unique identifier for the assignment with which this submission is associated. A submission is always associated with one and only one assignment.
    */
    private ?string $assignmentId = null;
    
    /**
     * @var IdentitySet|null $excusedBy The user that marked the submission as excused.
    */
    private ?IdentitySet $excusedBy = null;
    
    /**
     * @var DateTime|null $excusedDateTime The time that the submission was excused. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $excusedDateTime = null;
    
    /**
     * @var IdentitySet|null $lastModifiedBy The identities of those who modified the submission.
    */
    private ?IdentitySet $lastModifiedBy = null;
    
    /**
     * @var DateTime|null $lastModifiedDateTime The date and time the submission was modified.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $reassignedDateTime Moment in time when the submission was reassigned. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $returnedDateTime Moment in time when the submission was returned. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $returnedDateTime = null;
    
    /**
     * @var EducationSubmissionStatus|null $status Read-only. The possible values are: excused, reassigned, returned, submitted and working. Use the Prefer: include-unknown-enum-members request header to get the following values in this evolvable enum: excused and reassigned.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $submittedDateTime Moment in time when the submission was moved into the submitted state. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $unsubmittedDateTime Moment in time when the submission was moved from submitted into the working state. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */

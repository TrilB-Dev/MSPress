...
{
    /**
     * @var User|null $invitedUser The user created as part of the invitation creation. Read-only. The id property is required in the request body to reset a redemption status.
    */
    ...
    */
    ...
    /**
     * @var InvitedUserMessageInfo|null $invitedUserMessageInfo Contains configuration for the message being sent to the invited user, including customizing message text, language, and cc recipient list.
    */
    private ?InvitedUserMessageInfo $invitedUserMessageInfo = null;
    
    /**
     * @var array<DirectoryObject>|null $invitedUserSponsors The users or groups who are sponsors of the invited user. Sponsors are users and groups that are responsible for guest users' privileges in the tenant and for keeping the guest users' information and access up to date.
    */
    private ?array $invitedUserSponsors = null;
    
    /**
     * @var string|null $invitedUserType The userType of the user being invited. By default, this is Guest. You can invite as Member if you're a company administrator.
    */
    ...
    */
    ...
    /**
     * @var string|null $inviteRedirectUrl The URL the user should be redirected to after the invitation is redeemed. Required.
    */
    ...
    */
    ...
    /**
     * @var string|null $status The status of the invitation. The possible values are: PendingAcceptance, Completed, InProgress, and Error.
    */

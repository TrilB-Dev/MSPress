...
{
    /**
     * @var EducationAiFeedbackCriteria|null $aiFeedbackCriteria The feedback types that students should receive from AI feedback. This property should only be provided if isAiFeedbackEnabled is true.
    */
    private ?EducationAiFeedbackCriteria $aiFeedbackCriteria = null;
    
    /**
     * @var bool|null $isAiFeedbackEnabled Indicates whether AI feedback is enabled for the student submissions.
    */
    private ?bool $isAiFeedbackEnabled = null;
    
    /**
     * @var bool|null $isVideoRequired Indicates whether video is required for the student recording.
    */
    private ?bool $isVideoRequired = null;
    
    /**
     * @var int|null $maxRecordingAttempts The maximum number of recording attempts available to the student. Specify 0 to set unlimited recording attempts.
    */
    private ?int $maxRecordingAttempts = null;
    
    /**
     * @var string|null $presentationTitle The title of the speaker progress resource visible to students.
    */
    private ?string $presentationTitle = null;
    
    /**
     * @var int|null $recordingTimeLimitInMinutes The time limit is in minutes for the student recording.
    */
    private ?int $recordingTimeLimitInMinutes = null;
    
    /**
     * @var bool|null $showRehearsalReportToStudentBeforeMediaUpload Allows students to view their rehearsal report before the assignment is graded.
    */
    private ?bool $showRehearsalReportToStudentBeforeMediaUpload = null;
    
    /**
     * @var EducationSpeakerCoachSettings|null $speakerCoachSettings The feedback types that students should receive from the Speaker Coach.
    */
    private ?EducationSpeakerCoachSettings $speakerCoachSettings = null;
    
    /**
     * @var string|null $spokenLanguageLocale The spoken language for the student recording. For example, en-US.
    */
    private ?string $spokenLanguageLocale = null;
    ...
    */
    public function getAiFeedbackCriteria(): ?EducationAiFeedbackCriteria {
        return $this->aiFeedbackCriteria;
    }
    ...
    */
    public function getIsAiFeedbackEnabled(): ?bool {
        return $this->isAiFeedbackEnabled;
    }
    ...
    */
    public function getMaxRecordingAttempts(): ?int {
        return $this->maxRecordingAttempts;
    }
    ...
    */
    public function getRecordingTimeLimitInMinutes(): ?int {
        return $this->recordingTimeLimitInMinutes;
    }
    ...
    */
    public function getShowRehearsalReportToStudentBeforeMediaUpload(): ?bool {
        return $this->showRehearsalReportToStudentBeforeMediaUpload;
    }
    ...
    */
    public function getSpeakerCoachSettings(): ?EducationSpeakerCoachSettings {
        return $this->speakerCoachSettings;
    }
    ...
    */
    public function getSpokenLanguageLocale(): ?string {
        return $this->spokenLanguageLocale;
    }
    ...
    */
    public function setIsAiFeedbackEnabled(?bool $value): void {
        $this->isAiFeedbackEnabled = $value;
    }
    ...
    */
    public function setMaxRecordingAttempts(?int $value): void {
        $this->maxRecordingAttempts = $value;
    }
    ...
    */
    public function setRecordingTimeLimitInMinutes(?int $value): void {
        $this->recordingTimeLimitInMinutes = $value;
    }
    ...
    */
    public function setShowRehearsalReportToStudentBeforeMediaUpload(?bool $value): void {
        $this->showRehearsalReportToStudentBeforeMediaUpload = $value;
    }
    ...
    */
    public function setSpeakerCoachSettings(?EducationSpeakerCoachSettings $value): void {
        $this->speakerCoachSettings = $value;
    }
    ...
    */
    public function setSpokenLanguageLocale(?string $value): void {
        $this->spokenLanguageLocale = $value;
    }

...
{
    /**
     * @var OnAttributeCollectionHandler|null $handler Required. Configuration for what to invoke if the event resolves to this listener.
    */
    private ?OnAttributeCollectionHandler $handler = null;

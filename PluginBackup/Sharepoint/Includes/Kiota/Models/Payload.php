...
{
    /**
     * @var PayloadBrand|null $brand The branch of a payload. The possible values are: unknown, other, americanExpress, capitalOne, dhl, docuSign, dropbox, facebook, firstAmerican, microsoft, netflix, scotiabank, sendGrid, stewartTitle, tesco, wellsFargo, syrinxCloud, adobe, teams, zoom, unknownFutureValue.
    */
    private ?PayloadBrand $brand = null;
    
    /**
     * @var PayloadComplexity|null $complexity The complexity of a payload. The possible values are: unknown, low, medium, high, unknownFutureValue.
    */
    private ?PayloadComplexity $complexity = null;
    
    /**
     * @var EmailIdentity|null $createdBy Identity of the user who created the attack simulation and training campaign payload.
    */
    private ?EmailIdentity $createdBy = null;
    
    /**
     * @var DateTime|null $createdDateTime Date and time when the attack simulation and training campaign payload. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $description Description of the attack simulation and training campaign payload.
    */
    private ?string $description = null;
    
    /**
     * @var PayloadDetail|null $detail Additional details about the payload.
    */
    private ?PayloadDetail $detail = null;
    
    /**
     * @var string|null $displayName Display name of the attack simulation and training campaign payload. Supports $filter and $orderby.
    */
    private ?string $displayName = null;
    
    /**
     * @var PayloadIndustry|null $industry Industry of a payload. The possible values are: unknown, other, banking, businessServices, consumerServices, education, energy, construction, consulting, financialServices, government, hospitality, insurance, legal, courierServices, IT, healthcare, manufacturing, retail, telecom, realEstate, unknownFutureValue.
    */
    private ?PayloadIndustry $industry = null;
    
    /**
     * @var bool|null $isAutomated Indicates whether the attack simulation and training campaign payload was created from an automation flow. Supports $filter and $orderby.
    */
    private ?bool $isAutomated = null;
    
    /**
     * @var bool|null $isControversial Indicates whether the payload is controversial.
    */
    private ?bool $isControversial = null;
    
    /**
     * @var bool|null $isCurrentEvent Indicates whether the payload is from any recent event.
    */
    private ?bool $isCurrentEvent = null;
    
    /**
     * @var string|null $language Payload language.
    */
    private ?string $language = null;
    
    /**
     * @var EmailIdentity|null $lastModifiedBy Identity of the user who most recently modified the attack simulation and training campaign payload.
    */
    private ?EmailIdentity $lastModifiedBy = null;
    
    /**
     * @var DateTime|null $lastModifiedDateTime Date and time when the attack simulation and training campaign payload was last modified. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $lastModifiedDateTime = null;
    
    /**
     * @var array<string>|null $payloadTags Free text tags for a payload.
    */
    private ?array $payloadTags = null;
    
    /**
     * @var PayloadDeliveryPlatform|null $platform The payload delivery platform for a simulation. The possible values are: unknown, sms, email, teams, unknownFutureValue.
    */
    private ?PayloadDeliveryPlatform $platform = null;
    
    /**
     * @var float|null $predictedCompromiseRate Predicted probability for a payload to phish a targeted user.
    */
    private ?float $predictedCompromiseRate = null;
    
    /**
     * @var SimulationAttackType|null $simulationAttackType Attack type of the attack simulation and training campaign. Supports $filter and $orderby. The possible values are: unknown, social, cloud, endpoint, unknownFutureValue.
    */
    private ?SimulationAttackType $simulationAttackType = null;
    
    /**
     * @var SimulationContentSource|null $source The source property
    */
    private ?SimulationContentSource $source = null;
    
    /**
     * @var SimulationContentStatus|null $status Simulation content status. Supports $filter and $orderby. The possible values are: unknown, draft, ready, archive, delete, unknownFutureValue.
    */
    private ?SimulationContentStatus $status = null;
    
    /**
     * @var SimulationAttackTechnique|null $technique The social engineering technique used in the attack simulation and training campaign. Supports $filter and $orderby. The possible values are: unknown, credentialHarvesting, attachmentMalware, driveByUrl, linkInAttachment, linkToMalwareFile, unknownFutureValue, oAuthConsentGrant. Use the Prefer: include-unknown-enum-members request header to get the following values from this evolvable enum: oAuthConsentGrant. For more information on the types of social engineering attack techniques, see simulations.
    */
    private ?SimulationAttackTechnique $technique = null;
    
    /**
     * @var PayloadTheme|null $theme The theme of a payload. The possible values are: unknown, other, accountActivation, accountVerification, billing, cleanUpMail, controversial, documentReceived, expense, fax, financeReport, incomingMessages, invoice, itemReceived, loginAlert, mailReceived, password, payment, payroll, personalizedOffer, quarantine, remoteWork, reviewMessage, securityUpdate, serviceSuspended, signatureRequired, upgradeMailboxStorage, verifyMailbox, voicemail, advertisement, employeeEngagement, unknownFutureValue.
    */
    private ?PayloadTheme $theme = null;

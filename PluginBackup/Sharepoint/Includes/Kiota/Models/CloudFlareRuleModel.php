...
class CloudFlareRuleModel implements AdditionalDataHolder, Parsable 
{
    /**
     * @var string|null $action The action Cloudflare applies when the rule matches traffic. Common values include Managed Challenge, Interactive Challenge, Log, Block, JS Challenge, or Skip.
    */
    ...
    */
    ...
    /**
     * @var string|null $name Friendly name for the rule, used in UIs or logs to help administrators identify the rule.
    */
    ...
    */
    ...
    /**
     * @var string|null $ruleId Unique identifier assigned to the rule by Cloudflare or the integration.
    */

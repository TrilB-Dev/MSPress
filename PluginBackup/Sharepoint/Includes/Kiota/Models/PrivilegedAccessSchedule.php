...
{
    /**
     * @var DateTime|null $createdDateTime When the schedule was created. Optional.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $createdUsing The identifier of the access assignment or eligibility request that created this schedule. Optional.
    */
    private ?string $createdUsing = null;
    
    /**
     * @var DateTime|null $modifiedDateTime When the schedule was last modified. Optional.
    */
    private ?DateTime $modifiedDateTime = null;
    
    /**
     * @var RequestSchedule|null $scheduleInfo Represents the period of the access assignment or eligibility. The scheduleInfo can represent a single occurrence or multiple recurring instances. Required.
    */
    private ?RequestSchedule $scheduleInfo = null;
    
    /**
     * @var string|null $status The status of the access assignment or eligibility request. The possible values are: Canceled, Denied, Failed, Granted, PendingAdminDecision, PendingApproval, PendingProvisioning, PendingScheduleCreation, Provisioned, Revoked, and ScheduleCreated. Not nullable. Optional.
    */

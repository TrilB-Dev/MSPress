...
class AccessPackageAssignmentWorkflowExtension extends CustomCalloutExtension implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime When the entity was created.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $lastModifiedBy The userPrincipalName of the identity that last modified the entity.
    */
    private ?string $lastModifiedBy = null;
    
    /**
     * @var DateTime|null $lastModifiedDateTime When the entity was last modified.
    */

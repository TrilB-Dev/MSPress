...
{
    /**
     * @var string|null $description The description of the tag as it appears to the user in Microsoft Teams. A teamworkTag can't have more than 200 teamworkTagMembers.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $displayName The name of the tag as it appears to the user in Microsoft Teams.
    */

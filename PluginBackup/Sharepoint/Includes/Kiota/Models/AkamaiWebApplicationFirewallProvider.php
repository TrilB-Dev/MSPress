...
{
    /**
     * @var string|null $accessToken Akamai API access token used to authenticate to the Akamai account. Contact your Akamai Customer Success Manager for assistance with your accessToken.
    */
    private ?string $accessToken = null;
    
    /**
     * @var string|null $clientSecret Akamai API client secret used in conjunction with the client token and access token for authentication. Contact your Akamai Customer Success Manager for assistance with this information.
    */
    private ?string $clientSecret = null;
    
    /**
     * @var string|null $clientToken Akamai API client token used for authentication to the Akamai account. Contact your Akamai Customer Success Manager for assistance with this information.
    */
    private ?string $clientToken = null;
    
    /**
     * @var string|null $hostPrefix Prefix used to identify the host or domain in Akamai configuration operations. This value may be required for certain API calls or configuration scenarios.
    */

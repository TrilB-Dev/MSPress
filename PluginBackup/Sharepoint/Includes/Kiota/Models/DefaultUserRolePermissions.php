...
class DefaultUserRolePermissions implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $allowedToReadOtherUsers Indicates whether the default user role can read other users. DO NOT SET THIS VALUE TO false.
    */

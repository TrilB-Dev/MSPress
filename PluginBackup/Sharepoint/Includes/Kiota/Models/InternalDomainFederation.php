...
{
    /**
     * @var string|null $activeSignInUri URL of the endpoint used by active clients when authenticating with federated domains set up for single sign-on in Microsoft Entra ID. Corresponds to the ActiveLogOnUri property of the Set-EntraDomainFederationSettings PowerShell cmdlet.
    */
    private ?string $activeSignInUri = null;
    
    /**
     * @var FederatedIdpMfaBehavior|null $federatedIdpMfaBehavior Determines whether Microsoft Entra ID accepts the MFA performed by the federated IdP when a federated user accesses an application that is governed by a conditional access policy that requires MFA. The possible values are: acceptIfMfaDoneByFederatedIdp, enforceMfaByFederatedIdp, rejectMfaByFederatedIdp, unknownFutureValue. For more information, see federatedIdpMfaBehavior values.
    */
    private ?FederatedIdpMfaBehavior $federatedIdpMfaBehavior = null;
    
    /**
     * @var bool|null $isSignedAuthenticationRequestRequired If true, when SAML authentication requests are sent to the federated SAML IdP, Microsoft Entra ID will sign those requests using the OrgID signing key. If false (default), the SAML authentication requests sent to the federated IdP aren't signed.
    */
    private ?bool $isSignedAuthenticationRequestRequired = null;
    
    /**
     * @var string|null $nextSigningCertificate Fallback token signing certificate that can also be used to sign tokens, for example when the primary signing certificate expires. Formatted as Base64 encoded strings of the public portion of the federated IdP's token signing certificate. Needs to be compatible with the X509Certificate2 class. Much like the signingCertificate, the nextSigningCertificate property is used if a rollover is required outside of the auto-rollover update, a new federation service is being set up, or if the new token signing certificate isn't present in the federation properties after the federation service certificate has been updated.
    */
    private ?string $nextSigningCertificate = null;
    
    /**
     * @var string|null $passwordResetUri The passwordResetUri property
    */
    private ?string $passwordResetUri = null;
    ...
    */
    ...
    /**
     * @var string|null $signOutUri URI that clients are redirected to when they sign out of Microsoft Entra services. Corresponds to the LogOffUri property of the Set-EntraDomainFederationSettings PowerShell cmdlet.
    */
    private ?string $signOutUri = null;
    
    /**
     * @var SystemBrowserEnabledOn|null $systemBrowserEnabledOn The systemBrowserEnabledOn property
    */
    private ?SystemBrowserEnabledOn $systemBrowserEnabledOn = null;
    ...
    */
    public function getSystemBrowserEnabledOn(): ?SystemBrowserEnabledOn {
        return $this->systemBrowserEnabledOn;
    }
    ...
    */
    public function setSystemBrowserEnabledOn(?SystemBrowserEnabledOn $value): void {
        $this->systemBrowserEnabledOn = $value;
    }

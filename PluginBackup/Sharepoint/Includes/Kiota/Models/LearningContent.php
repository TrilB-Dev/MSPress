...
class LearningContent extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime The date and time when the learning content was created. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Optional.
    */
    ...
    */
    ...
    /**
     * @var bool|null $isActive Indicates whether the content is active or not. Inactive content doesn't show up in the UI. The default value is true. Optional.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $lastModifiedDateTime The date and time when the learning content was last modified. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Optional.
    */
    private ?DateTime $lastModifiedDateTime = null;
    
    /**
     * @var Level|null $level The difficulty level of the learning content. The possible values are: Beginner, Intermediate, Advanced, unknownFutureValue. Optional.
    */

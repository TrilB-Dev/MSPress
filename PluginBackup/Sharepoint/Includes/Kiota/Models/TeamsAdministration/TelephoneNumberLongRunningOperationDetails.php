...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\LongRunningOperationStatus;

class TelephoneNumberLongRunningOperationDetails implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $resourceLocation Location of the asynchronous operation. It includes the operation identifier.
    */
    private ?string $resourceLocation = null;
    
    /**
     * @var LongRunningOperationStatus|null $status status of the asynchronous operation. The possible values are: notStarted, running, succeeded, failed, unknownFutureValue.
    */
    private ?LongRunningOperationStatus $status = null;
    
    /**
     * @var string|null $statusDetail Indicates the asynchronous operation details.
    */

...
{
    /**
     * @var UserType|null $userTypeToCreate The type of user to create. Maps to userType property of user object. The possible values are: member, guest, unknownFutureValue.
    */
    private ?UserType $userTypeToCreate = null;

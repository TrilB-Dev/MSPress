...
{
    /**
     * @var string|null $printerId The ID of the printer represented by these statistics.
    */
    private ?string $printerId = null;
    
    /**
     * @var string|null $printerName The name of the printer represented by these statistics.
    */

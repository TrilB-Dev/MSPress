...
{
    /**
     * @var DeviceEnrollmentPlatformRestriction|null $androidRestriction Indicates restrictions for Android platform.
    */
    private ?DeviceEnrollmentPlatformRestriction $androidRestriction = null;
    
    /**
     * @var DeviceEnrollmentPlatformRestriction|null $iosRestriction Indicates restrictions for IOS platform.
    */
    private ?DeviceEnrollmentPlatformRestriction $iosRestriction = null;
    
    /**
     * @var DeviceEnrollmentPlatformRestriction|null $macOSRestriction Indicates restrictions for MacOS platform.
    */
    private ?DeviceEnrollmentPlatformRestriction $macOSRestriction = null;
    
    /**
     * @var DeviceEnrollmentPlatformRestriction|null $windowsMobileRestriction Indicates restrictions for Windows Mobile platform.
    */
    private ?DeviceEnrollmentPlatformRestriction $windowsMobileRestriction = null;
    
    /**
     * @var DeviceEnrollmentPlatformRestriction|null $windowsRestriction Indicates restrictions for Windows platform.
    */

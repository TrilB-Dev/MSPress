...
class MacOSLobApp extends MobileLobApp implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $installAsManaged When TRUE, indicates that the app will be installed as managed (requires macOS 11.0 and other managed package restrictions). When FALSE, indicates that the app will be installed as unmanaged. The default value is FALSE.
    */

...
class ChecklistItem extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $displayName Indicates the title of the checklistItem.
    */
    private ?string $displayName = null;
    
    /**
     * @var bool|null $isChecked State that indicates whether the item is checked off or not.
    */

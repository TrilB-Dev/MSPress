...
use MSPress\Admin\Manager\Tools\AnalyticsManager;
...
final class ToolsManager extends Manager {
    ...
    public function render(): void {
        ...
        $capabilities = [
            'analytics' => 'mspress_tools_analytics',
    ...
    public function register_assets( Assets $assets ): void {
        $this->register_page_assets( $assets, [ 'mspress-tools' ], 'analytics' );
    }
    /**
    ...
    private function title( string $tool ): string {
        return [
            'analytics' => __( 'Analytics', 'mspress' ),

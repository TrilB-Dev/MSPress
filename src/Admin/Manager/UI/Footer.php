	...
	public static function render(): void {
		...
		<footer class="mspress-footer border-top">
			<div class="container-fluid px-3 px-lg-4 py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
				...
				<span class="small text-secondary"><?php esc_html_e( 'Powered by', 'mspress' ); ?> <a class="fw-semibold text-decoration-none" href="https://github.com/TrilB-Dev/MSPress" target="_blank" rel="noopener noreferrer">MSPress</a></span>
			</div>
		</footer>
		<?php
	}

        ...
        return [
            ...
            'fields' => [
                [ 
                    ...
                    'label' => __( 'Icon source', 'mspress' ),
                    'description' => __( 'Choose how MSPress loads Font Awesome icons.', 'mspress' ),
                    'tooltip' => __( 'Use the base package for the bundled icons or a Kit when you need a custom Font Awesome configuration.', 'mspress' ),
                    'tooltip_type' => 'info',
                    'type' => 'select',
                    'options' => [ 'base' => __( 'Base package', 'mspress' ),
                    'kit' => __( 'Font Awesome Kit', 'mspress' ) ],
                    'default' => 'base' 
                ],
                [ 
                    'key' => 'fontawesome_kit_id',
                    'label' => __( 'Kit ID', 'mspress' ),
                    'description' => __( 'Enter the ID of your Font Awesome Kit.', 'mspress' ),
                    'tooltip' => __( 'This value is used only when Icon source is set to Font Awesome Kit.', 'mspress' ),
                    'type' => 'text',
                    'default' => '' 
                ],
                [ 
                    'key' => 'fontawesome_version',
                    'label' => __( 'Base package version', 'mspress' ),
                    'description' => __( 'Set the version of the bundled Font Awesome package to load.', 'mspress' ),
                    'tooltip' => __( 'Use a version supported by the installed Font Awesome assets.', 'mspress' ),
                    'tooltip_type' => 'info',
                    'type' => 'text',
                    'default' => '7.0.0'
                ],

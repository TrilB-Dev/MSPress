...
/**
 * Shortcodes supplied by the MSPress SharePoint plugin.
 */
    ...
    public static function definitions(): array {
        return [
            ShortcodeHelper::define(
                ...
                [ 'message' => __( 'MSPress SharePoint', 'mspress' ) ],
                [
                    'description' => __( 'Render a message from the MSPress SharePoint plugin.', 'mspress' ),
                    'category' => 'demo',
                ]
            ),
        ];

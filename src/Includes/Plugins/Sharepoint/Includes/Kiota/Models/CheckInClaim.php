...
class CheckInClaim implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $calendarEventId The unique identifier for an Outlook calendar event associated with the checkInClaim object. For more information, see the iCalUId property in event.
    */
    private ?string $calendarEventId = null;
    
    /**
     * @var CheckInMethod|null $checkInMethod The checkInMethod property
    */
    private ?CheckInMethod $checkInMethod = null;
    
    /**
     * @var DateTime|null $createdDateTime The date and time when the checkInClaim object was created. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */

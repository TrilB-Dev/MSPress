...
class MicrosoftManagedDesktop implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var MicrosoftManagedDesktopType|null $managedType Indicates the provisioning policy associated with Microsoft Managed Desktop settings. The possible values are: notManaged, premiumManaged, standardManaged, starterManaged, unknownFutureValue. The default is notManaged.
    */
    private ?MicrosoftManagedDesktopType $managedType = null;

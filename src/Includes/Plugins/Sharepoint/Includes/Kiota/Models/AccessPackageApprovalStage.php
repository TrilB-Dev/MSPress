...
class AccessPackageApprovalStage implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ApproverInformationVisibility|null $approverInformationVisibility The approverInformationVisibility property
    */
    private ?ApproverInformationVisibility $approverInformationVisibility = null;
    ...
    */
    ...
    /**
     * @var array<SubjectSet>|null $escalationApprovers If escalation is enabled and the primary approvers do not respond before the escalation time, the escalationApprovers are the users who are asked to approve requests.
    */
    ...
    */
    ...
    /**
     * @var array<SubjectSet>|null $primaryApprovers The subjects, typically users, who are asked to approve requests. A collection of singleUser, groupMembers, requestorManager, internalSponsors, externalSponsors, or targetUserSponsors.
    */
    ...
    */
    public function getApproverInformationVisibility(): ?ApproverInformationVisibility {
        return $this->approverInformationVisibility;
    }
    ...
    */
    public function setApproverInformationVisibility(?ApproverInformationVisibility $value): void {
        $this->approverInformationVisibility = $value;
    }

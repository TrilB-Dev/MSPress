...
namespace MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\TermStore;
...
class Group extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var TermGroupScope|null $scope Returns the type of the group. The possible values are: global, system, and siteCollection.
    */

...
{
    /**
     * @var CustomExtensionOverwriteConfiguration|null $configuration Configuration regarding properties of the custom extension that can be overwritten per event listener.
    */
    private ?CustomExtensionOverwriteConfiguration $configuration = null;
    
    /**
     * @var OnAttributeCollectionSubmitCustomExtension|null $customExtension The customExtension property
    */
    private ?OnAttributeCollectionSubmitCustomExtension $customExtension = null;

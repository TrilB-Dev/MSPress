...
{
    /**
     * @var SimulationNotification|null $simulationNotification The notification for the user who is part of the simulation.
    */
    private ?SimulationNotification $simulationNotification = null;

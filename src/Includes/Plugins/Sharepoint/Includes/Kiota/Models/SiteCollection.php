...
class SiteCollection implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var SiteArchivalDetails|null $archivalDetails Represents whether the site collection is recently archived, fully archived, or reactivating. The possible values are: recentlyArchived, fullyArchived, reactivating, unknownFutureValue.
    */
    private ?SiteArchivalDetails $archivalDetails = null;
    
    /**
     * @var string|null $dataLocationCode The geographic region code for where this site collection resides. Only present for multi-geo tenants. Read-only.
    */

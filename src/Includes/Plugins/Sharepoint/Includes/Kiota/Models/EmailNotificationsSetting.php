...
{
    /**
     * @var NotificationEventsType|null $additionalEvents The additionalEvents property
    */
    private ?NotificationEventsType $additionalEvents = null;
    
    /**
     * @var bool|null $isEnabled Indicates whether notifications are enabled.
    */
    private ?bool $isEnabled = null;
    
    /**
     * @var NotificationRecipients|null $recipients The recipients property
    */
    private ?NotificationRecipients $recipients = null;

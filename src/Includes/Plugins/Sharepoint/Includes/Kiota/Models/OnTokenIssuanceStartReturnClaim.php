...
class OnTokenIssuanceStartReturnClaim implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $claimIdInApiResponse The identifier of the claim returned by an API that is to be add to a token being issued.
    */
    private ?string $claimIdInApiResponse = null;
    ...
    */
    public function setClaimIdInApiResponse(?string $value): void {
        $this->claimIdInApiResponse = $value;
    }

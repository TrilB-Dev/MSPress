...
{
    /**
     * @var array<FileStorageContainerTypeAppPermissionGrant>|null $applicationPermissionGrants Access privileges of applications on containers.
    */
    private ?array $applicationPermissionGrants = null;
    ...
    */
    ...
    /**
     * @var string|null $name The name of the fileStorageContainerTypeRegistration. Read-only.
    */
    private ?string $name = null;
    
    /**
     * @var string|null $owningAppId ID of the application that owns the fileStorageContainerType. Read-only.
    */
    private ?string $owningAppId = null;
    
    /**
     * @var DateTime|null $registeredDateTime The registration date. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Read-only.
    */
    private ?DateTime $registeredDateTime = null;
    
    /**
     * @var FileStorageContainerTypeRegistrationSettings|null $settings The settings property
    */
    private ?FileStorageContainerTypeRegistrationSettings $settings = null;
    ...
    */
    public function getApplicationPermissionGrants(): ?array {
        return $this->applicationPermissionGrants;
    }
    ...
    */
    public function setApplicationPermissionGrants(?array $value): void {
        $this->applicationPermissionGrants = $value;
    }

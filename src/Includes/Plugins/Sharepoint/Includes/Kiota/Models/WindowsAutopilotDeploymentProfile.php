...
class WindowsAutopilotDeploymentProfile extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $description A description of the deployment profile. Max allowed length is 1500 chars. Supports: $select, $top, $skip, $orderBy. $Search and $filter are not supported.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $deviceNameTemplate The template used to name the Autopilot device. This can be a custom text and can also contain either the serial number of the device, or a randomly generated number. The total length of the text generated by the template can be no more than 15 characters. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported.
    */
    ...
    */
    ...
    /**
     * @var string|null $displayName The display name of the deployment profile. Max allowed length is 200 chars. Returned by default. Supports: $select, $top, $skip, $orderby. $Search and $filter are not supported.
    */
    private ?string $displayName = null;
    
    /**
     * @var bool|null $hardwareHashExtractionEnabled Indicates whether the profile supports the extraction of hardware hash values and registration of the device into Windows Autopilot. When TRUE, indicates if hardware extraction and Windows Autopilot registration will happen on the next successful check-in. When FALSE, hardware hash extraction and Windows Autopilot registration will not happen. Default value is FALSE. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported.
    */
    private ?bool $hardwareHashExtractionEnabled = null;
    ...
    */
    ...
    /**
     * @var string|null $locale The locale (language) to be used when configuring the device. E.g. en-US. The default value is os-default. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported.
    */
    private ?string $locale = null;
    
    /**
     * @var string|null $managementServiceAppId The Entra management service App ID which gets used during client device-based enrollment discovery. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported.
    */
    private ?string $managementServiceAppId = null;
    
    /**
     * @var OutOfBoxExperienceSetting|null $outOfBoxExperienceSetting The Windows Autopilot Deployment Profile settings used by the device for the out-of-box experience. Supports: $select, $top, $skip. $Search, $orderBy and $filter are not supported.
    */
    private ?OutOfBoxExperienceSetting $outOfBoxExperienceSetting = null;
    
    /**
     * @var bool|null $preprovisioningAllowed Indicates whether the user is allowed to use Windows Autopilot for pre-provisioned deployment mode during Out of Box experience (OOBE). When TRUE, indicates that Windows Autopilot for pre-provisioned deployment mode for OOBE is allowed to be used. When false, Windows Autopilot for pre-provisioned deployment mode for OOBE is not allowed. The default is FALSE.
    */
    private ?bool $preprovisioningAllowed = null;
    
    /**
     * @var array<string>|null $roleScopeTagIds List of role scope tags for the deployment profile. 
    */
    ...
    */
    public function setHardwareHashExtractionEnabled(?bool $value): void {
        $this->hardwareHashExtractionEnabled = $value;
    }
    ...
    */
    public function setOutOfBoxExperienceSetting(?OutOfBoxExperienceSetting $value): void {
        $this->outOfBoxExperienceSetting = $value;
    }
    ...
    */
    public function setPreprovisioningAllowed(?bool $value): void {
        $this->preprovisioningAllowed = $value;
    }

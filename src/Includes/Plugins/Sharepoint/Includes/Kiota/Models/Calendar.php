...
{
    /**
     * @var array<OnlineMeetingProviderType>|null $allowedOnlineMeetingProviders Represent the online meeting service providers that can be used to create online meetings in this calendar. The possible values are: unknown, skypeForBusiness, skypeForConsumer, teamsForBusiness.
    */
    ...
    */
    ...
    /**
     * @var bool|null $canEdit true if the user can write to the calendar, false otherwise. This property is true for the user who created the calendar. This property is also true for a user who shared a calendar and granted write access.
    */
    private ?bool $canEdit = null;
    
    /**
     * @var bool|null $canShare true if the user has permission to share the calendar, false otherwise. Only the user who created the calendar can share it.
    */
    private ?bool $canShare = null;
    
    /**
     * @var bool|null $canViewPrivateItems If true, the user can read calendar items that have been marked private, false otherwise.
    */
    ...
    */
    ...
    /**
     * @var OnlineMeetingProviderType|null $defaultOnlineMeetingProvider The default online meeting provider for meetings sent from this calendar. The possible values are: unknown, skypeForBusiness, skypeForConsumer, teamsForBusiness.
    */

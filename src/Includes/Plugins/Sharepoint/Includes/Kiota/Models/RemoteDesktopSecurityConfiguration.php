...
{
    /**
     * @var array<ApprovedClientApp>|null $approvedClientApps The collection of approved client apps that are associated with the RDS configuration. Supports $expand.
    */
    private ?array $approvedClientApps = null;
    
    /**
     * @var bool|null $isRemoteDesktopProtocolEnabled Determines if Microsoft Entra ID RDS authentication protocol for RDP is enabled.
    */
    private ?bool $isRemoteDesktopProtocolEnabled = null;
    
    /**
     * @var array<TargetDeviceGroup>|null $targetDeviceGroups The collection of target device groups that are associated with the RDS security configuration that will be enabled for SSO when a client connects to the target device over RDP using the new Microsoft Entra ID RDS authentication protocol.
    */
    private ?array $targetDeviceGroups = null;
    ...
    */
    public function getApprovedClientApps(): ?array {
        return $this->approvedClientApps;
    }

...
class ChannelSummary implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $guestsCount Count of guests in a channel.
    */
    private ?int $guestsCount = null;
    
    /**
     * @var bool|null $hasMembersFromOtherTenants Indicates whether external members are included on the channel.
    */
    private ?bool $hasMembersFromOtherTenants = null;
    
    /**
     * @var int|null $membersCount Count of members in a channel.
    */
    ...
    */
    ...
    /**
     * @var int|null $ownersCount Count of owners in a channel.
    */

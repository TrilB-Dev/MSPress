...
{
    /**
     * @var ScheduleChangeRequestActor|null $assignedTo Indicates who the request is assigned to. The possible values are: sender, recipient, manager, system, unknownFutureValue.
    */
    private ?ScheduleChangeRequestActor $assignedTo = null;
    
    /**
     * @var DateTime|null $managerActionDateTime The date and time when the manager approved or declined the scheduleChangeRequest. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $managerActionDateTime = null;
    
    /**
     * @var string|null $managerActionMessage The message sent by the manager regarding the scheduleChangeRequest. Optional.
    */
    private ?string $managerActionMessage = null;
    
    /**
     * @var string|null $managerUserId The user ID of the manager who approved or declined the scheduleChangeRequest.
    */
    private ?string $managerUserId = null;
    
    /**
     * @var DateTime|null $senderDateTime The date and time when the sender sent the scheduleChangeRequest. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $senderDateTime = null;
    
    /**
     * @var string|null $senderMessage The message sent by the sender of the scheduleChangeRequest. Optional.
    */
    private ?string $senderMessage = null;
    
    /**
     * @var string|null $senderUserId The user ID of the sender of the scheduleChangeRequest.
    */
    private ?string $senderUserId = null;
    
    /**
     * @var ScheduleChangeState|null $state The state of the scheduleChangeRequest. The possible values are: pending, approved, declined, unknownFutureValue.
    */

...
class LicenseUnitsDetail implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var int|null $lockedOut The number of units that are locked out because the customer canceled their subscription of the service SKU.
    */
    private ?int $lockedOut = null;
    ...
    */
    ...
    /**
     * @var int|null $suspended The number of units that are suspended because the subscription of the service SKU has been canceled. The units can't be assigned but can still be reactivated before they're deleted.
    */
    private ?int $suspended = null;
    
    /**
     * @var int|null $warning The number of units that are in warning status. When the subscription of the service SKU has expired, the customer has a grace period to renew their subscription before it's canceled (moved to a suspended state).
    */

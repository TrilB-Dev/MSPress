...
{
    /**
     * @var IdentitySet|null $createdBy The identity of the person who created the protection unit.
    */
    private ?IdentitySet $createdBy = null;
    
    /**
     * @var DateTime|null $createdDateTime The time of creation of the protection unit. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var PublicError|null $error Contains error details if an error occurred while creating a protection unit.
    */
    private ?PublicError $error = null;
    
    /**
     * @var IdentitySet|null $lastModifiedBy The identity of person who last modified the protection unit.
    */
    private ?IdentitySet $lastModifiedBy = null;
    
    /**
     * @var DateTime|null $lastModifiedDateTime Timestamp of the last modification of this protection unit. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $lastModifiedDateTime = null;
    
    /**
     * @var DateTime|null $offboardRequestedDateTime The date and time when protection unit offboard was requested. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $offboardRequestedDateTime = null;
    
    /**
     * @var string|null $policyId The unique identifier of the protection policy based on which protection unit was created.
    */
    private ?string $policyId = null;
    
    /**
     * @var ProtectionSource|null $protectionSources The protectionSources property
    */
    private ?ProtectionSource $protectionSources = null;
    
    /**
     * @var ProtectionUnitStatus|null $status The status of the protection unit. The possible values are: protectRequested, protected, unprotectRequested, unprotected, removeRequested, unknownFutureValue, offboardRequested, offboarded, cancelOffboardRequested. Use the Prefer: include-unknown-enum-members request header to get the following values from this evolvable enum: offboardRequested, offboarded, cancelOffboardRequested.
    */
    private ?ProtectionUnitStatus $status = null;
    ...
    */
    public function getOffboardRequestedDateTime(): ?DateTime {
        return $this->offboardRequestedDateTime;
    }
    ...
    */
    public function setOffboardRequestedDateTime(?DateTime $value): void {
        $this->offboardRequestedDateTime = $value;
    }

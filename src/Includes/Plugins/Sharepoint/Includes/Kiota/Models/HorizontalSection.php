...
{
    /**
     * @var array<HorizontalSectionColumn>|null $columns The set of vertical columns in this section.
    */
    private ?array $columns = null;
    
    /**
     * @var SectionEmphasisType|null $emphasis Enumeration value that indicates the emphasis of the section background. The possible values are: none, netural, soft, strong, unknownFutureValue.
    */
    private ?SectionEmphasisType $emphasis = null;
    
    /**
     * @var HorizontalSectionLayoutType|null $layout Layout type of the section. The possible values are: none, oneColumn, twoColumns, threeColumns, oneThirdLeftColumn, oneThirdRightColumn, fullWidth, unknownFutureValue.
    */
    private ?HorizontalSectionLayoutType $layout = null;

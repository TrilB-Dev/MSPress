...
class UserExperienceAnalyticsInsight implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var UserExperienceAnalyticsInsightSeverity|null $severity Indicates severity of insights. Possible values are: None, Informational, Warning, Error.
    */
    private ?UserExperienceAnalyticsInsightSeverity $severity = null;
    
    /**
     * @var string|null $userExperienceAnalyticsMetricId The unique identifier of the user experience analytics metric.
    */

...
{
    /**
     * @var string|null $configurationId A unique identifier used to manage the external auth method within Microsoft Entra ID.
    */
    private ?string $configurationId = null;
    
    /**
     * @var string|null $displayName Custom name given to the registered external MFA.
    */

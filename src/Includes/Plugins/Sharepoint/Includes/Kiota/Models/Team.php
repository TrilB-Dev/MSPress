...
class Team extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $classification An optional label. Typically describes the data or business sensitivity of the team. Must match one of a preconfigured set in the tenant's directory.
    */
    ...
    */
    ...
    /**
     * @var string|null $description An optional description for the team. Maximum length: 1,024 characters.
    */
    ...
    */
    ...
    /**
     * @var string|null $firstChannelName The name of the first channel in the team. This is an optional property, only used during team creation and isn't returned in methods to get and list teams.
    */
    private ?string $firstChannelName = null;
    ...
    */
    ...
    /**
     * @var string|null $internalId A unique ID for the team that was used in a few places such as the audit log/Office 365 Management Activity API.
    */
    ...
    */
    ...
    /**
     * @var string|null $webUrl A hyperlink that goes to the team in the Microsoft Teams client. You get this URL when you right-click a team in the Microsoft Teams client and select Get link to team. This URL should be treated as an opaque blob, and not parsed.
    */

...
class Participant extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var RemovedState|null $removedState Indicates the reason why the participant was removed from the roster.
    */
    private ?RemovedState $removedState = null;
    
    /**
     * @var OnlineMeetingRestricted|null $restrictedExperience Indicates the reason or reasons media content from this participant is restricted.
    */
    private ?OnlineMeetingRestricted $restrictedExperience = null;
    
    /**
     * @var int|null $rosterSequenceNumber Indicates the roster sequence number in which the participant was last updated.
    */
    private ?int $rosterSequenceNumber = null;

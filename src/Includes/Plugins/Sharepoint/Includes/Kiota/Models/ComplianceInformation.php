...
class ComplianceInformation implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<CertificationControl>|null $certificationControls Collection of the certification controls associated with the certification.
    */
    private ?array $certificationControls = null;
    
    /**
     * @var string|null $certificationName The name of the compliance certification, for example, ISO 27018:2014, GDPR, FedRAMP, and NIST 800-171.
    */

...
{
    /**
     * @var array<OnTokenIssuanceStartReturnClaim>|null $claimsForTokenConfiguration Collection of claims to be returned by the API called by this custom authentication extension. Used to populate claims mapping experience in Microsoft Entra admin center. Optional.
    */

...
{
    /**
     * @var int|null $activeDeviceCount The number of active devices for the OS version. Valid values 0 to 2147483647. Supports: $filter, $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    ...
    */
    ...
    /**
     * @var string|null $osBuildNumber The OS build number installed on the device. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $osBuildNumber = null;
    
    /**
     * @var string|null $osVersion The OS version installed on the device. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $osVersion = null;
    
    /**
     * @var float|null $osVersionAppHealthScore The application health score of the OS version. Valid values 0 to 100. Supports: $filter, $select, $OrderBy. Read-only. Valid values -1.79769313486232E+308 to 1.79769313486232E+308
    */

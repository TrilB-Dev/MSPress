...
{
    /**
     * @var IdentitySet|null $createdBy Identity of the user, device, and application that created the item. Read-only.
    */
    ...
    */
    ...
    /**
     * @var IdentitySet|null $lastModifiedBy Identity of the user, device, and application that created the item. Read-only.
    */

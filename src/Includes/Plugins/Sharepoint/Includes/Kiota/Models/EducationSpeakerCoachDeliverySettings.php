...
class EducationSpeakerCoachDeliverySettings implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $areFillerWordsEnabled Indicates whether the student should receive feedback on their filler words from the Speaker Coach.
    */
    private ?bool $areFillerWordsEnabled = null;
    
    /**
     * @var bool|null $isPaceEnabled Indicates whether the student should receive feedback on their pace from the Speaker Coach.
    */
    private ?bool $isPaceEnabled = null;
    
    /**
     * @var bool|null $isPitchEnabled Indicates whether the student should receive feedback on their pitch from the Speaker Coach.
    */
    private ?bool $isPitchEnabled = null;
    
    /**
     * @var bool|null $isPronunciationEnabled Indicates whether the student should receive feedback on their pronunciation from the Speaker Coach. This is automatically enabled if isAiFeedbackEnabled is set to true on the educationSpeakerProgressResource, or if spokenLanguageLocale is set to a value besides en-US on the educationSpeakerProgressResource.
    */
    private ?bool $isPronunciationEnabled = null;
    ...
    */
    public function getAreFillerWordsEnabled(): ?bool {
        return $this->areFillerWordsEnabled;
    }
    ...
    */
    public function getIsPronunciationEnabled(): ?bool {
        return $this->isPronunciationEnabled;
    }
    ...
    */
    public function setAreFillerWordsEnabled(?bool $value): void {
        $this->areFillerWordsEnabled = $value;
    }
    ...
    */
    public function setIsPronunciationEnabled(?bool $value): void {
        $this->isPronunciationEnabled = $value;
    }

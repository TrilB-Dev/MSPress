...
{
    /**
     * @var array<CalendarRoleType>|null $allowedRoles List of allowed sharing or delegating permission levels for the calendar. The possible values are: none, freeBusyRead, limitedRead, read, write, delegateWithoutPrivateEventAccess, delegateWithPrivateEventAccess, custom.
    */
    private ?array $allowedRoles = null;
    
    /**
     * @var EmailAddress|null $emailAddress Represents a share recipient or delegate who has access to the calendar. For the 'My Organization' share recipient, the address property is null. Read-only.
    */
    private ?EmailAddress $emailAddress = null;
    
    /**
     * @var bool|null $isInsideOrganization True if the user in context (recipient or delegate) is inside the same organization as the calendar owner.
    */
    private ?bool $isInsideOrganization = null;
    
    /**
     * @var bool|null $isRemovable True if the user can be removed from the list of recipients or delegates for the specified calendar, false otherwise. The 'My organization' user determines the permissions other people within your organization have to the given calendar. You can't remove 'My organization' as a share recipient to a calendar.
    */
    private ?bool $isRemovable = null;
    
    /**
     * @var CalendarRoleType|null $role Current permission level of the calendar share recipient or delegate.
    */

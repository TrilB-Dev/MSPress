...
class PhoneAuthenticationMethod extends AuthenticationMethod implements Parsable 
{
    ...
    */
    ...
    /**
     * @var AuthenticationPhoneType|null $phoneType The type of this phone. The possible values are: mobile, alternateMobile, or office.
    */
    private ?AuthenticationPhoneType $phoneType = null;
    
    /**
     * @var AuthenticationMethodSignInState|null $smsSignInState Whether a phone is ready to be used for SMS sign-in or not. The possible values are: notSupported, notAllowedByPolicy, notEnabled, phoneNumberNotUnique, ready, or notConfigured, unknownFutureValue.
    */

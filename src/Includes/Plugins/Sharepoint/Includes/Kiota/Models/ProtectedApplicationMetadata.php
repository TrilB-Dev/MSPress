...
{
    /**
     * @var PolicyLocation|null $applicationLocation The client (application) ID of the Microsoft Entra application. Required.
    */
    private ?PolicyLocation $applicationLocation = null;

...
{
    /**
     * @var CustomCalloutExtension|null $customExtension Indicates the custom workflow extension that will be executed at this stage. Nullable. Supports $expand.
    */
    private ?CustomCalloutExtension $customExtension = null;
    
    /**
     * @var AccessPackageCustomExtensionStage|null $stage The stage property
    */

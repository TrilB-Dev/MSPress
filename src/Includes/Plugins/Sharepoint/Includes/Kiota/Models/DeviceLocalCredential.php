...
{
    /**
     * @var string|null $accountName The name of the local admin account for which LAPS is enabled.
    */
    private ?string $accountName = null;
    
    /**
     * @var string|null $accountSid The SID of the local admin account for which LAPS is enabled.
    */
    private ?string $accountSid = null;
    
    /**
     * @var DateTime|null $backupDateTime When the local administrator account credential for the device object was backed up to Azure Active Directory.
    */
    private ?DateTime $backupDateTime = null;
    
    /**
     * @var string|null $passwordBase64 The password for the local administrator account that is backed up to Azure Active Directory and returned as a Base64 encoded value.
    */

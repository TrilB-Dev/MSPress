...
class AuthenticationAttributeCollectionPage implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<AuthenticationAttributeCollectionPageViewConfiguration>|null $views A collection of displays of the attribute collection page.
    */

...
{
    /**
     * @var string|null $createdBy The userPrincipalName of the user or identity that created the control configuration.
    */
    private ?string $createdBy = null;
    
    /**
     * @var DateTime|null $createdDateTime The date and time the control configuration was created.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var bool|null $isEnabled Determines whether or not the control configuration is enabled.
    */
    private ?bool $isEnabled = null;
    
    /**
     * @var string|null $modifiedBy The userPrincipalName of the user or identity that modified the control configuration.
    */
    private ?string $modifiedBy = null;
    
    /**
     * @var DateTime|null $modifiedDateTime The date and time the control configuration was modified.
    */

...
class CalculatedColumn implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $format For dateTime output types, the format of the value. The possible values are: dateOnly or dateTime.
    */
    ...
    */
    ...
    /**
     * @var string|null $outputType The output type used to format values in this column. The possible values are: boolean, currency, dateTime, number, or text.
    */

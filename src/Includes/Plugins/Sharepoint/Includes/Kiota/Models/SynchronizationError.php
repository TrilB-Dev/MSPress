...
class SynchronizationError implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $code The error code. For example, AzureDirectoryB2BManagementPolicyCheckFailure.
    */
    private ?string $code = null;
    
    /**
     * @var string|null $message The error message. For example, Policy permitting auto-redemption of invitations not configured.
    */
    ...
    */
    ...
    /**
     * @var bool|null $tenantActionable The action to take to resolve the error. For example, false.
    */

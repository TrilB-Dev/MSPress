...
class ChallengingWord implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $count Number of times the word was found challenging by the student during the reading session.
    */
    ...
    */
    ...
    /**
     * @var string|null $word The specific word that the student found challenging during the reading session.
    */

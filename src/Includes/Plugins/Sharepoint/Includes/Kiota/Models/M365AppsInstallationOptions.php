...
{
    /**
     * @var AppsInstallationOptionsForMac|null $appsForMac The appsForMac property
    */
    private ?AppsInstallationOptionsForMac $appsForMac = null;
    
    /**
     * @var AppsInstallationOptionsForWindows|null $appsForWindows The appsForWindows property
    */
    private ?AppsInstallationOptionsForWindows $appsForWindows = null;
    
    /**
     * @var AppsUpdateChannelType|null $updateChannel The updateChannel property
    */
    private ?AppsUpdateChannelType $updateChannel = null;

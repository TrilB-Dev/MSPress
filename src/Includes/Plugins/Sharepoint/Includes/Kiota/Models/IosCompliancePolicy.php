...
class IosCompliancePolicy extends DeviceCompliancePolicy implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $securityBlockJailbrokenDevices Indicates the device should not be jailbroken. When TRUE, if the device is detected as jailbroken it will be reported non-compliant. When FALSE, the device is not reported as non-compliant regardless of device jailbroken state. Default is FALSE.
    */

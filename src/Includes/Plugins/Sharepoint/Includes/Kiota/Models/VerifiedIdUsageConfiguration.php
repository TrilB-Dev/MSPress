...
class VerifiedIdUsageConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $isEnabledForTestOnly Sets profile usage for evaluation (test-only) or production.
    */
    private ?bool $isEnabledForTestOnly = null;
    ...
    */
    ...
    /**
     * @var VerifiedIdUsageConfigurationPurpose|null $purpose The purpose property
    */
    private ?VerifiedIdUsageConfigurationPurpose $purpose = null;
    ...
    */
    public function getIsEnabledForTestOnly(): ?bool {
        return $this->isEnabledForTestOnly;
    }
    ...
    */
    public function setIsEnabledForTestOnly(?bool $value): void {
        $this->isEnabledForTestOnly = $value;
    }

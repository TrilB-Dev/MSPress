...
{
    /**
     * @var PrivilegedAccessGroupRelationships|null $accessId The identifier of membership or ownership eligibility relationship to the group. Required. The possible values are: owner, member, unknownFutureValue.
    */
    private ?PrivilegedAccessGroupRelationships $accessId = null;
    
    /**
     * @var Group|null $group References the group that is the scope of the membership or ownership eligibility request through PIM for Groups. Supports $expand and $select nested in $expand for select properties like id, displayName, and mail.
    */
    private ?Group $group = null;
    
    /**
     * @var string|null $groupId The identifier of the group representing the scope of the membership and ownership eligibility through PIM for Groups. Required.
    */
    private ?string $groupId = null;
    
    /**
     * @var DirectoryObject|null $principal References the principal that's in the scope of the membership or ownership eligibility request through the group that's governed by PIM. Supports $expand and $select nested in $expand for id only.
    */
    private ?DirectoryObject $principal = null;
    
    /**
     * @var string|null $principalId The identifier of the principal whose membership or ownership eligibility to the group is managed through PIM for Groups. Required.
    */
    private ?string $principalId = null;
    
    /**
     * @var PrivilegedAccessGroupEligibilitySchedule|null $targetSchedule Schedule created by this request.
    */
    private ?PrivilegedAccessGroupEligibilitySchedule $targetSchedule = null;
    
    /**
     * @var string|null $targetScheduleId The identifier of the schedule that's created from the eligibility request. Optional.
    */

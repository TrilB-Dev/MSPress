...
class SynchronizationTemplate extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<SynchronizationMetadataEntry>|null $metadata Additional extension properties. Unless mentioned explicitly, metadata values should not be changed.
    */

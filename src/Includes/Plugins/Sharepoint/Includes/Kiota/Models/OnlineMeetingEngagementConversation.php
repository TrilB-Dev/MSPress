...
{
    /**
     * @var EngagementConversationModerationState|null $moderationState Represents the moderation state of an Engage conversation message.
    */
    private ?EngagementConversationModerationState $moderationState = null;
    
    /**
     * @var OnlineMeeting|null $onlineMeeting The onlineMeeting property
    */
    private ?OnlineMeeting $onlineMeeting = null;
    
    /**
     * @var string|null $onlineMeetingId The unique identifier of the online meeting associated with this conversation. The online meeting ID links the conversation to a specific meeting instance.
    */
    private ?string $onlineMeetingId = null;
    
    /**
     * @var EngagementIdentitySet|null $organizer The organizer property
    */
    private ?EngagementIdentitySet $organizer = null;
    
    /**
     * @var int|null $upvoteCount The number of upvotes the conversation received.
    */

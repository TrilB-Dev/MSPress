...
{
    /**
     * @var CommunicationsIdentitySet|null $createdBy The identity information for the creator of the virtual event. Inherited from virtualEvent.
    */
    private ?CommunicationsIdentitySet $createdBy = null;
    
    /**
     * @var ItemBody|null $description A description of the virtual event.
    */
    private ?ItemBody $description = null;
    
    /**
     * @var string|null $displayName The display name of the virtual event.
    */
    private ?string $displayName = null;
    
    /**
     * @var DateTimeTimeZone|null $endDateTime The end time of the virtual event. The timeZone property can be set to any of the time zones currently supported by Windows. For details on how to get all available time zones using PowerShell, see Get-TimeZone.
    */
    private ?DateTimeTimeZone $endDateTime = null;
    
    /**
     * @var array<VirtualEventExternalInformation>|null $externalEventInformation The external information of a virtual event. Returned only for event organizers or coorganizers; otherwise, null.
    */
    private ?array $externalEventInformation = null;
    
    /**
     * @var bool|null $isRegistrationRequired Indicates whether attendee registration is enabled for the virtual event.
    */
    private ?bool $isRegistrationRequired = null;
    
    /**
     * @var array<VirtualEventPresenter>|null $presenters The virtual event presenters.
    */
    private ?array $presenters = null;
    
    /**
     * @var array<VirtualEventSession>|null $sessions The sessions for the virtual event.
    */
    private ?array $sessions = null;
    
    /**
     * @var VirtualEventSettings|null $settings The virtual event settings.
    */
    private ?VirtualEventSettings $settings = null;
    
    /**
     * @var DateTimeTimeZone|null $startDateTime Start time of the virtual event. The timeZone property can be set to any of the time zones currently supported by Windows. For details on how to get all available time zones using PowerShell, see Get-TimeZone.
    */
    private ?DateTimeTimeZone $startDateTime = null;
    
    /**
     * @var VirtualEventStatus|null $status The status of the virtual event. The possible values are: draft, published, canceled, and unknownFutureValue.
    */
    private ?VirtualEventStatus $status = null;

...
{
    /**
     * @var InboundOutboundPolicyConfiguration|null $automaticUserConsentSettings Determines the partner-specific configuration for automatic user consent settings. Unless configured, the inboundAllowed and outboundAllowed properties are null and inherit from the default settings, which is always false.
    */
    ...
    */
    ...
    /**
     * @var TemplateApplicationLevel|null $templateApplicationLevel The templateApplicationLevel property
    */
    private ?TemplateApplicationLevel $templateApplicationLevel = null;

...
class CloudPcAuditResource implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $displayName The display name of the modified resource entity.
    */
    private ?string $displayName = null;
    
    /**
     * @var array<CloudPcAuditProperty>|null $modifiedProperties The list of modified properties.
    */
    ...
    */
    ...
    /**
     * @var string|null $resourceId The unique identifier of the modified resource entity.
    */

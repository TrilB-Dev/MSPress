...
class UnifiedRoleDefinition extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<UnifiedRoleDefinition>|null $inheritsPermissionsFrom Read-only collection of role definitions that the given role definition inherits from. Only Microsoft Entra built-in roles (isBuiltIn is true) support this attribute. Supports $expand.
    */
    private ?array $inheritsPermissionsFrom = null;
    
    /**
     * @var bool|null $isBuiltIn Flag indicating whether the role definition is part of the default set included in Microsoft Entra or a custom definition. Read-only. Supports $filter (eq, in).
    */

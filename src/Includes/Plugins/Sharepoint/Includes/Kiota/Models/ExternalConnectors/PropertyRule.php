...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\BinaryOperator;
...
class PropertyRule implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<string>|null $values A collection with one or many strings. One or more specified strings are matched with the specified property using the specified operation. Required.
    */

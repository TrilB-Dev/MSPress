...
{
    /**
     * @var int|null $appCrashCount The number of application crashes for the device. Valid values 0 to 2147483647. Supports: $filter, $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    private ?int $appCrashCount = null;
    
    /**
     * @var int|null $appHangCount The number of application hangs for the device. Valid values 0 to 2147483647. Supports: $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    private ?int $appHangCount = null;
    
    /**
     * @var int|null $crashedAppCount The number of distinct application crashes for the device. Valid values 0 to 2147483647. Supports: $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    private ?int $crashedAppCount = null;
    
    /**
     * @var float|null $deviceAppHealthScore The application health score of the device. Valid values 0 to 100. Supports: $filter, $select, $OrderBy. Read-only. Valid values -1.79769313486232E+308 to 1.79769313486232E+308
    */
    ...
    */
    ...
    /**
     * @var string|null $deviceManufacturer The manufacturer name of the device. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $deviceManufacturer = null;
    
    /**
     * @var string|null $deviceModel The model name of the device. Supports: $select, $OrderBy. Read-only.
    */
    ...
    */
    ...
    /**
     * @var int|null $meanTimeToFailureInMinutes The mean time to failure for the application in minutes. Valid values 0 to 2147483647. Supports: $filter, $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */

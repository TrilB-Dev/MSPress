...
{
    /**
     * @var array<string>|null $verifiedIdProfiles A collection of Verified ID profile IDs. The profiles define the credentials that users can present to prove their id when signing in, onboarding, or recovering. Verified ID profiles are managed through the Verified ID APIs.
    */
    private ?array $verifiedIdProfiles = null;
    ...
    */
    public function getVerifiedIdProfiles(): ?array {
        return $this->verifiedIdProfiles;
    }

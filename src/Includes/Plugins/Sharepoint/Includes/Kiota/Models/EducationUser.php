...
class EducationUser extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var EducationExternalSource|null $externalSource Where this user was created from. The possible values are: sis, manual.
    */
    ...
    */
    ...
    /**
     * @var string|null $mail The SMTP address for the user, for example, jeff@contoso.com. Read-Only. Supports $filter.
    */
    ...
    */
    ...
    /**
     * @var string|null $officeLocation The office location for the user.
    */
    private ?string $officeLocation = null;
    
    /**
     * @var EducationOnPremisesInfo|null $onPremisesInfo Additional information used to associate the Microsoft Entra user with its Active Directory counterpart.
    */

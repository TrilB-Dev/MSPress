...
{
    /**
     * @var RecoveryJobFilteringCriteriaBase|null $filteringCriteria Optional filtering criteria used to scope the job to specific entity types or entity IDs.
    */
    private ?RecoveryJobFilteringCriteriaBase $filteringCriteria = null;
    
    /**
     * @var DateTime|null $jobCompletionDateTime The date and time when the job completed. Null if the job is still running.
    */
    private ?DateTime $jobCompletionDateTime = null;
    
    /**
     * @var DateTime|null $jobStartDateTime The date and time when the job started.
    */
    private ?DateTime $jobStartDateTime = null;
    
    /**
     * @var RecoveryStatus|null $status The status property
    */
    private ?RecoveryStatus $status = null;
    
    /**
     * @var DateTime|null $targetStateDateTime The target snapshot timestamp to which the tenant is being restored. Supports $filter (eq, ne).
    */
    private ?DateTime $targetStateDateTime = null;
    
    /**
     * @var int|null $totalChangedLinksCalculated The total count of changed directory object links (relationships) calculated by the job. null until the job completes calculation. Not all calculated link changes may be successfully applied; see totalLinksModified on derived types for the count of links that were actually modified.
    */
    private ?int $totalChangedLinksCalculated = null;
    
    /**
     * @var int|null $totalChangedObjectsCalculated The total count of changed directory objects calculated by the job. null until the job completes calculation. Not all calculated object changes may be successfully applied; see totalObjectsModified on derived types for the count of objects that were actually modified.
    */
    private ?int $totalChangedObjectsCalculated = null;
    ...
    */
    public function getJobCompletionDateTime(): ?DateTime {
        return $this->jobCompletionDateTime;
    }
    ...
    */
    public function getTargetStateDateTime(): ?DateTime {
        return $this->targetStateDateTime;
    }
    ...
    */
    public function getTotalChangedLinksCalculated(): ?int {
        return $this->totalChangedLinksCalculated;
    }
    ...
    */
    public function getTotalChangedObjectsCalculated(): ?int {
        return $this->totalChangedObjectsCalculated;
    }
    ...
    */
    public function setJobCompletionDateTime(?DateTime $value): void {
        $this->jobCompletionDateTime = $value;
    }
    ...
    */
    public function setTargetStateDateTime(?DateTime $value): void {
        $this->targetStateDateTime = $value;
    }
    ...
    */
    public function setTotalChangedLinksCalculated(?int $value): void {
        $this->totalChangedLinksCalculated = $value;
    }
    ...
    */
    public function setTotalChangedObjectsCalculated(?int $value): void {
        $this->totalChangedObjectsCalculated = $value;
    }

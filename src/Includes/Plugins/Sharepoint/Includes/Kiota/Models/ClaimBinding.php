...
class ClaimBinding implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var MatchConfidenceLevel|null $matchConfidenceLevel The matchConfidenceLevel property
    */
    private ?MatchConfidenceLevel $matchConfidenceLevel = null;
    ...
    */
    ...
    /**
     * @var string|null $sourceAttribute Source attribute name from the source system, for example a directory attribute.
    */
    private ?string $sourceAttribute = null;
    
    /**
     * @var string|null $verifiedIdClaim Verified ID claim name or path, for example vc.credentialSubject.firstName.
    */
    private ?string $verifiedIdClaim = null;
    ...
    */
    public function setMatchConfidenceLevel(?MatchConfidenceLevel $value): void {
        $this->matchConfidenceLevel = $value;
    }

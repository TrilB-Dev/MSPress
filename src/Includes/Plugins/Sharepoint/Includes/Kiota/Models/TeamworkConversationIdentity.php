...
{
    /**
     * @var TeamworkConversationIdentityType|null $conversationIdentityType Type of conversation. The possible values are: team, channel, chat, and unknownFutureValue.
    */

...
class EmployeeOrgData implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $costCenter The cost center associated with the user. Requires $select to retrieve. Supports $filter.
    */
    private ?string $costCenter = null;
    
    /**
     * @var string|null $division The name of the division in which the user works. Requires $select to retrieve. Supports $filter.
    */

...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\TermStore\Set;
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\TermStore\Term;
...
class TermColumn implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $allowMultipleValues Specifies whether the column allows more than one value.
    */

...
{
    /**
     * @var bool|null $isAnswerEditable Specifies whether the requestor is allowed to edit answers to questions for an assignment by posting an update to accessPackageAssignmentRequest.
    */
    ...
    */
    ...
    /**
     * @var array<AccessPackageLocalizedText>|null $localizations The text of the question represented in a format for a specific locale.
    */
    ...
    */
    ...
    /**
     * @var string|null $text The text of the question to show to the requestor.
    */

...
class MicrosoftAuthenticatorFeatureSettings implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var AuthenticationMethodFeatureConfiguration|null $displayAppInformationRequiredState Determines whether the user's Authenticator app shows them the client app they're signing into.
    */
    private ?AuthenticationMethodFeatureConfiguration $displayAppInformationRequiredState = null;
    
    /**
     * @var AuthenticationMethodFeatureConfiguration|null $displayLocationInformationRequiredState Determines whether the user's Authenticator app shows them the geographic location of where the authentication request originated from.
    */

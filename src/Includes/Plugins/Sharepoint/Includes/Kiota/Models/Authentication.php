...
class Authentication extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<ExternalAuthenticationMethod>|null $externalAuthenticationMethods Represents the external MFA registered to a user for authentication using an external identity provider.
    */
    private ?array $externalAuthenticationMethods = null;
    ...
    */
    ...
    /**
     * @var array<LongRunningOperation>|null $operations Represents the status of a long-running operation, such as a password reset operation.
    */
    private ?array $operations = null;
    
    /**
     * @var array<PasswordAuthenticationMethod>|null $passwordMethods Represents the password registered to a user for authentication. For security, the password itself is never returned in the object, but action can be taken to reset a password.
    */
    ...
    */
    ...
    /**
     * @var array<PlatformCredentialAuthenticationMethod>|null $platformCredentialMethods Represents a platform credential instance registered to a user on Mac OS.
    */
    private ?array $platformCredentialMethods = null;
    
    /**
     * @var array<SoftwareOathAuthenticationMethod>|null $softwareOathMethods The software OATH time-based one-time password (TOTP) applications registered to a user for authentication.
    */
    ...
    */
    public function setExternalAuthenticationMethods(?array $value): void {
        $this->externalAuthenticationMethods = $value;
    }

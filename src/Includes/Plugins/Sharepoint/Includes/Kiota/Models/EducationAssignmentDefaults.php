...
{
    /**
     * @var EducationAddedStudentAction|null $addedStudentAction Class-level default behavior for handling students who are added after the assignment is published. The possible values are: none, assignIfOpen.
    */
    ...
    */
    ...
    /**
     * @var string|null $notificationChannelUrl Default Teams channel to which notifications are sent. Default value is null.
    */

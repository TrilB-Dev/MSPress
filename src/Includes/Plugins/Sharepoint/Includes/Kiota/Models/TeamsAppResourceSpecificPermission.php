...
class TeamsAppResourceSpecificPermission implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var TeamsAppResourceSpecificPermissionType|null $permissionType The type of resource-specific permission.
    */
    private ?TeamsAppResourceSpecificPermissionType $permissionType = null;
    
    /**
     * @var string|null $permissionValue The name of the resource-specific permission.
    */

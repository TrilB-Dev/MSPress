...
{
    /**
     * @var bool|null $bold Inidicates whether the font is bold.
    */
    private ?bool $bold = null;
    
    /**
     * @var string|null $color The HTML color code representation of the text color. For example, #FF0000 represents the color red.
    */
    private ?string $color = null;
    
    /**
     * @var bool|null $italic Inidicates whether the font is italic.
    */
    ...
    */
    ...
    /**
     * @var float|null $size The font size.
    */
    private ?float $size = null;
    
    /**
     * @var string|null $underline The type of underlining applied to the font. The possible values are: None, Single, Double, SingleAccountant, DoubleAccountant.
    */

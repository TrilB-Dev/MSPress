...
class InvitedUserMessageInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<Recipient>|null $ccRecipients Additional recipients the invitation message should be sent to. Currently only one additional recipient is supported.
    */
    private ?array $ccRecipients = null;
    
    /**
     * @var string|null $customizedMessageBody Customized message body you want to send if you don't want the default message. Only plain text is allowed.
    */

...
{
    /**
     * @var array<RecycleBinItem>|null $items List of the recycleBinItems deleted by a user.
    */
    private ?array $items = null;
    
    /**
     * @var RecycleBinSettings|null $settings The settings property
    */
    private ?RecycleBinSettings $settings = null;

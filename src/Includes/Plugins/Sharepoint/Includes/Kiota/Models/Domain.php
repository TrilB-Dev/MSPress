...
class Domain extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<DirectoryObject>|null $domainNameReferences The objects such as users and groups that reference the domain ID. Read-only, Nullable. Doesn't support $expand. Supports $filter by the OData type of objects returned. For example, /domains/{domainId}/domainNameReferences/microsoft.graph.user and /domains/{domainId}/domainNameReferences/microsoft.graph.group.
    */
    private ?array $domainNameReferences = null;
    
    /**
     * @var array<InternalDomainFederation>|null $federationConfiguration Domain settings configured by a customer when federated with Microsoft Entra ID. Doesn't support $expand.
    */
    private ?array $federationConfiguration = null;
    
    /**
     * @var bool|null $isAdminManaged The value of the property is false if the DNS record management of the domain is delegated to Microsoft 365. Otherwise, the value is true. Not nullable
    */
    private ?bool $isAdminManaged = null;
    
    /**
     * @var bool|null $isDefault true if this is the default domain that is used for user creation. There's only one default domain per company. Not nullable.
    */
    private ?bool $isDefault = null;
    
    /**
     * @var bool|null $isInitial true if this is the initial domain created by Microsoft Online Services (contoso.com). There's only one initial domain per company. Not nullable
    */
    ...
    */
    ...
    /**
     * @var bool|null $isVerified true if the domain completed domain ownership verification. Not nullable.
    */
    ...
    */
    ...
    /**
     * @var int|null $passwordNotificationWindowInDays Specifies the number of days before a user receives notification that their password expires. If the property isn't set, a default value of 14 days is used.
    */
    private ?int $passwordNotificationWindowInDays = null;
    
    /**
     * @var int|null $passwordValidityPeriodInDays Specifies the length of time that a password is valid before it must be changed. If the property isn't set, a default value of 90 days is used.
    */
    private ?int $passwordValidityPeriodInDays = null;
    
    /**
     * @var Domain|null $rootDomain Root domain of a subdomain. Read-only, Nullable. Supports $expand.
    */
    private ?Domain $rootDomain = null;
    
    /**
     * @var array<DomainDnsRecord>|null $serviceConfigurationRecords DNS records the customer adds to the DNS zone file of the domain before the domain can be used by Microsoft Online services. Read-only, Nullable. Doesn't support $expand.
    */
    ...
    */
    ...
    /**
     * @var array<DomainDnsRecord>|null $verificationDnsRecords DNS records that the customer adds to the DNS zone file of the domain before the customer can complete domain ownership verification with Microsoft Entra ID. Read-only, Nullable. Doesn't support $expand.
    */

...
{
    /**
     * @var array<Approval>|null $assignmentApprovals The assignmentApprovals property
    */
    private ?array $assignmentApprovals = null;
    
    /**
     * @var array<PrivilegedAccessGroupAssignmentScheduleInstance>|null $assignmentScheduleInstances The instances of assignment schedules to activate a just-in-time access.
    */
    private ?array $assignmentScheduleInstances = null;
    
    /**
     * @var array<PrivilegedAccessGroupAssignmentScheduleRequest>|null $assignmentScheduleRequests The schedule requests for operations to create, update, delete, extend, and renew an assignment.
    */
    private ?array $assignmentScheduleRequests = null;
    
    /**
     * @var array<PrivilegedAccessGroupAssignmentSchedule>|null $assignmentSchedules The assignment schedules to activate a just-in-time access.
    */
    private ?array $assignmentSchedules = null;
    
    /**
     * @var array<PrivilegedAccessGroupEligibilityScheduleInstance>|null $eligibilityScheduleInstances The instances of eligibility schedules to activate a just-in-time access.
    */
    private ?array $eligibilityScheduleInstances = null;
    
    /**
     * @var array<PrivilegedAccessGroupEligibilityScheduleRequest>|null $eligibilityScheduleRequests The schedule requests for operations to create, update, delete, extend, and renew an eligibility.
    */
    private ?array $eligibilityScheduleRequests = null;
    
    /**
     * @var array<PrivilegedAccessGroupEligibilitySchedule>|null $eligibilitySchedules The eligibility schedules to activate a just-in-time access.
    */
    private ?array $eligibilitySchedules = null;

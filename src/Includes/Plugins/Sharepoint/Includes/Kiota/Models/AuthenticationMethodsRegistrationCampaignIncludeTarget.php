...
class AuthenticationMethodsRegistrationCampaignIncludeTarget implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $id The object identifier of a Microsoft Entra user or group.
    */
    ...
    */
    ...
    /**
     * @var string|null $targetedAuthenticationMethod The authentication method that the user is prompted to register. The value can be Fido2 or microsoftAuthenticator.
    */

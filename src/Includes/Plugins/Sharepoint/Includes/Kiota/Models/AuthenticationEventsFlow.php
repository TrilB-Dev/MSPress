...
{
    /**
     * @var AuthenticationConditions|null $conditions The conditions representing the context of the authentication request that's used to decide whether the events policy is invoked.  Supports $filter (eq). See support for filtering on user flows for syntax information.
    */
    private ?AuthenticationConditions $conditions = null;
    
    /**
     * @var string|null $description The description of the events policy.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $displayName Required. The display name for the events policy.
    */

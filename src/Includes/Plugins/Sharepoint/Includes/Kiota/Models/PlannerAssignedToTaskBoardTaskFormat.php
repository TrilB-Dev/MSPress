...
class PlannerAssignedToTaskBoardTaskFormat extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $unassignedOrderHint Hint value used to order the task on the AssignedTo view of the Task Board when the task isn't assigned to anyone, or if the orderHintsByAssignee dictionary doesn't provide an order hint for the user the task is assigned to. The format is defined as outlined here.
    */

...
class EducationClass extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var EducationExternalSource|null $externalSource How this class was created. The possible values are: sis, manual.
    */
    ...
    */
    ...
    /**
     * @var array<EducationModule>|null $modules All modules in the class. Nullable.
    */

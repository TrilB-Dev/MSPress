...
{
    /**
     * @var Identity|null $audience Optional. The audience associated with this action.
    */
    private ?Identity $audience = null;
    
    /**
     * @var Identity|null $group Optional. The group associated with this action.
    */

...
class Hashes implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $quickXorHash A proprietary hash of the file that can be used to determine if the contents of the file change (if available). Read-only.
    */
    ...
    */
    ...
    /**
     * @var string|null $sha256Hash This property isn't supported. Don't use.
    */

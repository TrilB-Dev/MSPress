...
{
    /**
     * @var string|null $fromEmail Email address of the user.
    */
    private ?string $fromEmail = null;
    
    /**
     * @var string|null $fromName Display name of the user.
    */
    private ?string $fromName = null;
    
    /**
     * @var bool|null $isExternalSender Indicates whether the sender isn't from the user's organization.
    */
    private ?bool $isExternalSender = null;
    
    /**
     * @var string|null $subject The subject of the email address sent to the user.
    */

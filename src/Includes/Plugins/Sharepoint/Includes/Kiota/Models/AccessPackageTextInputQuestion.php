...
{
    /**
     * @var bool|null $isSingleLineQuestion Indicates whether the answer is in single or multiple line format.
    */
    private ?bool $isSingleLineQuestion = null;
    
    /**
     * @var string|null $regexPattern The regular expression pattern that any answer to this question must match.
    */

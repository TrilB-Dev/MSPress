...
{
    /**
     * @var PrivilegedAccessGroupRelationships|null $accessId The identifier of the membership or ownership assignment relationship to the group. Required. The possible values are: owner, member,  unknownFutureValue. Supports $filter (eq).
    */
    private ?PrivilegedAccessGroupRelationships $accessId = null;
    
    /**
     * @var PrivilegedAccessGroupEligibilityScheduleInstance|null $activatedUsing When the request activates a membership or ownership in PIM for Groups, this object represents the eligibility request for the group. Otherwise, it is null.
    */
    private ?PrivilegedAccessGroupEligibilityScheduleInstance $activatedUsing = null;
    
    /**
     * @var string|null $assignmentScheduleId The identifier of the privilegedAccessGroupAssignmentSchedule from which this instance was created. Required. Supports $filter (eq, ne).
    */
    private ?string $assignmentScheduleId = null;
    
    /**
     * @var PrivilegedAccessGroupAssignmentType|null $assignmentType Indicates whether the membership or ownership assignment is granted through activation of an eligibility or through direct assignment. Required. The possible values are: assigned, activated, unknownFutureValue. Supports $filter (eq).
    */
    private ?PrivilegedAccessGroupAssignmentType $assignmentType = null;
    
    /**
     * @var Group|null $group References the group that is the scope of the membership or ownership assignment through PIM for Groups. Supports $expand.
    */
    private ?Group $group = null;
    
    /**
     * @var string|null $groupId The identifier of the group representing the scope of the membership or ownership assignment through PIM for Groups. Optional. Supports $filter (eq).
    */
    private ?string $groupId = null;
    
    /**
     * @var PrivilegedAccessGroupMemberType|null $memberType Indicates whether the assignment is derived from a group assignment. It can further imply whether the caller can manage the assignment schedule. Required. The possible values are: direct, group, unknownFutureValue. Supports $filter (eq).
    */
    private ?PrivilegedAccessGroupMemberType $memberType = null;
    
    /**
     * @var DirectoryObject|null $principal References the principal that's in the scope of the membership or ownership assignment request through the group that's governed by PIM. Supports $expand.
    */
    private ?DirectoryObject $principal = null;
    
    /**
     * @var string|null $principalId The identifier of the principal whose membership or ownership assignment to the group is managed through PIM for Groups. Required. Supports $filter (eq).
    */

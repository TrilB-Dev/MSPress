...
class BookingStaffMember extends BookingStaffMemberBase implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime The date, time, and time zone when the staff member was created. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    ...
    */
    ...
    /**
     * @var string|null $emailAddress The email address of the staff member. This email address can be in the same Microsoft 365 tenant as the business, or in a different email domain. This email address can be used if the sendConfirmationsToOwner property is set to true in the scheduling policy of the business. Required.
    */
    private ?string $emailAddress = null;
    
    /**
     * @var bool|null $isEmailNotificationEnabled Indicates that a staff member is notified via email when a booking assigned to them is created or changed. The default value is true.
    */
    private ?bool $isEmailNotificationEnabled = null;
    
    /**
     * @var DateTime|null $lastUpdatedDateTime The date, time, and time zone when the staff member was last updated. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $lastUpdatedDateTime = null;
    
    /**
     * @var BookingStaffMembershipStatus|null $membershipStatus The membershipStatus property
    */
    private ?BookingStaffMembershipStatus $membershipStatus = null;
    ...
    */
    ...
    /**
     * @var array<BookingWorkHours>|null $workingHours The range of hours each day of the week that the staff member is available for booking. By default, they're initialized to be the same as the businessHours property of the business.
    */

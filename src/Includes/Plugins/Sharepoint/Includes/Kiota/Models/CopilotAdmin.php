...
{
    /**
     * @var CopilotAdminCatalog|null $catalog The catalog property
    */
    private ?CopilotAdminCatalog $catalog = null;
    
    /**
     * @var CopilotAdminSetting|null $settings The settings property
    */
    private ?CopilotAdminSetting $settings = null;

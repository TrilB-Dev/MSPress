...
class AccessPackageSubject extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $objectId The object identifier of the subject. null if the subject isn't yet a user in the tenant.
    */
    private ?string $objectId = null;
    
    /**
     * @var string|null $onPremisesSecurityIdentifier A string representation of the principal's security identifier, if known, or null if the subject doesn't have a security identifier.
    */

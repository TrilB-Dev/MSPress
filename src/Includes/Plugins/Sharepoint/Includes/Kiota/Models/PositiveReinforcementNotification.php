...
{
    /**
     * @var NotificationDeliveryPreference|null $deliveryPreference Delivery preference. The possible values are: unknown, deliverImmedietly, deliverAfterCampaignEnd, unknownFutureValue.
    */
    private ?NotificationDeliveryPreference $deliveryPreference = null;

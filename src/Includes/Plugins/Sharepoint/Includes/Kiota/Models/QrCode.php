...
{
    /**
     * @var DateTime|null $createdDateTime The date and time when the QR code was created. Read-only.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var DateTime|null $expireDateTime The date and time when the QR code expires. For standard QR codes, the lifetime is in days with a maximum of 395 days (13 months) and a default of 365 days. For temporary QR codes, the lifetime must be between 1-12 hours. The expireDateTime can be edited for standard QR codes but not for temporary QR codes.
    */
    private ?DateTime $expireDateTime = null;
    
    /**
     * @var QrCodeImageDetails|null $image The QR code image data. This property is only returned at the time of creating or resetting the QR code because the private key isn't stored on the server.
    */
    private ?QrCodeImageDetails $image = null;
    
    /**
     * @var DateTime|null $lastUsedDateTime The date and time when the QR code was last successfully used for authentication. Read-only.
    */
    private ?DateTime $lastUsedDateTime = null;
    
    /**
     * @var DateTime|null $startDateTime The date and time when the QR code becomes available for use.
    */

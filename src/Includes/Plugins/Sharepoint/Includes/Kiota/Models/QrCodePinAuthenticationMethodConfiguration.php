...
{
    /**
     * @var array<AuthenticationMethodTarget>|null $includeTargets Groups of users that are included and enabled in the policy.
    */
    private ?array $includeTargets = null;
    
    /**
     * @var int|null $pinLength The required length of the PIN. The minimum length is 8 digits (as per NIST standards), and the maximum is 20 digits.
    */
    private ?int $pinLength = null;
    
    /**
     * @var int|null $standardQRCodeLifetimeInDays The lifetime of standard QR codes in days. The default is 365 days and the maximum is 395 days (13 months). The minimum is 1 day.
    */
    private ?int $standardQRCodeLifetimeInDays = null;
    ...
    */
    public function getStandardQRCodeLifetimeInDays(): ?int {
        return $this->standardQRCodeLifetimeInDays;
    }
    ...
    */
    public function setStandardQRCodeLifetimeInDays(?int $value): void {
        $this->standardQRCodeLifetimeInDays = $value;
    }

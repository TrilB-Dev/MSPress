...
class DelegatedAdminRelationshipCustomerParticipant implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $displayName The display name of the customer tenant as set by Microsoft Entra ID. Read-only
    */
    ...
    */
    ...
    /**
     * @var string|null $tenantId The Microsoft Entra ID-assigned tenant ID of the customer tenant.
    */

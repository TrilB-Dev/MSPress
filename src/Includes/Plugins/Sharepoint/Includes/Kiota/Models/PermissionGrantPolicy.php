...
{
    /**
     * @var array<PermissionGrantConditionSet>|null $excludes Condition sets that are excluded in this permission grant policy. Automatically expanded on GET.
    */
    private ?array $excludes = null;
    
    /**
     * @var array<PermissionGrantConditionSet>|null $includes Condition sets that are included in this permission grant policy. Automatically expanded on GET.
    */

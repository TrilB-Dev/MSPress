...
class AppsInstallationOptionsForWindows implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $isMicrosoft365AppsEnabled Specifies whether users can install Microsoft 365 apps, including Skype for Business, on their Windows devices. The default value is true.
    */
    private ?bool $isMicrosoft365AppsEnabled = null;
    
    /**
     * @var bool|null $isProjectEnabled Specifies whether users can install Microsoft Project on their Windows devices. The default value is true.
    */
    private ?bool $isProjectEnabled = null;
    
    /**
     * @var bool|null $isSkypeForBusinessEnabled Specifies whether users can install Skype for Business (standalone) on their Windows devices. The default value is true.
    */
    private ?bool $isSkypeForBusinessEnabled = null;
    
    /**
     * @var bool|null $isVisioEnabled Specifies whether users can install Visio on their Windows devices. The default value is true.
    */
    private ?bool $isVisioEnabled = null;
    ...
    */
    public function setIsMicrosoft365AppsEnabled(?bool $value): void {
        $this->isMicrosoft365AppsEnabled = $value;
    }
    ...
    */
    public function setIsSkypeForBusinessEnabled(?bool $value): void {
        $this->isSkypeForBusinessEnabled = $value;
    }

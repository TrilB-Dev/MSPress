...
class ObjectDefinition implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<AttributeDefinition>|null $attributes Defines attributes of the object.
    */
    private ?array $attributes = null;
    
    /**
     * @var array<ObjectDefinitionMetadataEntry>|null $metadata Metadata for the given object.
    */
    private ?array $metadata = null;
    
    /**
     * @var string|null $name Name of the object. Must be unique within a directory definition. Not nullable.
    */
    ...
    */
    ...
    /**
     * @var array<string>|null $supportedApis The API that the provisioning service queries to retrieve data for synchronization.
    */

...
class TermsOfUseContainer extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<Agreement>|null $agreements Represents a tenant's customizable terms of use agreement that's created and managed with Microsoft Entra ID Governance.
    */

...
{
    /**
     * @var int|null $deviceCount The count of devices which initiated this process on startup. Supports: $filter, $select, $OrderBy. Read-only.
    */
    private ?int $deviceCount = null;
    
    /**
     * @var int|null $medianImpactInMs The median impact of startup process on device boot time in milliseconds. Supports: $filter, $select, $OrderBy. Read-only.
    */
    private ?int $medianImpactInMs = null;
    
    /**
     * @var string|null $processName The name of the startup process. Examples: outlook, excel. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $processName = null;
    
    /**
     * @var string|null $productName The product name of the startup process. Examples: Microsoft Outlook, Microsoft Excel. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $productName = null;
    
    /**
     * @var string|null $publisher The publisher of the startup process. Examples: Microsoft Corporation, Contoso Corp. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $publisher = null;
    
    /**
     * @var int|null $totalImpactInMs The total impact of startup process on device boot time in milliseconds. Supports: $filter, $select, $OrderBy. Read-only.
    */

...
class AuthenticationAttributeCollectionOptionConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $label The label of the option that will be displayed to user, unless overridden.
    */
    ...
    */
    ...
    /**
     * @var string|null $value The value of the option that will be stored.
    */

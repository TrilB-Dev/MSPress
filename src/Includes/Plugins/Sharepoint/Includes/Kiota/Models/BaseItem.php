...
{
    /**
     * @var IdentitySet|null $createdBy Identity of the user, device, or application that created the item. Read-only.
    */
    ...
    */
    ...
    /**
     * @var IdentitySet|null $lastModifiedBy Identity of the user, device, and application that last modified the item. Read-only.
    */
    ...
    */
    ...
    /**
     * @var string|null $webUrl URL that either displays the resource in the browser (for Office file formats), or is a direct link to the file (for other formats). Read-only.
    */

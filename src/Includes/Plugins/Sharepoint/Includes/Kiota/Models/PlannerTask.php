...
class PlannerTask extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $bucketId Bucket ID to which the task belongs. The bucket needs to be in the plan that the task is in. It's 28 characters long and case-sensitive. Format validation is done on the service.
    */
    ...
    */
    ...
    /**
     * @var PlannerTaskDetails|null $details Read-only. Nullable. More details about the task.
    */
    ...
    */
    ...
    /**
     * @var bool|null $hasDescription Read-only. Value is true if the details object of the task has a nonempty description and false otherwise.
    */

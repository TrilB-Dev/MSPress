...
{
    /**
     * @var DateTime|null $completedDateTime The date and time when the snapshot job was completed. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Supports $filter (eq, ne, ge, le) and $orderby.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime The date and time when the snapshot job was created. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Supports $filter (eq, ne, ge, le) and $orderby.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $description User-friendly description of the snapshot given by the user. Supports $filter (eq, ne, startsWith) and $orderby.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $displayName User-friendly name provided by the user during snapshot creation. Supports $filter (eq, ne, startsWith) and $orderby.
    */
    private ?string $displayName = null;
    
    /**
     * @var array<string>|null $errorDetails Details of errors related to the reasons why the snapshot can't complete. Requires $select to retrieve.
    */
    private ?array $errorDetails = null;
    
    /**
     * @var string|null $resourceLocation The URL at which the snapshot file resides. Requires $select to retrieve.
    */
    private ?string $resourceLocation = null;
    
    /**
     * @var array<string>|null $resources The names of all resources included in the request body by the user who created the snapshot. Fetched by the system. Requires $select to retrieve.
    */
    private ?array $resources = null;
    
    /**
     * @var SnapshotJobStatus|null $status The status property
    */
    private ?SnapshotJobStatus $status = null;
    
    /**
     * @var string|null $tenantId Globally unique identifier (GUID) of the tenant for which the snapshot is created. Supports $filter (eq, ne).
    */

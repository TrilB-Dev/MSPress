...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\Identity;
...
{
    /**
     * @var Identity|null $associatedIdentity Identity associated with the endpoint.
    */
    private ?Identity $associatedIdentity = null;
    
    /**
     * @var int|null $cpuCoresCount CPU number of cores used by the media endpoint.
    */
    private ?int $cpuCoresCount = null;
    
    /**
     * @var string|null $cpuName CPU name used by the media endpoint.
    */
    private ?string $cpuName = null;
    
    /**
     * @var int|null $cpuProcessorSpeedInMhz CPU processor speed used by the media endpoint.
    */
    private ?int $cpuProcessorSpeedInMhz = null;
    ...
    */
    ...
    /**
     * @var IdentitySet|null $identity Identity associated with the endpoint. The identity property is deprecated and will stop returning data on June 30, 2026. Going forward, use the associatedIdentity property.
    */
    private ?IdentitySet $identity = null;
    
    /**
     * @var string|null $name Name of the device used by the media endpoint.
    */

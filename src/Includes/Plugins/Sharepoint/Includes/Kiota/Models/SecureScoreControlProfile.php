...
class SecureScoreControlProfile extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<ComplianceInformation>|null $complianceInformation The collection of compliance information associated with secure score control. Not implemented. Currently returns null.
    */
    ...
    */
    ...
    /**
     * @var array<SecureScoreControlStateUpdate>|null $controlStateUpdates Flag to indicate where the tenant has marked a control (ignored, thirdParty, reviewed) (supports update).
    */
    ...
    */
    ...
    /**
     * @var string|null $service Service that owns the control (Exchange, Sharepoint, Microsoft Entra ID).
    */

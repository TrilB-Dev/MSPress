...
class PrintJobConfiguration implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $fitPdfToPage True to fit each page of a PDF document to a physical sheet of media; false to let the printer decide how to lay out impressions.
    */

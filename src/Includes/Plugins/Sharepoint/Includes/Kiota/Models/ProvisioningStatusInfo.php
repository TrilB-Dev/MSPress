...
class ProvisioningStatusInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ProvisioningErrorInfo|null $errorInformation If status isn't success/ skipped details for the error are contained in this.
    */
    ...
    */
    ...
    /**
     * @var ProvisioningResult|null $status The possible values are: success, warning, failure, skipped, unknownFutureValue.
    */

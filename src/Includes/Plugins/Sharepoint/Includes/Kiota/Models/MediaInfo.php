...
class MediaInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $resourceId Optional. Used to uniquely identity the resource. If passed in, the prompt uri is against this resourceId as a key.
    */
    private ?string $resourceId = null;
    
    /**
     * @var string|null $uri Path to the prompt that will be played. Currently supports only Wave file (.wav) format, single-channel, 16-bit samples with a 16,000 (16 KHz) sampling rate.
    */

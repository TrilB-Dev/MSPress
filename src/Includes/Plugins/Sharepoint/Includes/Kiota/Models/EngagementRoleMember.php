...
{
    /**
     * @var DateTime|null $createdDateTime The date and time when the role was assigned to the user. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var User|null $user The user who has this role assigned.
    */
    private ?User $user = null;
    
    /**
     * @var string|null $userId The Microsoft Entra ID of the user who has the role assigned.
    */

...
class ChatRestrictions implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $allowTextOnly Indicates whether only text is allowed in the meeting chat. Optional.
    */
    private ?bool $allowTextOnly = null;

...
{
    /**
     * @var CustomExtensionOverwriteConfiguration|null $configuration Configuration regarding properties of the custom extension that are can be overwritten per event listener.
    */
    private ?CustomExtensionOverwriteConfiguration $configuration = null;
    
    /**
     * @var OnAttributeCollectionStartCustomExtension|null $customExtension The customExtension property
    */
    private ?OnAttributeCollectionStartCustomExtension $customExtension = null;

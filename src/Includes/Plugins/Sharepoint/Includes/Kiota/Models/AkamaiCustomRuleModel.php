...
class AkamaiCustomRuleModel implements AdditionalDataHolder, Parsable 
{
    /**
     * @var string|null $action The action Akamai applies when the rule matches traffic. Common values include deny, none or alert.
    */
    ...
    */
    ...
    /**
     * @var string|null $name Friendly name for the rule, used in UIs or logs to help administrators identify the rule (for example, 'Block suspicious user agents').
    */
    ...
    */
    ...
    /**
     * @var string|null $ruleId Unique identifier assigned to the rule by Akamai or the integration. Use this identifier to reference, update, or remove the rule in API requests.
    */

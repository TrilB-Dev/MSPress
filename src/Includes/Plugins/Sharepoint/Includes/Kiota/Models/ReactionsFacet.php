...
class ReactionsFacet implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $commentCount Count of comments.
    */
    private ?int $commentCount = null;
    
    /**
     * @var int|null $likeCount Count of likes.
    */
    ...
    */
    ...
    /**
     * @var int|null $shareCount Count of shares.
    */

...
{
    /**
     * @var string|null $azureStorageUri Indicates the Azure Storage URI that the file is uploaded to. Created by the service upon receiving a valid mobileAppContentFile. Read-only. This property is read-only.
    */
    private ?string $azureStorageUri = null;
    
    /**
     * @var DateTime|null $azureStorageUriExpirationDateTime Indicates the date and time when the Azure storage URI expires, in ISO 8601 format. For example, midnight UTC on Jan 1, 2014 would look like this: '2014-01-01T00:00:00Z'. Read-only. This property is read-only.
    */
    private ?DateTime $azureStorageUriExpirationDateTime = null;
    
    /**
     * @var DateTime|null $createdDateTime Indicates created date and time associated with app content file, in ISO 8601 format. For example, midnight UTC on Jan 1, 2014 would look like this: '2014-01-01T00:00:00Z'. Read-only. This property is read-only.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var bool|null $isCommitted A value indicating whether the file is committed. A committed app content file has been fully uploaded and validated by the Intune service. TRUE means that app content file is committed, FALSE means that app content file is not committed. Defaults to FALSE. Read-only. This property is read-only.
    */
    private ?bool $isCommitted = null;
    
    /**
     * @var bool|null $isDependency Indicates whether this content file is a dependency for the main content file. TRUE means that the content file is a dependency, FALSE means that the content file is not a dependency and is the main content file. Defaults to FALSE.
    */
    private ?bool $isDependency = null;
    
    /**
     * @var StreamInterface|null $manifest Indicates the manifest information, containing file metadata.
    */
    private ?StreamInterface $manifest = null;
    
    /**
     * @var string|null $name Indicates the name of the file.
    */
    private ?string $name = null;
    
    /**
     * @var int|null $size Indicates the original size of the file, in bytes.
    */
    private ?int $size = null;
    
    /**
     * @var int|null $sizeEncrypted Indicates the size of the file after encryption, in bytes.
    */

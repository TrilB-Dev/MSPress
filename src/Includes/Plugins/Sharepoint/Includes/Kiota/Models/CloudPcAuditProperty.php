...
class CloudPcAuditProperty implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $displayName The display name for this property.
    */
    private ?string $displayName = null;
    
    /**
     * @var string|null $newValue The new value for this property.
    */
    ...
    */
    ...
    /**
     * @var string|null $oldValue The old value for this property.
    */

...
{
    /**
     * @var string|null $appClass The appClass property
    */
    private ?string $appClass = null;
    
    /**
     * @var array<AiInteractionAttachment>|null $attachments The attachments property
    */
    ...
    */
    ...
    /**
     * @var array<AiInteractionContext>|null $contexts The contexts property
    */
    private ?array $contexts = null;
    
    /**
     * @var string|null $conversationType The conversationType property
    */
    ...
    */
    ...
    /**
     * @var string|null $etag The etag property
    */
    private ?string $etag = null;
    
    /**
     * @var IdentitySet|null $from The from property
    */
    private ?IdentitySet $from = null;
    
    /**
     * @var AiInteractionType|null $interactionType The interactionType property
    */
    private ?AiInteractionType $interactionType = null;
    
    /**
     * @var array<AiInteractionLink>|null $links The links property
    */
    ...
    */
    ...
    /**
     * @var array<AiInteractionMention>|null $mentions The mentions property
    */
    private ?array $mentions = null;
    
    /**
     * @var string|null $requestId The requestId property
    */

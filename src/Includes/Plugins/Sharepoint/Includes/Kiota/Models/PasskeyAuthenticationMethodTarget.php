...
{
    /**
     * @var array<string>|null $allowedPasskeyProfiles List of passkey profiles scoped to the targets. Required.
    */
    private ?array $allowedPasskeyProfiles = null;
    ...
    */
    public function getAllowedPasskeyProfiles(): ?array {
        return $this->allowedPasskeyProfiles;
    }
    ...
    */
    public function setAllowedPasskeyProfiles(?array $value): void {
        $this->allowedPasskeyProfiles = $value;
    }

...
class AccessPackageResourceEnvironment extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isDefaultEnvironment Determines whether this is default environment or not. It is set to true for all static origin systems, such as Microsoft Entra groups and Microsoft Entra Applications.
    */
    ...
    */
    ...
    /**
     * @var array<AccessPackageResource>|null $resources Read-only. Required.
    */

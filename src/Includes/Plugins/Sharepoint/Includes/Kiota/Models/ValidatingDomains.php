...
class ValidatingDomains implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var RootDomains|null $rootDomains The rootDomains property
    */
    private ?RootDomains $rootDomains = null;

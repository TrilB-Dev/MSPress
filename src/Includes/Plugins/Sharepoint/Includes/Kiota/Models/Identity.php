...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\CallRecords\UserIdentity;
...
class Identity implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $id Unique identifier for the identity or actor. For example, in the access reviews decisions API, this property might record the id of the principal, that is, the group, user, or application that's subject to review.
    */

...
{
    /**
     * @var WorkingTimeSchedule|null $workingTimeSchedule The working time schedule entity associated with the solution.
    */
    private ?WorkingTimeSchedule $workingTimeSchedule = null;
    ...
    */
    public function setWorkingTimeSchedule(?WorkingTimeSchedule $value): void {
        $this->workingTimeSchedule = $value;
    }

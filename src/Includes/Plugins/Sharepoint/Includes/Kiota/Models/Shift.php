...
{
    /**
     * @var ShiftItem|null $draftShift Draft changes in the shift. Draft changes are only visible to managers. The changes are visible to employees when they're shared, which copies the changes from the draftShift to the sharedShift property.
    */
    private ?ShiftItem $draftShift = null;
    
    /**
     * @var bool|null $isStagedForDeletion The shift is marked for deletion, a process that is finalized when the schedule is shared.
    */
    ...
    */
    ...
    /**
     * @var ShiftItem|null $sharedShift The shared version of this shift that is viewable by both employees and managers. Updates to the sharedShift property send notifications to users in the Teams client.
    */

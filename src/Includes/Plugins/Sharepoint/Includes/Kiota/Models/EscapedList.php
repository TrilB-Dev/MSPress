...
class EscapedList extends BaseItem implements Parsable 
{
    ...
    */
    ...
    /**
     * @var Drive|null $drive Allows access to the list as a drive resource with driveItems. Only present on document libraries.
    */
    private ?Drive $drive = null;
    
    /**
     * @var ListInfo|null $escapedList Contains more details about the list.
    */
    ...
    */
    ...
    /**
     * @var SystemFacet|null $system If present, indicates that the list is system-managed. Read-only.
    */

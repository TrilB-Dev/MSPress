...
{
    /**
     * @var string|null $displayName The name of the grading category.
    */
    private ?string $displayName = null;
    
    /**
     * @var int|null $percentageWeight The weight of the category; an integer between 0 and 100.
    */
    private ?int $percentageWeight = null;

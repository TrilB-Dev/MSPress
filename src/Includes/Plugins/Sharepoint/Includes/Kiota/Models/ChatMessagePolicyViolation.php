...
class ChatMessagePolicyViolation implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ChatMessagePolicyViolationUserActionTypes|null $userAction Indicates the action taken by the user on a message blocked by the DLP provider. Supported values are: NoneOverrideReportFalsePositiveWhen the DLP provider is updating the message for blocking sensitive content, userAction isn't required.
    */

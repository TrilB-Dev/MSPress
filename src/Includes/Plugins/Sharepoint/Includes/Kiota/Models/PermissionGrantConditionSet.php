...
class PermissionGrantConditionSet extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $clientApplicationsFromVerifiedPublisherOnly Set to true to only match on client applications with a verified publisher. Set to false to match on any client app, even if it doesn't have a verified publisher. Default is false.
    */
    private ?bool $clientApplicationsFromVerifiedPublisherOnly = null;
    
    /**
     * @var array<string>|null $clientApplicationTenantIds A list of Microsoft Entra tenant IDs in which the client application is registered, or a list with the single value all to match with client apps registered in any tenant. Default is the single value all.
    */
    private ?array $clientApplicationTenantIds = null;
    
    /**
     * @var string|null $permissionClassification The permission classification for the permission being granted, or all to match with any permission classification (including permissions that aren't classified). Default is all.
    */
    ...
    */
    ...
    /**
     * @var string|null $resourceApplication The appId of the resource application (for example the API) for which a permission is being granted, or any to match with any resource application or API. Default is any.
    */

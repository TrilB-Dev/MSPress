...
class Certification implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $certificationExpirationDateTime The timestamp when the current certification for the application expires.
    */
    ...
    */
    ...
    /**
     * @var bool|null $isPublisherAttested Indicates whether the application developer or publisher completed Publisher Attestation.
    */

...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\TermStore\Store;

class Site extends BaseItem implements Parsable 
{
    /**
     * @var ItemAnalytics|null $analytics Analytics about the view activities that took place on this site.
    */
    ...
    */
    ...
    /**
     * @var bool|null $isPersonalSite Identifies whether the site is personal or not. Read-only.
    */
    private ?bool $isPersonalSite = null;
    ...
    */
    ...
    /**
     * @var array<BaseSitePage>|null $pages The collection of pages in the baseSitePages list in this site.
    */
    ...
    */
    ...
    /**
     * @var Root|null $root If present, provides the root site in the site collection. Read-only.
    */

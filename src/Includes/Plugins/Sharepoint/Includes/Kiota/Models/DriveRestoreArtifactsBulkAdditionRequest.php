...
{
    /**
     * @var array<string>|null $directoryObjectIds The list of directory object IDs that are added to the corresponding OneDrive for work or school restore session in a bulk operation.
    */
    private ?array $directoryObjectIds = null;
    
    /**
     * @var array<string>|null $drives The list of email addresses that are added to the corresponding OneDrive for work or school restore session in a bulk operation.
    */

...
class NetworkConnection implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ConnectionDirection|null $direction Network connection direction. The possible values are: unknown, inbound, outbound.
    */
    ...
    */
    ...
    /**
     * @var SecurityNetworkProtocol|null $protocol Network protocol. The possible values are: unknown, ip, icmp, igmp, ggp, ipv4, tcp, pup, udp, idp, ipv6, ipv6RoutingHeader, ipv6FragmentHeader, ipSecEncapsulatingSecurityPayload, ipSecAuthenticationHeader, icmpV6, ipv6NoNextHeader, ipv6DestinationOptions, nd, raw, ipx, spx, spxII.
    */
    ...
    */
    ...
    /**
     * @var ConnectionStatus|null $status Network connection status. The possible values are: unknown, attempted, succeeded, blocked, failed.
    */

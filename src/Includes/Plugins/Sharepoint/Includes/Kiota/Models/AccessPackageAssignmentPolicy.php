...
{
    /**
     * @var AccessPackage|null $accessPackage Access package containing this policy. Read-only. Supports $expand.
    */
    ...
    */
    ...
    /**
     * @var array<CustomExtensionStageSetting>|null $customExtensionStageSettings The collection of stages when to execute one or more custom access package workflow extensions. Supports $expand.
    */
    private ?array $customExtensionStageSettings = null;
    ...
    */
    ...
    /**
     * @var AccessPackageNotificationSettings|null $notificationSettings The notificationSettings property
    */
    private ?AccessPackageNotificationSettings $notificationSettings = null;

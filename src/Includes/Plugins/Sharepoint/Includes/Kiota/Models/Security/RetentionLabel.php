...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\IdentitySet;

class RetentionLabel extends Entity implements Parsable 
{
    /**
     * @var ActionAfterRetentionPeriod|null $actionAfterRetentionPeriod Specifies the action to take on the labeled document after the period specified by the retentionDuration property expires. The possible values are: none, delete, startDispositionReview, unknownFutureValue.
    */
    ...
    */
    ...
    /**
     * @var FilePlanDescriptor|null $descriptors Represents out-of-the-box values that provide more options to improve the manageability and organization of the content you need to label.
    */
    private ?FilePlanDescriptor $descriptors = null;
    ...
    */
    ...
    /**
     * @var array<DispositionReviewStage>|null $dispositionReviewStages When action at the end of retention is chosen as 'dispositionReview', dispositionReviewStages specifies a sequential set of stages with at least one reviewer in each stage.
    */
    ...
    */
    ...
    /**
     * @var RetentionEventType|null $retentionEventType Represents the type associated with a retention event.
    */

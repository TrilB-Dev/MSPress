...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\ResultInfo;

class CaseOperation extends Entity implements Parsable 
{
    /**
     * @var CaseAction|null $action The type of action the operation represents. The possible values are: contentExport,  applyTags, convertToPdf, index, estimateStatistics, addToReviewSet, holdUpdate, unknownFutureValue, purgeData, exportReport, exportResult, holdPolicySync. Use the Prefer: include-unknown-enum-members request header to get the following values from this evolvable enum: purgeData, exportReport, exportResult, holdPolicySync.
    */
    ...
    */
    ...
    /**
     * @var CaseOperationStatus|null $status The status of the case operation. The possible values are: notStarted, submissionFailed, running, succeeded, partiallySucceeded, failed, unknownFutureValue.
    */

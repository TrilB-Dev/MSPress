...
{
    /**
     * @var string|null $email The email address of the user account.
    */
    private ?string $email = null;
    
    /**
     * @var string|null $login The user's login (GitHub handle).
    */
    private ?string $login = null;
    
    /**
     * @var string|null $name The user's name.
    */
    private ?string $name = null;
    
    /**
     * @var string|null $userId The unique and immutable ID of the user account.
    */
    private ?string $userId = null;
    
    /**
     * @var string|null $webUrl The URL of the user's profile web page. For example, https://github.com/my-login.
    */

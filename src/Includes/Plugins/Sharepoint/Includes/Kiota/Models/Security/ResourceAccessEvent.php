...
class ResourceAccessEvent implements AdditionalDataHolder, Parsable 
{
    /**
     * @var DateTime|null $accessDateTime The time of the access event.
    */
    private ?DateTime $accessDateTime = null;
    
    /**
     * @var string|null $accountId The identifier of the user account.
    */
    ...
    */
    ...
    /**
     * @var string|null $ipAddress IP address of the resource.
    */
    ...
    */
    ...
    /**
     * @var string|null $resourceIdentifier The protocol and host name pairs describing the connection.
    */

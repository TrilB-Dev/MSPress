...
{
    /**
     * @var DataSource|null $dataSource User source or SharePoint site data source as noncustodial data source.
    */
    private ?DataSource $dataSource = null;
    
    /**
     * @var EdiscoveryIndexOperation|null $lastIndexOperation Operation entity that represents the latest indexing for the noncustodial data source.
    */

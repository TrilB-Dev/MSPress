...
{
    /**
     * @var array<EdiscoveryCaseMember>|null $caseMembers Represents members of an eDiscovery case.
    */
    private ?array $caseMembers = null;

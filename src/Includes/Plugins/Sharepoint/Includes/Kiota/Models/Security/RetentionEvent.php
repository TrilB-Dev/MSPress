...
class RetentionEvent extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<EventPropagationResult>|null $eventPropagationResults Represents the success status of a created event and additional information.
    */
    ...
    */
    ...
    /**
     * @var RetentionEventStatus|null $eventStatus Status of event propogation to the scoped locations after the event has been created.
    */

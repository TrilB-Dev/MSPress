...
{
    /**
     * @var IdentitySet|null $createdBy Represents the user who created the filePlanDescriptorTemplate column.
    */
    private ?IdentitySet $createdBy = null;
    
    /**
     * @var DateTime|null $createdDateTime Represents the date and time in which the filePlanDescriptorTemplate is created.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $displayName Unique string that defines a filePlanDescriptorTemplate name.
    */

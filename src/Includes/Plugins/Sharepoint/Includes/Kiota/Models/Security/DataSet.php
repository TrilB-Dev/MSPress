...
{
    /**
     * @var IdentitySet|null $createdBy The user who created the data set. Read-only.
    */
    private ?IdentitySet $createdBy = null;
    
    /**
     * @var DateTime|null $createdDateTime The date and time when the review set was created. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Read-only.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $description The description of the data set.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $displayName The name of the data set. The name is unique with a maximum limit of 64 characters.
    */

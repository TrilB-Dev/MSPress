...
class EventPropagationResult implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var EventPropagationStatus|null $status Indicates the status of the event creation request. The possible values are: none, inProcessing, failed, success, unknownFutureValue.
    */

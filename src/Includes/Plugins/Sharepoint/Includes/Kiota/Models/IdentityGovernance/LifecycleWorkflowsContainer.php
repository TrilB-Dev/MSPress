...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\DeletedItemContainer;
...
class LifecycleWorkflowsContainer extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var Insights|null $insights The insight container holding workflow insight summaries for a tenant.
    */

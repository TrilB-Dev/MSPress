...
use MSPress\Includes\Plugins\SharePoint\Includes\Kiota\Models\KeyValuePair;
...
class Task extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $continueOnError A Boolean value that specifies whether, if this task fails, the workflow stops, and subsequent tasks aren't run. Optional.
    */
    ...
    */
    ...
    /**
     * @var int|null $executionSequence An integer that states in what order the task runs in a workflow.Supports $orderby.
    */
    ...
    */
    ...
    /**
     * @var string|null $taskDefinitionId A unique template identifier for the task. For more information about the tasks that Lifecycle Workflows currently supports and their unique identifiers, see Configure the arguments for built-in Lifecycle Workflow tasks. Required.Supports $filter(eq, ne).
    */

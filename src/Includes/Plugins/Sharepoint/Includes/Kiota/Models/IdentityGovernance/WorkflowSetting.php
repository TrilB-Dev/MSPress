...
class WorkflowSetting implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var QuarantineConfiguration|null $quarantineConfiguration The threshold configuration that automatically halts the workflow when its conditions are met.
    */

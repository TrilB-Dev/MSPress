...
class EducationAiFeedbackSettings implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var EducationAiFeedbackAudienceEngagementSettings|null $audienceEngagementSettings The audience engagement related feedback types that students should receive from the AI feedback.
    */
    private ?EducationAiFeedbackAudienceEngagementSettings $audienceEngagementSettings = null;
    
    /**
     * @var EducationAiFeedbackContentSettings|null $contentSettings The content related feedback types that students should receive from the AI feedback.
    */
    private ?EducationAiFeedbackContentSettings $contentSettings = null;
    
    /**
     * @var EducationAiFeedbackDeliverySettings|null $deliverySettings The delivery related feedback types that students should receive from the AI feedback.
    */
    private ?EducationAiFeedbackDeliverySettings $deliverySettings = null;

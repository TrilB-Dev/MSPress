...
class WorkbookIcon implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var int|null $index The index of the icon in the given set.
    */
    ...
    */
    ...
    /**
     * @var string|null $set The set that the icon is part of. The possible values are: Invalid, ThreeArrows, ThreeArrowsGray, ThreeFlags, ThreeTrafficLights1, ThreeTrafficLights2, ThreeSigns, ThreeSymbols, ThreeSymbols2, FourArrows, FourArrowsGray, FourRedToBlack, FourRating, FourTrafficLights, FiveArrows, FiveArrowsGray, FiveRating, FiveQuarters, ThreeStars, ThreeTriangles, FiveBoxes.
    */

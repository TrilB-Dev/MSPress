...
class FilterOperatorSchema extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<AttributeType>|null $supportedAttributeTypes Attribute types supported by the operator. The possible values are: Boolean, Binary, Reference, Integer, String.
    */

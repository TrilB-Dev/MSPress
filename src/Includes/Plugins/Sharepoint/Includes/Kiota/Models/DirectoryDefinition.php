...
class DirectoryDefinition extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $readOnly Whether this object is read-only.
    */
    private ?bool $readOnly = null;
    
    /**
     * @var string|null $version Read only value that indicates version discovered. null if discovery hasn't yet occurred.
    */

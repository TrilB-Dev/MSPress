...
{
    /**
     * @var VirtualEventRegistrationPredefinedQuestionLabel|null $label Label of the predefined registration question. It accepts a single line of text: street, city, state, postalCode, countryOrRegion, industry, jobTitle, organization, and unknownFutureValue.
    */
    private ?VirtualEventRegistrationPredefinedQuestionLabel $label = null;

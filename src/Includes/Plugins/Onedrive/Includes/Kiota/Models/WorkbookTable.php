...
{
    /**
     * @var array<WorkbookTableColumn>|null $columns The list of all the columns in the table. Read-only.
    */
    ...
    */
    ...
    /**
     * @var string|null $legacyId A legacy identifier used in older Excel clients. The value of the identifier remains the same even when the table is renamed. This property should be interpreted as an opaque string value and shouldn't be parsed to any other type. Read-only.
    */
    private ?string $legacyId = null;
    
    /**
     * @var string|null $name The name of the table.
    */
    private ?string $name = null;
    
    /**
     * @var array<WorkbookTableRow>|null $rows The list of all the rows in the table. Read-only.
    */
    ...
    */
    ...
    /**
     * @var WorkbookTableSort|null $sort The sorting for the table. Read-only.
    */
    private ?WorkbookTableSort $sort = null;
    
    /**
     * @var string|null $style A constant value that represents the Table style. The possible values are: TableStyleLight1 through TableStyleLight21, TableStyleMedium1 through TableStyleMedium28, TableStyleStyleDark1 through TableStyleStyleDark11. A custom user-defined style present in the workbook can also be specified.
    */

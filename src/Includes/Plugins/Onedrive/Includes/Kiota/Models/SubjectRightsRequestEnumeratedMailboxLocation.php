...
{
    /**
     * @var array<string>|null $userPrincipalNames Collection of mailboxes that should be included in the search. Includes the user principal name (UPN) of each mailbox, for example, Monica.Thompson@contoso.com.
    */
    private ?array $userPrincipalNames = null;

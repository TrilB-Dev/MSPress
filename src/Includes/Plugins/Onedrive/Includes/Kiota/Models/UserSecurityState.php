...
class UserSecurityState implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var EmailRole|null $emailRole For email-related alerts - user account's email 'role'. The possible values are: unknown, sender, recipient.
    */
    ...
    */
    ...
    /**
     * @var LogonType|null $logonType Method of user sign in. The possible values are: unknown, interactive, remoteInteractive, network, batch, service.
    */
    ...
    */
    ...
    /**
     * @var UserAccountSecurityType|null $userAccountType User account type (group membership), per Windows definition. The possible values are: unknown, standard, power, administrator.
    */

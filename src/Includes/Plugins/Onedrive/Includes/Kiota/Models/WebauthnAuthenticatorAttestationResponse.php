...
class WebauthnAuthenticatorAttestationResponse implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $attestationObject A CBOR-encoded attestation object containing the authenticator data and attestation statement. This value is Base64URL-encoded without padding.
    */
    private ?string $attestationObject = null;
    
    /**
     * @var string|null $clientDataJSON Contains the JSON-compatible serialization of client data passed to the authenticator by the client. This value is Base64URL-encoded without padding.
    */

...
{
    /**
     * @var BaseEndUserNotification|null $trainingAssignment Training assignment details.
    */
    private ?BaseEndUserNotification $trainingAssignment = null;
    
    /**
     * @var TrainingReminderNotification|null $trainingReminder Training reminder details.
    */
    private ?TrainingReminderNotification $trainingReminder = null;

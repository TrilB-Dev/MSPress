...
{
    /**
     * @var array<ServiceHealth>|null $healthOverviews A collection of service health information for tenant. This property is a contained navigation property, it is nullable and read-only.
    */
    private ?array $healthOverviews = null;
    
    /**
     * @var array<ServiceHealthIssue>|null $issues A collection of service issues for tenant. This property is a contained navigation property, it is nullable and read-only.
    */
    private ?array $issues = null;
    
    /**
     * @var array<ServiceUpdateMessage>|null $messages A collection of service messages for tenant. This property is a contained navigation property, it is nullable and read-only.
    */

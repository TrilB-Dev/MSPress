...
class TrainingSetting implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var TrainingSettingType|null $settingType Type of setting. The possible values are: microsoftCustom, microsoftManaged, noTraining, custom, unknownFutureValue.
    */
    private ?TrainingSettingType $settingType = null;

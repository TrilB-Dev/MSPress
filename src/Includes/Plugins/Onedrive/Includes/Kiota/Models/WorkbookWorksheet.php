...
{
    /**
     * @var array<WorkbookChart>|null $charts The list of charts that are part of the worksheet. Read-only.
    */
    ...
    */
    ...
    /**
     * @var array<WorkbookNamedItem>|null $names The list of names that are associated with the worksheet. Read-only.
    */
    private ?array $names = null;
    
    /**
     * @var array<WorkbookPivotTable>|null $pivotTables The list of piot tables that are part of the worksheet.
    */
    ...
    */
    ...
    /**
     * @var WorkbookWorksheetProtection|null $protection The sheet protection object for a worksheet. Read-only.
    */
    private ?WorkbookWorksheetProtection $protection = null;
    
    /**
     * @var array<WorkbookTable>|null $tables The list of tables that are part of the worksheet. Read-only.
    */

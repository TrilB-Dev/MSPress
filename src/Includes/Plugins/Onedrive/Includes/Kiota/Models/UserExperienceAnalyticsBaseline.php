...
{
    /**
     * @var UserExperienceAnalyticsCategory|null $appHealthMetrics The scores and insights for the application health metrics.
    */
    private ?UserExperienceAnalyticsCategory $appHealthMetrics = null;
    
    /**
     * @var UserExperienceAnalyticsCategory|null $batteryHealthMetrics The scores and insights for the battery health metrics.
    */
    private ?UserExperienceAnalyticsCategory $batteryHealthMetrics = null;
    
    /**
     * @var UserExperienceAnalyticsCategory|null $bestPracticesMetrics The scores and insights for the best practices metrics.
    */
    ...
    */
    ...
    /**
     * @var UserExperienceAnalyticsCategory|null $deviceBootPerformanceMetrics The scores and insights for the device boot performance metrics.
    */
    private ?UserExperienceAnalyticsCategory $deviceBootPerformanceMetrics = null;
    
    /**
     * @var string|null $displayName The name of the baseline.
    */
    private ?string $displayName = null;
    
    /**
     * @var bool|null $isBuiltIn When TRUE, indicates the current baseline is the commercial median baseline. When FALSE, indicates it is a custom baseline. FALSE by default.
    */
    private ?bool $isBuiltIn = null;
    
    /**
     * @var UserExperienceAnalyticsCategory|null $rebootAnalyticsMetrics The scores and insights for the reboot analytics metrics.
    */
    private ?UserExperienceAnalyticsCategory $rebootAnalyticsMetrics = null;
    
    /**
     * @var UserExperienceAnalyticsCategory|null $resourcePerformanceMetrics The scores and insights for the resource performance metrics.
    */
    private ?UserExperienceAnalyticsCategory $resourcePerformanceMetrics = null;
    
    /**
     * @var UserExperienceAnalyticsCategory|null $workFromAnywhereMetrics The scores and insights for the work from anywhere metrics.
    */

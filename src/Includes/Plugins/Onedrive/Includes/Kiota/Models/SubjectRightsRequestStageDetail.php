...
class SubjectRightsRequestStageDetail implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var SubjectRightsRequestStage|null $stage The stage of the subject rights request.
    */
    private ?SubjectRightsRequestStage $stage = null;
    
    /**
     * @var SubjectRightsRequestStageStatus|null $status Status of the current stage. The possible values are: notStarted, current, completed, failed, unknownFutureValue.
    */

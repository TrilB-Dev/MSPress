...
class WorkbookRangeFormat extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var float|null $columnWidth The width of all columns within the range. If the column widths aren't uniform, null will be returned.
    */
    ...
    */
    ...
    /**
     * @var string|null $horizontalAlignment The horizontal alignment for the specified object. The possible values are: General, Left, Center, Right, Fill, Justify, CenterAcrossSelection, Distributed.
    */
    ...
    */
    ...
    /**
     * @var float|null $rowHeight The height of all rows in the range. If the row heights aren't uniform null will be returned.
    */
    private ?float $rowHeight = null;
    
    /**
     * @var string|null $verticalAlignment The vertical alignment for the specified object. The possible values are: Top, Center, Bottom, Justify, Distributed.
    */
    private ?string $verticalAlignment = null;
    
    /**
     * @var bool|null $wrapText Indicates whether Excel wraps the text in the object. A null value indicates that the entire range doesn't have a uniform wrap setting.
    */

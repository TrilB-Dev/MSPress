...
{
    /**
     * @var array<string>|null $additionalInformation Contains additional information about the issue, such as a list of items to fix.
    */
    private ?array $additionalInformation = null;
    
    /**
     * @var DateTime|null $createdDateTime The date and time when the health issue was generated. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $description Contains more detailed information about the health issue.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $displayName The display name of the health issue.
    */
    private ?string $displayName = null;
    
    /**
     * @var array<string>|null $domainNames A list of the fully qualified domain names of the domains or the sensors the health issue is related to.
    */
    private ?array $domainNames = null;
    
    /**
     * @var HealthIssueType|null $healthIssueType The type of the health issue. The possible values are: sensor, global, unknownFutureValue. For a list of all health issues and their identifiers, see Microsoft Defender for Identity health issues.
    */
    private ?HealthIssueType $healthIssueType = null;
    
    /**
     * @var string|null $issueTypeId The type identifier of the health issue. For a list of all health issues and their identifiers, see Microsoft Defender for Identity health issues.
    */
    private ?string $issueTypeId = null;
    
    /**
     * @var DateTime|null $lastModifiedDateTime The date and time when the health issue was last updated. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $lastModifiedDateTime = null;
    
    /**
     * @var array<string>|null $recommendations A list of recommended actions that can be taken to resolve the issue effectively and efficiently. These actions might include instructions for further investigation and aren't limited to prewritten responses.
    */
    private ?array $recommendations = null;
    
    /**
     * @var array<string>|null $recommendedActionCommands A list of commands from the PowerShell module for the product that can be used to resolve the issue, if available. If no commands can be used to solve the issue, this property is empty. The commands, if present, provide a quick and efficient way to address the issue. These commands run in sequence for the single recommended fix.
    */
    private ?array $recommendedActionCommands = null;
    
    /**
     * @var array<string>|null $sensorDNSNames A list of the DNS names of the sensors the health issue is related to.
    */
    private ?array $sensorDNSNames = null;
    
    /**
     * @var HealthIssueSeverity|null $severity The severity of the health issue. The possible values are: low, medium, high, unknownFutureValue.
    */
    private ?HealthIssueSeverity $severity = null;
    
    /**
     * @var HealthIssueStatus|null $status The status of the health issue. The possible values are: open, closed, suppressed, unknownFutureValue.
    */
    private ?HealthIssueStatus $status = null;
    ...
    */
    public function setRecommendedActionCommands(?array $value): void {
        $this->recommendedActionCommands = $value;
    }

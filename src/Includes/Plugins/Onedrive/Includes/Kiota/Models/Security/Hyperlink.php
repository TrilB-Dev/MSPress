...
class Hyperlink implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $name The name for this hyperlink.
    */
    ...
    */
    ...
    /**
     * @var string|null $url The URL for this hyperlink.
    */

...
class FilePlanDescriptorBase implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $displayName Unique string that defines the name for the file plan descriptor associated with a particular retention label.
    */

...
{
    /**
     * @var string|null $domain The URI for which the cookie is valid.
    */
    private ?string $domain = null;
    
    /**
     * @var DateTime|null $firstSeenDateTime The first date and time when this hostCookie was observed by Microsoft Defender Threat Intelligence. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014, is 2014-01-01T00:00:00Z.
    */
    ...
    */
    ...
    /**
     * @var string|null $name The name of the cookie, for example, JSESSIONID or SEARCH_NAMESITE.
    */

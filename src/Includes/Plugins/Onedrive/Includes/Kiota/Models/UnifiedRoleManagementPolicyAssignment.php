...
class UnifiedRoleManagementPolicyAssignment extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $roleDefinitionId For Microsoft Entra roles policy, it's the identifier of the role definition object where the policy applies. For PIM for Groups membership and ownership, it's either member or owner. Supports $filter (eq).
    */
    ...
    */
    ...
    /**
     * @var string|null $scopeType The type of the scope where the policy is assigned. One of Directory, DirectoryRole, Group. Required.
    */

...
{
    /**
     * @var ActivitiesContainer|null $activities Container for activity logs (content processing and audit) related to this user. ContainsTarget: true.
    */
    private ?ActivitiesContainer $activities = null;
    
    /**
     * @var UserProtectionScopeContainer|null $protectionScopes The protectionScopes property
    */
    private ?UserProtectionScopeContainer $protectionScopes = null;

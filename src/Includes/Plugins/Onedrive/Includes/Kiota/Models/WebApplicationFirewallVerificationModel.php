...
{
    /**
     * @var WebApplicationFirewallProvider|null $provider Reference to a provider resource associated with this verification model. Represents a WAF provider that can be used to verify or manage the host.
    */
    private ?WebApplicationFirewallProvider $provider = null;
    
    /**
     * @var WebApplicationFirewallProviderType|null $providerType The providerType property
    */
    private ?WebApplicationFirewallProviderType $providerType = null;
    
    /**
     * @var WebApplicationFirewallVerificationResult|null $verificationResult An object describing the outcome of the verification operation, including status, errors or warnings
    */
    private ?WebApplicationFirewallVerificationResult $verificationResult = null;
    
    /**
     * @var WebApplicationFirewallVerifiedDetails|null $verifiedDetails Details of DNS configuration
    */
    private ?WebApplicationFirewallVerifiedDetails $verifiedDetails = null;
    
    /**
     * @var string|null $verifiedHost The host (domain or subdomain) that was verified as part of this verification operation.
    */
    private ?string $verifiedHost = null;

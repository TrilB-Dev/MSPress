...
class X509CertificateIssuerHintsConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var X509CertificateIssuerHintsState|null $state The possible values are: disabled, enabled, unknownFutureValue.
    */
    private ?X509CertificateIssuerHintsState $state = null;

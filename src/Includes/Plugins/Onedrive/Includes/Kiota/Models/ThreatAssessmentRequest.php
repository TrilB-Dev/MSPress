...
class ThreatAssessmentRequest extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var ThreatAssessmentContentType|null $contentType The content type of threat assessment. The possible values are: mail, url, file.
    */
    ...
    */
    ...
    /**
     * @var ThreatAssessmentRequestSource|null $requestSource The source of the threat assessment request. The possible values are: administrator.
    */
    ...
    */
    ...
    /**
     * @var ThreatAssessmentStatus|null $status The assessment process status. The possible values are: pending, completed.
    */

...
{
    /**
     * @var string|null $containerTextWebPartId The instance identifier of the container text webPart. It only works for inline standard webPart in rich text webParts.
    */
    private ?string $containerTextWebPartId = null;
    
    /**
     * @var WebPartData|null $data Data of the webPart.
    */
    private ?WebPartData $data = null;
    
    /**
     * @var string|null $webPartType A Guid that indicates the webPart type.
    */
    private ?string $webPartType = null;

...
class StringKeyLongValuePair implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $key The mapping of the user type from the source system to the target system. For example:User to User - For Microsoft Entra ID to Microsoft Entra ID synchronization worker to user - For Workday to Microsoft Entra synchronization.
    */
    ...
    */
    ...
    /**
     * @var int|null $value Total number of synchronized objects.
    */

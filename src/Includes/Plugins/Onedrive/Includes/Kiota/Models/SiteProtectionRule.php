...
{
    /**
     * @var string|null $siteExpression Contains a site expression. For examples, see siteExpression example.
    */
    private ?string $siteExpression = null;

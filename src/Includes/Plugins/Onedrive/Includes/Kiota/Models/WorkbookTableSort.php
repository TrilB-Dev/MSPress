...
{
    /**
     * @var array<WorkbookSortField>|null $fields The list of the current conditions last used to sort the table. Read-only.
    */
    private ?array $fields = null;
    
    /**
     * @var bool|null $matchCase Indicates whether the casing impacted the last sort of the table. Read-only.
    */
    private ?bool $matchCase = null;
    
    /**
     * @var string|null $method The Chinese character ordering method last used to sort the table. The possible values are: PinYin, StrokeCount. Read-only.
    */

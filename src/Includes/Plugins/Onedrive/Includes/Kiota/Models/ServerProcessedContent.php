...
class ServerProcessedContent implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<MetaDataKeyStringPair>|null $htmlStrings A key-value map where keys are string identifiers and values are rich text with HTML format. SharePoint servers treat the values as HTML content and run services like safety checks, search index and link fixup on them.
    */
    private ?array $htmlStrings = null;
    
    /**
     * @var array<MetaDataKeyStringPair>|null $imageSources A key-value map where keys are string identifiers and values are image sources. SharePoint servers treat the values as image sources and run services like search index and link fixup on them.
    */
    private ?array $imageSources = null;
    
    /**
     * @var array<MetaDataKeyStringPair>|null $links A key-value map where keys are string identifiers and values are links. SharePoint servers treat the values as links and run services like link fixup on them.
    */
    ...
    */
    ...
    /**
     * @var array<MetaDataKeyStringPair>|null $searchablePlainTexts A key-value map where keys are string identifiers and values are strings that should be search indexed.
    */
    private ?array $searchablePlainTexts = null;

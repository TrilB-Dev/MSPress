...
class UnifiedRoleAssignmentScheduleRequest extends Request implements Parsable 
{
    ...
    */
    ...
    /**
     * @var UnifiedRoleEligibilitySchedule|null $activatedUsing If the request is from an eligible administrator to activate a role, this parameter will show the related eligible assignment for that activation. Otherwise, it's null. Supports $expand and $select nested in $expand.
    */
    ...
    */
    ...
    /**
     * @var DirectoryObject|null $principal The principal that's getting a role assignment through the request. Supports $expand and $select nested in $expand for id only.
    */
    ...
    */
    ...
    /**
     * @var UnifiedRoleDefinition|null $roleDefinition Detailed information for the unifiedRoleDefinition object that is referenced through the roleDefinitionId property. Supports $expand and $select nested in $expand.
    */
    ...
    */
    ...
    /**
     * @var UnifiedRoleAssignmentSchedule|null $targetSchedule The schedule for an eligible role assignment that is referenced through the targetScheduleId property. Supports $expand and $select nested in $expand.
    */

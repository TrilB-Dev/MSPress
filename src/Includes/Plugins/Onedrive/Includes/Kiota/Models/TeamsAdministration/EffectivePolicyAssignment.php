...
class EffectivePolicyAssignment implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var PolicyAssignment|null $policyAssignment The policyAssignment property
    */
    private ?PolicyAssignment $policyAssignment = null;
    
    /**
     * @var string|null $policyType The type of the assigned policy; for example, TeamsMeetingPolicy and TeamsCallingPolicy.
    */

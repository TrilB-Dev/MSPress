...
class SignInLocation implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $city Provides the city where the sign-in originated and is determined using latitude/longitude information from the sign-in activity.
    */
    private ?string $city = null;
    
    /**
     * @var string|null $countryOrRegion Provides the country code info (two letter code) where the sign-in originated.  This is calculated using latitude/longitude information from the sign-in activity.
    */

        ...
        return [
            ...
            'fields' => [
                [
                    ...
                    'label' => __( 'Default content skin', 'mspress' ),
                    'description' => __( 'Choose the stylesheet used inside the editor content area.', 'mspress' ),
                    'tooltip' => __( 'Content skins control typography and content formatting inside the editing area.', 'mspress' ),
                    'type' => 'select',
                ...
                [
                    'key' => 'tinymce_ui_skin',
                    'label' => __( 'Default user-interface skin', 'mspress' ),
                    'description' => __( 'Choose the TinyMCE toolbar and dialog skin.', 'mspress' ),
                    'tooltip' => __( 'UI skins control the toolbar, menus, dialogs, and editor chrome.', 'mspress' ),
                    'type' => 'select',
                ...
                [
                    'key' => 'tinymce_plugins',
                    'label' => __( 'Enabled TinyMCE plugins', 'mspress' ),
                    'description' => __( 'Choose which bundled TinyMCE plugins are available to the editor.', 'mspress' ),
                    'tooltip' => __( 'Only selected local plugin files are requested when an editor starts.', 'mspress' ),
                    'type' => 'multiselect',
                    'dropup_auto' => false,
                    'show_tick' => true,

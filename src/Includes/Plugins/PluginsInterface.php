<?php
/**
 * MSPress plugin interface for all plugins.
 *
 * @package MSPress
...
/**
 * Provides an automatically generated settings tab for an MSPress plugin.
 * @since 1.0.0
 */
...
/**
 * Provides shortcode definitions for an MSPress extension.
 * @since 1.0.0
 */
...
/**
 * Provides MSPress admin menu definitions for a plugin.
 *
 * Definitions may use `type => menu` for a new top-level menu or provide a
 * `parent` slug for a submenu under an existing MSPress menu.
 * @since 1.0.0
 */
...
/**
 * Provides entries for the MSPress in-page admin sidebar.
 * @since 1.0.0
 */
...
/**
 * Capability provider interface for plugins.
 * @since 1.0.0
 */
interface CapabilitiesProviderInterface {
    /**
     * Register plugin-specific capabilities with the core registry.
     *
     * @return void
     */

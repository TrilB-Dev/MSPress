...
namespace MSPress\Includes\Plugins\Exchange\Includes\Kiota\Me\Settings\Exchange;
...
use MSPress\Includes\MSGraph\Kiota\Models\ExchangeSettings;
...
class ExchangeRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/me/settings/exchange{?%24expand,%24select}');

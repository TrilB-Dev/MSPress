...
final class FunctionsSettings {
    ...
    public function register_settings(): void {
        register_setting( 'mspress_settings', 'mspress_general', [ 'sanitize_callback' => [ $this, 'sanitize_general' ] ] );
        register_setting( 'mspress_settings', 'mspress_layout', [ 'sanitize_callback' => [ $this, 'sanitize_layout' ] ] );
        register_setting( 'mspress_settings', 'mspress_access', [ 'sanitize_callback' => [ $this, 'sanitize_access' ] ] );
    ...
    public function sanitize_general( $input ): array {
        if ( ! current_user_can( 'mspress_settings_general_edit' ) ) {
    ...
    public function sanitize_layout( $input ): array {
        if ( ! current_user_can( 'mspress_settings_layout_edit' ) ) {
    ...
    public function sanitize_access( $input ): array {
        if ( ! current_user_can( 'mspress_settings_access_edit' ) ) {

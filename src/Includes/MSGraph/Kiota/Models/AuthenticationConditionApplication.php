...
class AuthenticationConditionApplication implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $appId The identifier for an application corresponding to a condition which will trigger an authenticationEventListener.
    */

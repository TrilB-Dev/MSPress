...
class LocalAdminSettings implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $enableGlobalAdmins Indicates whether global administrators are local administrators on all Microsoft Entra-joined devices. This setting only applies to future registrations. Default is true.
    */
    private ?bool $enableGlobalAdmins = null;
    ...
    */
    ...
    /**
     * @var DeviceRegistrationMembership|null $registeringUsers Determines the users and groups that become local administrators on Microsoft Entra joined devices that they register.
    */
    private ?DeviceRegistrationMembership $registeringUsers = null;
    ...
    */
    public function getEnableGlobalAdmins(): ?bool {
        return $this->enableGlobalAdmins;
    }

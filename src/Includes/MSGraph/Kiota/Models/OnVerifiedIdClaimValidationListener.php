...
{
    /**
     * @var OnVerifiedIdClaimValidationHandler|null $handler Configuration for the handler to invoke when this listener is triggered. For Verified ID claim validation scenarios, this is typically an onVerifiedIdClaimValidationCustomExtensionHandler.
    */
    private ?OnVerifiedIdClaimValidationHandler $handler = null;

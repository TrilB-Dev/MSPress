...
class CustomExtensionOverwriteConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var CustomExtensionBehaviorOnError|null $behaviorOnError The behaviorOnError property
    */
    private ?CustomExtensionBehaviorOnError $behaviorOnError = null;
    
    /**
     * @var CustomExtensionClientConfiguration|null $clientConfiguration Configuration regarding properties of the custom extension which can be overwritten per event listener. If no values are provided, the properties on the custom extension are used.
    */

...
class CrossTenantAccessPolicyM365CollaborationOutboundSetting implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var CrossTenantAccessPolicyTargetConfiguration|null $usersAndGroups Defines the target users and groups in your organization who are allowed outbound Microsoft 365 collaboration with external organizations.
    */

...
{
    /**
     * @var int|null $failedSignInCount Number of failed sign ins on AD FS in the period specified. Supports $orderby, $filter (eq).
    */
    ...
    */
    ...
    /**
     * @var array<KeyValuePair>|null $migrationValidationDetails Specifies all the validations checks done on applications config details.
    */
    private ?array $migrationValidationDetails = null;
    
    /**
     * @var string|null $relyingPartyId Identifies the relying party to this federation service. It's used when issuing claims to the relying party. Supports $orderby, $filter (eq).
    */
    private ?string $relyingPartyId = null;
    
    /**
     * @var string|null $relyingPartyName Name of the relying party's website or other entity on the Internet that uses an identity provider to authenticate a user who wants to log in. Supports $orderby, $filter (eq).
    */
    ...
    */
    ...
    /**
     * @var string|null $serviceId Uniquely identifies the Active Directory forest. Supports $orderby, $filter (eq).
    */
    private ?string $serviceId = null;
    
    /**
     * @var float|null $signInSuccessRate Calculated as Number of successful / (Number of successful + Number of failed sign ins) or successfulSignInCount / totalSignInCount on AD FS in the period specified. Supports $orderby, $filter (eq).
    */
    private ?float $signInSuccessRate = null;
    
    /**
     * @var int|null $successfulSignInCount Number of successful sign ins on AD FS. Supports $orderby, $filter (eq).
    */
    private ?int $successfulSignInCount = null;
    
    /**
     * @var int|null $totalSignInCount Number of successful + failed sign ins on AD FS in the period specified. Supports $orderby, $filter (eq).
    */
    private ?int $totalSignInCount = null;
    
    /**
     * @var int|null $uniqueUserCount Number of unique users that signed into the application. Supports $orderby, $filter (eq).
    */

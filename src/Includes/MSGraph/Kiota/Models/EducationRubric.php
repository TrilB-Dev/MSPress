...
class EducationRubric extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var EducationAssignmentGradeType|null $grading The grading type of this rubric. You can use null for a no-points rubric or educationAssignmentPointsGradeType for a points rubric.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $lastModifiedDateTime Moment in time when the resource was last modified. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */

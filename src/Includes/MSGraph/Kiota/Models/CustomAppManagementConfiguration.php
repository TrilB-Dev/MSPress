...
{
    /**
     * @var CustomAppManagementApplicationConfiguration|null $applicationRestrictions Restrictions that are applicable only to application objects to which the policy is attached.
    */
    private ?CustomAppManagementApplicationConfiguration $applicationRestrictions = null;

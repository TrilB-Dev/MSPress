...
class DriveItem extends BaseItem implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $cTag An eTag for the content of the item. This eTag isn't changed if only the metadata is changed. Note This property isn't returned if the item is a folder. Read-only.
    */
    ...
    */
    ...
    /**
     * @var PublicationFacet|null $publication Provides information about the published or checked-out state of an item, in locations that support such actions. This property isn't returned by default. Read-only.
    */
    ...
    */
    ...
    /**
     * @var ItemRetentionLabel|null $retentionLabel Information about retention label and settings enforced on the driveItem. Read-write.
    */
    private ?ItemRetentionLabel $retentionLabel = null;
    ...
    */
    ...
    /**
     * @var Shared|null $shared Indicates that the item was shared with others and provides information about the shared state of the item. Read-only.
    */
    ...
    */
    ...
    /**
     * @var array<ThumbnailSet>|null $thumbnails Collection of thumbnailSet objects associated with the item. For more information, see getting thumbnails. Read-only. Nullable.
    */
    ...
    */
    ...
    /**
     * @var Workbook|null $workbook For files that are Excel spreadsheets, access to the workbook API to work with the spreadsheet's contents. Nullable.
    */

...
{
    /**
     * @var array<Participant>|null $participants The collection of participants that were updated since the last roster update.
    */
    private ?array $participants = null;
    
    /**
     * @var int|null $sequenceNumber The sequence number for the roster update that is used to identify the notification order.
    */

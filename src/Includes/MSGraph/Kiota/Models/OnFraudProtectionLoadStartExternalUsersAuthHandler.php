...
{
    /**
     * @var FraudProtectionConfiguration|null $signUp Specifies the fraud protection configuration for sign-up events.
    */
    private ?FraudProtectionConfiguration $signUp = null;

...
class BaseEndUserNotification implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $defaultLanguage The default language for the end user notification.
    */
    private ?string $defaultLanguage = null;
    
    /**
     * @var EndUserNotification|null $endUserNotification The endUserNotification property
    */
    private ?EndUserNotification $endUserNotification = null;

...
class WindowsUpdateForBusinessConfiguration extends DeviceConfiguration implements Parsable 
{
    ...
    */
    ...
    /**
     * @var WindowsUpdateInstallScheduleType|null $installationSchedule The Installation Schedule. The possible values are: ActiveHoursStart, ActiveHoursEnd, ScheduledInstallDay, ScheduledInstallTime. Returned by default. Query parameters are not supported.
    */
    ...
    */
    ...
    /**
     * @var WindowsUpdateForBusinessUpdateWeeks|null $updateWeeks Schedule the update installation on the weeks of the month. The possible values are: UserDefined, FirstWeek, SecondWeek, ThirdWeek, FourthWeek, EveryWeek. Returned by default. Query parameters are not supported. The possible values are: userDefined, firstWeek, secondWeek, thirdWeek, fourthWeek, everyWeek, unknownFutureValue.
    */

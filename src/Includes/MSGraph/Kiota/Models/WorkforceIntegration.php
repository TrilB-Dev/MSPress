...
{
    /**
     * @var int|null $apiVersion API version for the callback URL. Start with 1.
    */
    ...
    */
    ...
    /**
     * @var EligibilityFilteringEnabledEntities|null $eligibilityFilteringEnabledEntities Support to view eligibility-filtered results. The possible values are: none, swapRequest, offerShiftRequest, unknownFutureValue, timeOffReason. Use the Prefer: include-unknown-enum-members request header to get the following members in this evolvable enum: timeOffReason.
    */

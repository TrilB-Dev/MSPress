...
{
    /**
     * @var array<EducationAssignmentResource>|null $dependentResources A collection of assignment resources that depend on the parent educationAssignmentResource.
    */

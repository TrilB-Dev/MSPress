...
class MultiTenantOrganizationJoinRequestTransitionDetails implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var MultiTenantOrganizationMemberState|null $desiredMemberState State of the tenant in the multitenant organization currently being processed. The possible values are: pending, active, removed, unknownFutureValue. Read-only.
    */
    private ?MultiTenantOrganizationMemberState $desiredMemberState = null;

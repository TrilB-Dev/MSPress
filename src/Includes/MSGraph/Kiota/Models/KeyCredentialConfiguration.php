...
class KeyCredentialConfiguration implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var DateInterval|null $maxLifetime String value that indicates the maximum lifetime for key expiration, defined as an ISO 8601 duration. For example, P4DT12H30M5S represents four days, 12 hours, 30 minutes, and five seconds. This property is required when restrictionType is set to asymmetricKeyLifetime.
    */
    ...
    */
    ...
    /**
     * @var AppKeyCredentialRestrictionType|null $restrictionType The type of restriction being applied. Possible values are asymmetricKeyLifetime, and unknownFutureValue. Each value of restrictionType can be used only once per policy.
    */

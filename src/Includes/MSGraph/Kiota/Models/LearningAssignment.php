...
{
    /**
     * @var DateTime|null $assignedDateTime Assigned date for the course activity. Optional.
    */
    private ?DateTime $assignedDateTime = null;
    
    /**
     * @var string|null $assignerUserId The user ID of the assigner. Optional.
    */
    ...
    */
    ...
    /**
     * @var DateTimeTimeZone|null $dueDateTime Due date for the course activity. Optional.
    */
    private ?DateTimeTimeZone $dueDateTime = null;
    
    /**
     * @var ItemBody|null $notes Notes for the course activity. Optional.
    */

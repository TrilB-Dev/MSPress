...
class CrossTenantAccessPolicyInboundTrust implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isCompliantDeviceAccepted Specifies whether compliant devices from external Microsoft Entra organizations are trusted.
    */
    private ?bool $isCompliantDeviceAccepted = null;
    
    /**
     * @var bool|null $isHybridAzureADJoinedDeviceAccepted Specifies whether Microsoft Entra hybrid joined devices from external Microsoft Entra organizations are trusted.
    */
    private ?bool $isHybridAzureADJoinedDeviceAccepted = null;
    
    /**
     * @var bool|null $isMfaAccepted Specifies whether MFA from external Microsoft Entra organizations is trusted.
    */

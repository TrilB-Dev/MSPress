...
class M365CapabilityInboundAccess implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $isAllowed Indicates whether this capability should be allowed or blocked for inbound access.
    */
    ...
    */
    ...
    /**
     * @var M365CapabilityResourceScopes|null $resourceScopes Specifies the included and excluded resource scopes for the capability.
    */
    private ?M365CapabilityResourceScopes $resourceScopes = null;

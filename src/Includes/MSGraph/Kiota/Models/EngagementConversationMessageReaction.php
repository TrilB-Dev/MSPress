...
{
    /**
     * @var DateTime|null $createdDateTime Date and time when the reaction was added. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var EngagementIdentitySet|null $reactionBy The reactionBy property
    */
    private ?EngagementIdentitySet $reactionBy = null;
    
    /**
     * @var EngagementConversationMessageReactionType|null $reactionType Types of reactions to conversation messages.
    */
    private ?EngagementConversationMessageReactionType $reactionType = null;

...
class TeamsAppAuthorization implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $clientAppId The registration ID of the Microsoft Entra app ID associated with the teamsApp.
    */
    ...
    */
    ...
    /**
     * @var TeamsAppPermissionSet|null $requiredPermissionSet Set of permissions required by the teamsApp.
    */
    private ?TeamsAppPermissionSet $requiredPermissionSet = null;

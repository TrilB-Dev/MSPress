...
class AndroidWorkProfileCompliancePolicy extends DeviceCompliancePolicy implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $securityBlockJailbrokenDevices Indicates the device should not be rooted. When TRUE, if the device is detected as rooted it will be reported non-compliant. When FALSE, the device is not reported as non-compliant regardless of device rooted state. Default is FALSE.
    */
    ...
    */
    ...
    /**
     * @var bool|null $securityRequireSafetyNetAttestationBasicIntegrity Require the device to pass the Play Integrity basic integrity check.
    */
    private ?bool $securityRequireSafetyNetAttestationBasicIntegrity = null;
    
    /**
     * @var bool|null $securityRequireSafetyNetAttestationCertifiedDevice Require the device to pass the Play Integrity device integrity check.
    */

...
class UserTrainingEventInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var TrainingStatus|null $latestTrainingStatus Latest status of the training assigned to the user. The possible values are: unknown, assigned, inProgress, completed, overdue, unknownFutureValue.
    */

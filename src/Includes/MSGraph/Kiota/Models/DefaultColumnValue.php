...
class DefaultColumnValue implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $formula The formula used to compute the default value for the column.
    */
    ...
    */
    ...
    /**
     * @var string|null $value The direct value to use as the default value for the column.
    */

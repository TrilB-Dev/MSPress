...
class CallRecordingEventMessageDetail extends EventMessageDetail implements Parsable 
{
    ...
    */
    ...
    /**
     * @var CallRecordingStatus|null $callRecordingStatus Status of the call recording. The possible values are: success, failure, initial, chunkFinished, unknownFutureValue.
    */

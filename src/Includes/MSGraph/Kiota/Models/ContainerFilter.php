...
class ContainerFilter implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<string>|null $includedContainers The includedContainers property
    */
    private ?array $includedContainers = null;

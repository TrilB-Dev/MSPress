...
{
    /**
     * @var string|null $agentId The unique identifier for the AI agent.
    */
    private ?string $agentId = null;
    
    /**
     * @var string|null $agentName The display name for the AI agent.
    */
    private ?string $agentName = null;
    
    /**
     * @var AiAgentPlatform|null $hostingPlatformType Type of the platform the agent runs on. The possible values are: unknown, azureAIFoundry, copilotStudio, copilot, unknownFutureValue.
    */
    private ?AiAgentPlatform $hostingPlatformType = null;
    
    /**
     * @var string|null $instructions The instructions of the agent.
    */
    ...
    */
    public function getHostingPlatformType(): ?AiAgentPlatform {
        return $this->hostingPlatformType;
    }
    ...
    */
    public function setHostingPlatformType(?AiAgentPlatform $value): void {
        $this->hostingPlatformType = $value;
    }

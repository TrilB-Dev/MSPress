...
{
    /**
     * @var string|null $category The type of component that was detected (for example, Operating System, Framework, Remote Access, or Server).
    */
    private ?string $category = null;
    
    /**
     * @var DateTime|null $firstSeenDateTime The first date and time when Microsoft Defender Threat Intelligence observed this web component. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014, is 2014-01-01T00:00:00Z.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $lastSeenDateTime The most recent date and time when Microsoft Defender Threat Intelligence observed this web component. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014, is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $lastSeenDateTime = null;
    
    /**
     * @var string|null $name A name running on the artifact, for example, Microsoft IIS.
    */
    private ?string $name = null;
    
    /**
     * @var string|null $version The component version running on the artifact, for example, v8.5. This shouldn't be assumed to be strictly numerical.
    */

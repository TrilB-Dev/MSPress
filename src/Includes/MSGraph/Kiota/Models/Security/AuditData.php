...
*/
class AuditData implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AuditRecordTypeDictionary|null $dynamicProperties An open-type dictionary that contains dynamic audit event properties as name-value pairs.
    */
    private ?AuditRecordTypeDictionary $dynamicProperties = null;

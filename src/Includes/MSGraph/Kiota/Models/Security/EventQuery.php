...
class EventQuery implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $query Represents unique identification for the  query. 'Asset ID' for SharePoint Online and OneDrive for Business, 'keywords' for Exchange Online.
    */
    private ?string $query = null;
    
    /**
     * @var QueryType|null $queryType Represents the type of query associated with an event. 'files' for SPO and ODB and 'messages' for EXO.The possible values are: files, messages, unknownFutureValue.
    */

...
class AlertEvidence implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime The date and time when the evidence was created and added to the alert. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var array<string>|null $detailedRoles Detailed description of the entity role/s in an alert. Values are free-form.
    */
    private ?array $detailedRoles = null;
    ...
    */
    ...
    /**
     * @var array<EvidenceRole>|null $roles The role/s that an evidence entity represents in an alert, for example, an IP address that is associated with an attacker has the evidence role Attacker.
    */

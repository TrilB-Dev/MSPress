...
{
    /**
     * @var string|null $computerDnsName The DNS name of the computer associated with the sensor.
    */
    private ?string $computerDnsName = null;
    
    /**
     * @var string|null $domainName The domain name of the sensor.
    */
    private ?string $domainName = null;
    
    /**
     * @var DateTime|null $lastSeenDateTime The date and time when the sensor was last seen.
    */
    private ?DateTime $lastSeenDateTime = null;
    
    /**
     * @var string|null $senseClientVersion The version of the Defender for Identity sensor client. Supports $filter (eq).
    */
    private ?string $senseClientVersion = null;
    ...
    */
    public function getSenseClientVersion(): ?string {
        return $this->senseClientVersion;
    }

...
{
    /**
     * @var string|null $kind The kind for this unclassifiedArtifact resource, describing what this value means.
    */
    private ?string $kind = null;
    
    /**
     * @var string|null $value The value for this unclassifiedArtifact.
    */

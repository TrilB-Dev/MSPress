...
class KubernetesServicePort implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $appProtocol The application protocol for this port.
    */
    private ?string $appProtocol = null;
    
    /**
     * @var string|null $name The name of this port within the service.
    */
    private ?string $name = null;
    
    /**
     * @var int|null $nodePort The port on each node on which this service is exposed when the type is either NodePort or LoadBalancer.
    */
    ...
    */
    ...
    /**
     * @var int|null $port The port that this service exposes.
    */
    private ?int $port = null;
    
    /**
     * @var ContainerPortProtocol|null $protocol The protocol name. The possible values are: udp, tcp, sctp, unknownFutureValue.
    */
    private ?ContainerPortProtocol $protocol = null;
    
    /**
     * @var string|null $targetPort The name or number of the port to access on the pods targeted by the service. The port number must be in the range 1 to 65535. The name must be an IANASVCNAME.
    */

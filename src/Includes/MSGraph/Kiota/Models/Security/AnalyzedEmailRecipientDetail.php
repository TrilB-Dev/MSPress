...
class AnalyzedEmailRecipientDetail implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<string>|null $ccRecipients Recipient address in the cc field.
    */
    private ?array $ccRecipients = null;
    
    /**
     * @var string|null $domainName Domain name of the recipient.
    */

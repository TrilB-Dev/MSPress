...
class AnalyzedEmailExchangeTransportRuleInfo implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $name Name of the Exchange transport rules (ETRs) that are part of the email.
    */
    ...
    */
    ...
    /**
     * @var string|null $ruleId The ETR rule ID.
    */

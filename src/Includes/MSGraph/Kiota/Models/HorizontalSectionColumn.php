...
{
    /**
     * @var array<WebPart>|null $webparts The collection of WebParts in this column.
    */
    private ?array $webparts = null;
    
    /**
     * @var int|null $width Width of the column. A horizontal section is divided into 12 grids. A column should have a value of 1-12 to represent its range spans. For example, there can be two columns both have a width of 6 in a section.
    */

...
namespace MSPress\Includes\MSGraph\Kiota\Models\Search;
...
class Bookmark extends SearchAnswer implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<string>|null $groupIds The list of security groups that are able to view this bookmark.
    */
    ...
    */
    ...
    /**
     * @var array<string>|null $languageTags A list of geographically specific language names in which this bookmark can be viewed. Each language tag value follows the pattern {language}-{region}. For example, en-us is English as used in the United States. For the list of possible values, see Supported language tags.
    */
    private ?array $languageTags = null;
    
    /**
     * @var array<DevicePlatformType>|null $platforms List of devices and operating systems that are able to view this bookmark. The possible values are: android, androidForWork, ios, macOS, windowsPhone81, windowsPhone81AndLater, windows10AndLater, androidWorkProfile, unknown, androidASOP, androidMobileApplicationManagement, iOSMobileApplicationManagement, unknownFutureValue.
    */
    private ?array $platforms = null;
    
    /**
     * @var array<string>|null $powerAppIds List of Power Apps associated with this bookmark. If users add existing Power Apps to a bookmark, they can complete tasks directly on the search results page, such as entering vacation time or reporting expenses.
    */
    ...
    */
    ...
    /**
     * @var array<AnswerVariant>|null $targetedVariations Variations of a bookmark for different countries/regions or devices. Use when you need to show different content to users based on their device, country/region, or both. The date and group settings apply to all variations.
    */

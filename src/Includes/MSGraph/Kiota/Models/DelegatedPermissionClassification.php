...
{
    /**
     * @var PermissionClassificationType|null $classification The classification value. Possible values: low, medium (preview), high (preview). Doesn't support $filter.
    */
    private ?PermissionClassificationType $classification = null;
    
    /**
     * @var string|null $permissionId The unique identifier (id) for the delegated permission listed in the oauth2PermissionScopes collection of the servicePrincipal. Required on create. Doesn't support $filter.
    */
    private ?string $permissionId = null;
    
    /**
     * @var string|null $permissionName The claim value (value) for the delegated permission listed in the oauth2PermissionScopes collection of the servicePrincipal. Doesn't support $filter.
    */

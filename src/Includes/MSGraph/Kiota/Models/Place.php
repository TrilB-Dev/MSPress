...
{
    /**
     * @var PhysicalAddress|null $address The physical address of the place, including the street, city, state, country or region, and postal code.
    */
    private ?PhysicalAddress $address = null;
    
    /**
     * @var array<CheckInClaim>|null $checkIns A subresource of a place object that indicates the check-in status of an Outlook calendar event booked at the place.
    */
    private ?array $checkIns = null;
    
    /**
     * @var string|null $displayName The name that is associated with the place.
    */
    ...
    */
    ...
    /**
     * @var bool|null $isWheelChairAccessible Indicates whether the place is wheelchair accessible.
    */
    private ?bool $isWheelChairAccessible = null;
    
    /**
     * @var string|null $label User-defined description of the place.
    */
    private ?string $label = null;
    
    /**
     * @var string|null $parentId The ID of a parent place.
    */
    ...
    */
    ...
    /**
     * @var string|null $placeId A stable service-level identifier for the place object used by Places workloads.
    */
    private ?string $placeId = null;
    
    /**
     * @var array<string>|null $tags Custom tags that are associated with the place for categorization or filtering.
    */

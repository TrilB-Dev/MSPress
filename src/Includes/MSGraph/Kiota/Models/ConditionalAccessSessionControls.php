...
class ConditionalAccessSessionControls implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $disableResilienceDefaults Session control that determines whether it is acceptable for Microsoft Entra ID to extend existing sessions based on information collected prior to an outage or not.
    */
    ...
    */
    ...
    /**
     * @var SecureSignInSessionControl|null $secureSignInSession The secureSignInSession property
    */
    private ?SecureSignInSessionControl $secureSignInSession = null;

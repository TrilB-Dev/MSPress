...
{
    /**
     * @var DateTime|null $completedDateTime Date and time when the assignment was completed. Optional.
    */
    private ?DateTime $completedDateTime = null;
    
    /**
     * @var int|null $completionPercentage The percentage completion value of the course activity. Optional.
    */
    private ?int $completionPercentage = null;
    
    /**
     * @var string|null $externalcourseActivityId The externalcourseActivityId property
    */
    private ?string $externalcourseActivityId = null;
    
    /**
     * @var string|null $learnerUserId The user ID of the learner to whom the activity is assigned. Required.
    */
    private ?string $learnerUserId = null;
    
    /**
     * @var string|null $learningContentId The ID of the learning content created in Viva Learning. Required.
    */
    private ?string $learningContentId = null;
    
    /**
     * @var string|null $learningProviderId The registration ID of the provider. Required.
    */
    private ?string $learningProviderId = null;
    
    /**
     * @var CourseStatus|null $status The status of the course activity. The possible values are: notStarted, inProgress, completed. Required.
    */

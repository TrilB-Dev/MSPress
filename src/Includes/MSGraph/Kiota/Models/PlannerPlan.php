...
class PlannerPlan extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var PlannerPlanContainer|null $container Identifies the container of the plan. Specify only the url, the containerId and type, or all properties. After it's set, this property can’t be updated. Required.
    */
    ...
    */
    ...
    /**
     * @var PlannerPlanDetails|null $details Read-only. Nullable. Extra details about the plan.
    */
    private ?PlannerPlanDetails $details = null;
    
    /**
     * @var string|null $owner Use the container property instead. ID of the group that owns the plan. After it's set, this property can’t be updated. This property won't return a valid group ID if the container of the plan isn't a group.
    */

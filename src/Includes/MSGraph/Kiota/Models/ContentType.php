...
class ContentType extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<ColumnDefinition>|null $columns The collection of column definitions for this content type.
    */
    ...
    */
    ...
    /**
     * @var bool|null $propagateChanges If true, any changes made to the content type are pushed to inherited content types and lists that implement the content type.
    */

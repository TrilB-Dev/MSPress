...
{
    /**
     * @var array<string>|null $directoryObjectIds The list of Exchange directoryObjectIds to add to the Exchange protection policy.
    */
    private ?array $directoryObjectIds = null;
    
    /**
     * @var array<string>|null $mailboxes The list of Exchange email addresses to add to the Exchange protection policy.
    */

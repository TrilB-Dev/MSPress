...
class PasswordCredential implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $secretText Read-only; Contains the strong passwords generated by Microsoft Entra ID that are 16-64 characters in length. The generated password value is only returned during the initial POST request to addPassword. There is no way to retrieve this password in the future.
    */

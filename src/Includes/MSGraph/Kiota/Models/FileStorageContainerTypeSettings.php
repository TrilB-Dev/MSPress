...
class FileStorageContainerTypeSettings implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var FileStorageContainerTypeSettingsOverride|null $consumingTenantOverridables A comma-separated list of settings that can be overridden in the consuming tenant. The possible values are: urlTemplate, isDiscoverabilityEnabled, isSearchEnabled, isItemVersioningEnabled, itemMajorVersionLimit, maxStoragePerContainerInBytes, unknownFutureValue.
    */
    private ?FileStorageContainerTypeSettingsOverride $consumingTenantOverridables = null;
    ...
    */
    ...
    /**
     * @var SharingCapabilities|null $sharingCapability Sharing capabilities permitted for containers. This value can always be overridden during registration if needed. The possible values are: disabled, externalUserSharingOnly, externalUserAndGuestSharing, existingExternalUserSharingOnly, unknownFutureValue.
    */
    ...
    */
    public function getConsumingTenantOverridables(): ?FileStorageContainerTypeSettingsOverride {
        return $this->consumingTenantOverridables;
    }
    ...
    */
    public function setConsumingTenantOverridables(?FileStorageContainerTypeSettingsOverride $value): void {
        $this->consumingTenantOverridables = $value;
    }

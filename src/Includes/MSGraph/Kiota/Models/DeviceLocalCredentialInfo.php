...
{
    /**
     * @var array<DeviceLocalCredential>|null $credentials The credentials of the device's local administrator account backed up to Azure Active Directory.
    */
    private ?array $credentials = null;
    
    /**
     * @var string|null $deviceName Display name of the device that the local credentials are associated with.
    */
    private ?string $deviceName = null;
    
    /**
     * @var DateTime|null $lastBackupDateTime When the local administrator account credential was backed up to Azure Active Directory.
    */
    private ?DateTime $lastBackupDateTime = null;
    
    /**
     * @var DateTime|null $refreshDateTime When the local administrator account credential will be refreshed and backed up to Azure Active Directory.
    */
    private ?DateTime $refreshDateTime = null;

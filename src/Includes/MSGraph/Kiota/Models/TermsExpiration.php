...
class TermsExpiration implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var DateInterval|null $frequency Represents the frequency at which the terms will expire, after its first expiration as set in startDateTime. The value is represented in ISO 8601 format for durations. For example, PT1M represents a time period of one month.
    */

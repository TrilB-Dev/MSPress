...
class IdentityUserFlowAttributeAssignment extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isOptional Determines whether the identityUserFlowAttribute is optional. true means the user doesn't have to provide a value. false means the user can't complete sign-up without providing a value.
    */
    private ?bool $isOptional = null;
    
    /**
     * @var bool|null $requiresVerification Determines whether the identityUserFlowAttribute requires verification, and is only used for verifying the user's phone number or email address.
    */

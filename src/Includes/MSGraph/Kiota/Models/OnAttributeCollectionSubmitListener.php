...
{
    /**
     * @var OnAttributeCollectionSubmitHandler|null $handler Configuration for what to invoke if the event resolves to this listener.
    */
    private ?OnAttributeCollectionSubmitHandler $handler = null;

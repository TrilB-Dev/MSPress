...
class OnlineMeetingInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $joinUrl The external link that launches the online meeting. This is a URL that clients launch into a browser and will redirect the user to join the meeting.
    */
    ...
    */
    ...
    /**
     * @var string|null $quickDial The preformatted quick dial for this call.
    */

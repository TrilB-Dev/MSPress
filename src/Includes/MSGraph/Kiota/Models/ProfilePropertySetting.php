...
{
    /**
     * @var string|null $displayName Name of the property-level setting.
    */
    private ?string $displayName = null;
    
    /**
     * @var string|null $name Other name of the property-level setting. For backward compatibility.
    */
    private ?string $name = null;
    
    /**
     * @var array<string>|null $prioritizedSourceUrls A collection of prioritized profile source URLs ordered by data precedence within an organization.
    */
    private ?array $prioritizedSourceUrls = null;
    ...
    */
    public function getPrioritizedSourceUrls(): ?array {
        return $this->prioritizedSourceUrls;
    }
    ...
    */
    public function setPrioritizedSourceUrls(?array $value): void {
        $this->prioritizedSourceUrls = $value;
    }

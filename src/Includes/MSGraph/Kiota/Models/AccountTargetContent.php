...
class AccountTargetContent implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var AccountTargetContentType|null $type The type of account target content. The possible values are: unknown, includeAll, addressBook, unknownFutureValue.
    */
    private ?AccountTargetContentType $type = null;

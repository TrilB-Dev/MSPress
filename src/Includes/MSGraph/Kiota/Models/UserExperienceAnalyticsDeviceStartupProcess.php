...
{
    /**
     * @var string|null $managedDeviceId The Intune device id of the device. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $managedDeviceId = null;
    
    /**
     * @var string|null $processName The name of the process. Examples: outlook, excel. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $processName = null;
    
    /**
     * @var string|null $productName The product name of the process. Examples: Microsoft Outlook, Microsoft Excel. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $productName = null;
    
    /**
     * @var string|null $publisher The publisher of the process. Examples: Microsoft Corporation, Contoso Corp. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $publisher = null;
    
    /**
     * @var int|null $startupImpactInMs The impact of startup process on device boot time in milliseconds. Supports: $select, $OrderBy. Read-only.
    */

...
class ManagedMobileLobApp extends ManagedApp implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<MobileAppContent>|null $contentVersions The list of content versions for this app. This property is read-only.
    */
    ...
    */
    ...
    /**
     * @var int|null $size The total size, including all uploaded files. This property is read-only.
    */

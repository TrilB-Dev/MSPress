...
class Organization extends DirectoryObject implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<string>|null $businessPhones Telephone number for the organization. Although this property is a string collection, only one number can be set.
    */
    ...
    */
    ...
    /**
     * @var string|null $country Country or region name of the address for the organization.
    */
    ...
    */
    ...
    /**
     * @var bool|null $onPremisesSyncEnabled true if this object is synced from an on-premises directory; false if this object was originally synced from an on-premises directory but is no longer synced. Nullable. null if this object isn't synced from on-premises active directory (default).
    */
    private ?bool $onPremisesSyncEnabled = null;
    
    /**
     * @var PartnerTenantType|null $partnerTenantType The type of partnership this tenant has with Microsoft. The possible values are: microsoftSupport, syndicatePartner, breadthPartner, breadthPartnerDelegatedAdmin, resellerPartnerDelegatedAdmin, valueAddedResellerPartnerDelegatedAdmin, unknownFutureValue. Nullable. For more information about the possible types, see partnerTenantType values.
    */
    private ?PartnerTenantType $partnerTenantType = null;
    ...
    */
    ...
    /**
     * @var array<string>|null $securityComplianceNotificationMails Not nullable.
    */
    private ?array $securityComplianceNotificationMails = null;
    
    /**
     * @var array<string>|null $securityComplianceNotificationPhones Not nullable.
    */

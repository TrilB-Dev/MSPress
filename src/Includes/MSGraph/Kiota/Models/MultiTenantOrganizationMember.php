...
{
    /**
     * @var string|null $addedByTenantId Tenant ID of the tenant that added the tenant to the multitenant organization. Read-only.
    */
    private ?string $addedByTenantId = null;
    
    /**
     * @var DateTime|null $addedDateTime Date and time when the tenant was added to the multitenant organization. Read-only.
    */
    private ?DateTime $addedDateTime = null;
    
    /**
     * @var string|null $displayName Display name of the tenant added to the multitenant organization.
    */
    private ?string $displayName = null;
    
    /**
     * @var DateTime|null $joinedDateTime Date and time when the tenant joined the multitenant organization. Read-only.
    */
    private ?DateTime $joinedDateTime = null;
    
    /**
     * @var MultiTenantOrganizationMemberRole|null $role Role of the tenant in the multitenant organization. The possible values are: owner, member (default), unknownFutureValue. Tenants with the owner role can manage the multitenant organization but tenants with the member role can only participate in a multitenant organization. There can be multiple tenants with the owner role in a multitenant organization.
    */
    private ?MultiTenantOrganizationMemberRole $role = null;
    
    /**
     * @var MultiTenantOrganizationMemberState|null $state State of the tenant in the multitenant organization. The possible values are: pending, active, removed, unknownFutureValue. Tenants in the pending state must join the multitenant organization to participate in the multitenant organization. Tenants in the active state can participate in the multitenant organization. Tenants in the removed state are in the process of being removed from the multitenant organization. Read-only.
    */
    private ?MultiTenantOrganizationMemberState $state = null;
    
    /**
     * @var string|null $tenantId Tenant ID of the Microsoft Entra tenant added to the multitenant organization. Set at the time tenant is added.Supports $filter. Key.
    */
    private ?string $tenantId = null;
    
    /**
     * @var MultiTenantOrganizationMemberTransitionDetails|null $transitionDetails Details of the processing status for a tenant in a multitenant organization. Read-only. Nullable.
    */
    private ?MultiTenantOrganizationMemberTransitionDetails $transitionDetails = null;

...
class OrgContact extends DirectoryObject implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $companyName Name of the company that this organizational contact belongs to.  Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values).
    */
    private ?string $companyName = null;
    
    /**
     * @var string|null $department The name for the department in which the contact works.  Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values).
    */
    ...
    */
    ...
    /**
     * @var string|null $displayName Display name for this organizational contact. Maximum length is 256 characters. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values), $search, and $orderby.
    */
    private ?string $displayName = null;
    
    /**
     * @var string|null $givenName First name for this organizational contact. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values).
    */
    private ?string $givenName = null;
    
    /**
     * @var string|null $jobTitle Job title for this organizational contact. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values).
    */
    private ?string $jobTitle = null;
    
    /**
     * @var string|null $mail The SMTP address for the contact, for example, 'jeff@contoso.com'. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values).
    */
    private ?string $mail = null;
    
    /**
     * @var string|null $mailNickname Email alias (portion of email address pre-pending the @ symbol) for this organizational contact. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values).
    */
    private ?string $mailNickname = null;
    
    /**
     * @var DirectoryObject|null $manager The user or contact that is this contact's manager. Read-only. Supports $expand and $filter (eq) by id.
    */
    ...
    */
    ...
    /**
     * @var array<OnPremisesProvisioningError>|null $onPremisesProvisioningErrors List of any synchronization provisioning errors for this organizational contact. Supports $filter (eq, not for category and propertyCausingError), /$count eq 0, /$count ne 0.
    */
    ...
    */
    ...
    /**
     * @var bool|null $onPremisesSyncEnabled true if this object is synced from an on-premises directory; false if this object was originally synced from an on-premises directory but is no longer synced and now mastered in Exchange; null if this object has never been synced from an on-premises directory (default).   Supports $filter (eq, ne, not, in, and eq for null values).
    */
    private ?bool $onPremisesSyncEnabled = null;
    
    /**
     * @var array<Phone>|null $phones List of phones for this organizational contact. Phone types can be mobile, business, and businessFax. Only one of each type can ever be present in the collection.
    */
    private ?array $phones = null;
    
    /**
     * @var array<string>|null $proxyAddresses For example: 'SMTP: bob@contoso.com', 'smtp: bob@sales.contoso.com'. The any operator is required for filter expressions on multi-valued properties. Supports $filter (eq, not, ge, le, startsWith, /$count eq 0, /$count ne 0).
    */
    private ?array $proxyAddresses = null;
    
    /**
     * @var array<ServiceProvisioningError>|null $serviceProvisioningErrors Errors published by a federated service describing a non-transient, service-specific error regarding the properties or link from an organizational contact object .  Supports $filter (eq, not, for isResolved and serviceInstance).
    */
    private ?array $serviceProvisioningErrors = null;
    
    /**
     * @var string|null $surname Last name for this organizational contact. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq for null values).
    */
    private ?string $surname = null;
    
    /**
     * @var array<DirectoryObject>|null $transitiveMemberOf Groups that this contact is a member of, including groups that the contact is nested under. Read-only. Nullable.
    */

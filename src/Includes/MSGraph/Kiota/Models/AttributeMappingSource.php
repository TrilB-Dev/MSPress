...
class AttributeMappingSource implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $expression Equivalent expression representation of this attributeMappingSource object.
    */
    private ?string $expression = null;
    
    /**
     * @var string|null $name Name parameter of the mapping source. Depending on the type property value, this can be the name of the function, the name of the source attribute, or a constant value to be used.
    */
    ...
    */
    ...
    /**
     * @var array<StringKeyAttributeMappingSourceValuePair>|null $parameters If this object represents a function, lists function parameters. Parameters consist of attributeMappingSource objects themselves, allowing for complex expressions. If type isn't Function, this property is null/empty array.
    */

...
class BookingBusiness extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var BookingPageSettings|null $bookingPageSettings Settings for the published booking page.
    */
    private ?BookingPageSettings $bookingPageSettings = null;
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime The date, time, and time zone when the booking business was created. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    ...
    */
    public function setBookingPageSettings(?BookingPageSettings $value): void {
        $this->bookingPageSettings = $value;
    }

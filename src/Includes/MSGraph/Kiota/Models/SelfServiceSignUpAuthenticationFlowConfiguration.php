...
class SelfServiceSignUpAuthenticationFlowConfiguration implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isEnabled Indicates whether self-service sign-up flow is enabled or disabled. The default value is false. This property isn't a key. Required.
    */

...
{
    /**
     * @var string|null $clientAppId ID of the service principal of the Microsoft Entra app that has been granted access. Read-only.
    */
    private ?string $clientAppId = null;
    
    /**
     * @var string|null $clientId ID of the Microsoft Entra app that has been granted access. Read-only.
    */
    ...
    */
    ...
    /**
     * @var string|null $permissionType The type of permission. The possible values are: Application, Delegated. Read-only.
    */
    private ?string $permissionType = null;
    
    /**
     * @var string|null $resourceAppId ID of the Microsoft Entra app that is hosting the resource. Read-only.
    */

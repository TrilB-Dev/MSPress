...
class Onenote extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<OnenoteOperation>|null $operations The status of OneNote operations. Getting an operations collection isn't supported, but you can get the status of long-running operations if the Operation-Location header is returned in the response. Read-only. Nullable.
    */
    ...
    */
    ...
    /**
     * @var array<OnenoteResource>|null $resources The image and other file resources in OneNote pages. Getting a resources collection isn't supported, but you can get the binary content of a specific resource. Read-only. Nullable.
    */

...
{
    /**
     * @var NotificationDeliveryFrequency|null $deliveryFrequency Configurable frequency for the reminder email introduced during simulation creation. The possible values are: unknown, weekly, biWeekly, unknownFutureValue.
    */
    private ?NotificationDeliveryFrequency $deliveryFrequency = null;

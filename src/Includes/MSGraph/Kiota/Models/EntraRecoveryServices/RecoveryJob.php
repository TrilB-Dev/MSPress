...
{
    /**
     * @var int|null $totalFailedChanges The count of changes (including both objects and links) that failed to apply during recovery.
    */
    private ?int $totalFailedChanges = null;
    
    /**
     * @var int|null $totalLinksModified The count of directory object links (relationships) that were successfully modified during recovery. This value may be less than totalChangedLinksCalculated if some link changes failed.
    */
    private ?int $totalLinksModified = null;
    
    /**
     * @var int|null $totalObjectsModified The count of directory objects that were successfully modified during recovery. This value may be less than totalChangedObjectsCalculated if some object changes failed.
    */
    private ?int $totalObjectsModified = null;
    ...
    */
    public function getTotalFailedChanges(): ?int {
        return $this->totalFailedChanges;
    }
    ...
    */
    public function getTotalLinksModified(): ?int {
        return $this->totalLinksModified;
    }
    ...
    */
    public function getTotalObjectsModified(): ?int {
        return $this->totalObjectsModified;
    }
    ...
    */
    public function setTotalObjectsModified(?int $value): void {
        $this->totalObjectsModified = $value;
    }

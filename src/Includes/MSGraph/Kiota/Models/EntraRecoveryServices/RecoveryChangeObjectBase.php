...
{
    /**
     * @var string|null $displayName The display name of the changed object in its current state, used to uniquely identify the object. Supports $filter (eq, ne, startswith).
    */
    private ?string $displayName = null;
    
    /**
     * @var ResourceTypeName|null $entityTypeName The entityTypeName property
    */
    private ?ResourceTypeName $entityTypeName = null;
    
    /**
     * @var string|null $failureMessage The error message if the change failed to apply. Only populated in getFailedChanges responses. null otherwise.
    */
    private ?string $failureMessage = null;
    
    /**
     * @var RecoveryAction|null $recoveryAction The recoveryAction property
    */
    private ?RecoveryAction $recoveryAction = null;

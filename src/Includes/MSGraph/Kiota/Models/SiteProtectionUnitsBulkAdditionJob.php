...
{
    /**
     * @var array<string>|null $siteIds The list of SharePoint site IDs to add to the SharePoint protection policy.
    */
    private ?array $siteIds = null;
    
    /**
     * @var array<string>|null $siteWebUrls The list of SharePoint site URLs to add to the SharePoint protection policy.
    */

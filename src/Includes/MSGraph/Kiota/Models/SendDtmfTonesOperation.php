...
{
    /**
     * @var SendDtmfCompletionReason|null $completionReason The results of the action. The possible values are: unknown, completedSuccessfully, mediaOperationCanceled, unknownfutureValue.
    */
    private ?SendDtmfCompletionReason $completionReason = null;

...
class TimeCardEntry implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<TimeCardBreak>|null $breaks The clock-in event of the timeCard.
    */
    private ?array $breaks = null;
    
    /**
     * @var TimeCardEvent|null $clockInEvent The clock-out event of the timeCard.
    */
    private ?TimeCardEvent $clockInEvent = null;
    
    /**
     * @var TimeCardEvent|null $clockOutEvent The list of breaks associated with the timeCard.
    */

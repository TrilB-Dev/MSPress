...
class ParticipantInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var EndpointType|null $endpointType The type of endpoint the participant is using. The possible values are: default, skypeForBusiness, or skypeForBusinessVoipPhone. Read-only.
    */
    ...
    */
    ...
    /**
     * @var string|null $region The home region of the participant. This can be a country, a continent, or a larger geographic region. This doesn't change based on the participant's current physical location. Read-only.
    */

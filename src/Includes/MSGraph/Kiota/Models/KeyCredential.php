...
class KeyCredential implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var StreamInterface|null $customKeyIdentifier A 40-character binary type that can be used to identify the credential. Optional. When not provided in the payload, defaults to the thumbprint of the certificate.
    */
    private ?StreamInterface $customKeyIdentifier = null;
    
    /**
     * @var string|null $displayName The friendly name for the key, with a maximum length of 90 characters. Longer values are accepted but shortened. Optional.
    */
    ...
    */
    ...
    /**
     * @var StreamInterface|null $key The certificate's raw data in byte array converted to Base64 string. Requires $select to retrieve; only available for single object requests (GET /applications/{applicationId}?$select=keyCredentials or GET /servicePrincipals/{servicePrincipalId}?$select=keyCredentials); otherwise, it's always null.  From a .cer certificate, you can read the key using the Convert.ToBase64String() method. For more information, see Get the certificate key.
    */

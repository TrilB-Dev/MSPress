...
class TimePeriod implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var DateTime|null $endDateTime The date time of the end of the time period.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $startDateTime The date time of the start of the time period.
    */

...
class MicrosoftAuthenticatorAuthenticationMethodConfiguration extends AuthenticationMethodConfiguration implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<MicrosoftAuthenticatorAuthenticationMethodTarget>|null $includeTargets A collection of groups that are enabled to use the authentication method. Expanded by default.
    */
    private ?array $includeTargets = null;
    
    /**
     * @var bool|null $isSoftwareOathEnabled The isSoftwareOathEnabled property
    */
    private ?bool $isSoftwareOathEnabled = null;

...
class OperatingSystemSpecifications implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $operatingSystemPlatform The platform of the operating system (for example, 'Windows').
    */
    private ?string $operatingSystemPlatform = null;
    
    /**
     * @var string|null $operatingSystemVersion The version string of the operating system.
    */
    ...
    */
    public function setOperatingSystemPlatform(?string $value): void {
        $this->operatingSystemPlatform = $value;
    }

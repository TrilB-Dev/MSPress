...
{
    /**
     * @var DateTime|null $createdDateTime The date and time when the key was originally backed up to Microsoft Entra ID. Not nullable.
    */
    ...
    */
    ...
    /**
     * @var string|null $key The BitLocker recovery key. Requires $select to retrieve. Not nullable.
    */

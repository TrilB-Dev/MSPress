...
class ChatMessage extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<ChatMessageMention>|null $mentions List of entities mentioned in the chat message. Supported entities are: user, bot, team, channel, chat, and tag.
    */
    private ?array $mentions = null;
    
    /**
     * @var array<ChatMessageHistoryItem>|null $messageHistory List of activity history of a message item, including modification time and actions, such as reactionAdded, reactionRemoved, or reaction changes, on the message.
    */
    private ?array $messageHistory = null;

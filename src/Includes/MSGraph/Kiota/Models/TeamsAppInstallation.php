...
{
    /**
     * @var TeamsAppPermissionSet|null $consentedPermissionSet The set of resource-specific permissions consented to while installing or upgrading the teamsApp.
    */
    private ?TeamsAppPermissionSet $consentedPermissionSet = null;

...
{
    /**
     * @var WorkbookChartSeriesFormat|null $format The formatting of a chart series, which includes fill and line formatting. Read-only.
    */
    private ?WorkbookChartSeriesFormat $format = null;
    
    /**
     * @var string|null $name The name of a series in a chart.
    */
    private ?string $name = null;
    
    /**
     * @var array<WorkbookChartPoint>|null $points A collection of all points in the series. Read-only.
    */

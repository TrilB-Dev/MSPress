...
{
    /**
     * @var array<string>|null $siteIds The list of SharePoint site IDs that are added to the corresponding SharePoint restore session in a bulk operation.
    */
    private ?array $siteIds = null;
    
    /**
     * @var array<string>|null $siteWebUrls The list of SharePoint site URLs that are added to the corresponding SharePoint restore session in a bulk operation.
    */
    private ?array $siteWebUrls = null;

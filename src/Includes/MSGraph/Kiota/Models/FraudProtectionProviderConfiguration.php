...
{
    /**
     * @var FraudProtectionProvider|null $fraudProtectionProvider The fraudProtectionProvider property
    */
    private ?FraudProtectionProvider $fraudProtectionProvider = null;
    ...
    */
    public function getFraudProtectionProvider(): ?FraudProtectionProvider {
        return $this->fraudProtectionProvider;
    }
    ...
    */
    public function setFraudProtectionProvider(?FraudProtectionProvider $value): void {
        $this->fraudProtectionProvider = $value;
    }

...
use MSPress\Includes\MSGraph\Kiota\Models\CallRecords\CallRecord;
use MSPress\Includes\MSGraph\Kiota\Models\CallRecords\Organizer;
use MSPress\Includes\MSGraph\Kiota\Models\CallRecords\Participant;
use MSPress\Includes\MSGraph\Kiota\Models\CallRecords\ParticipantBase;
use MSPress\Includes\MSGraph\Kiota\Models\CallRecords\Segment;
use MSPress\Includes\MSGraph\Kiota\Models\CallRecords\Session;
use MSPress\Includes\MSGraph\Kiota\Models\EntraRecoveryServices\Recovery;
use MSPress\Includes\MSGraph\Kiota\Models\EntraRecoveryServices\RecoveryChangeObjectBase;
use MSPress\Includes\MSGraph\Kiota\Models\EntraRecoveryServices\RecoveryJob;
use MSPress\Includes\MSGraph\Kiota\Models\EntraRecoveryServices\RecoveryJobBase;
use MSPress\Includes\MSGraph\Kiota\Models\EntraRecoveryServices\RecoveryPreviewJob;
use MSPress\Includes\MSGraph\Kiota\Models\EntraRecoveryServices\Snapshot;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\ConnectionOperation;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\ExternalActivity;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\ExternalActivityResult;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\ExternalConnection;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\ExternalGroup;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\ExternalItem;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\Identity;
use MSPress\Includes\MSGraph\Kiota\Models\ExternalConnectors\Schema;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\CustomTaskExtension;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\Insights;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\LifecycleManagementSettings;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\LifecycleWorkflowsContainer;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\Run;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\SubjectProcessingResult;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\Task;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\TaskDefinition;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\TaskProcessingResult;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\TaskReport;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\UserProcessingResult;
use MSPress\Includes\MSGraph\Kiota\Models\IdentityGovernance\WorkflowTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\AzureUsage;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\BilledReconciliation;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\BilledUsage;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\Billing;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\BillingReconciliation;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\ExportSuccessOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\FailedOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\Manifest;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\Operation;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\RunningOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\UnbilledReconciliation;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Billing\UnbilledUsage;
use MSPress\Includes\MSGraph\Kiota\Models\Partners\Partners;
...
use MSPress\Includes\MSGraph\Kiota\Models\Search\SearchAnswer;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Alert;
use MSPress\Includes\MSGraph\Kiota\Models\Security\AnalyzedEmail;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Article;
use MSPress\Includes\MSGraph\Kiota\Models\Security\ArticleIndicator;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Artifact;
use MSPress\Includes\MSGraph\Kiota\Models\Security\AuditCoreRoot;
use MSPress\Includes\MSGraph\Kiota\Models\Security\AuditLogQuery;
use MSPress\Includes\MSGraph\Kiota\Models\Security\AuditLogRecord;
use MSPress\Includes\MSGraph\Kiota\Models\Security\AuthorityTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\AutoAuditingConfiguration;
use MSPress\Includes\MSGraph\Kiota\Models\Security\CaseOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\CasesRoot;
use MSPress\Includes\MSGraph\Kiota\Models\Security\CategoryTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\CitationTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\CollaborationRoot;
use MSPress\Includes\MSGraph\Kiota\Models\Security\DataSet;
use MSPress\Includes\MSGraph\Kiota\Models\Security\DataSource;
use MSPress\Includes\MSGraph\Kiota\Models\Security\DataSourceContainer;
use MSPress\Includes\MSGraph\Kiota\Models\Security\DepartmentTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\DispositionReviewStage;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryAddToReviewSetOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryCase;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryCaseMember;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryCaseSettings;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryCustodian;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryEstimateOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryExportOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryHoldOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryHoldPolicySyncOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryIndexOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryNoncustodialDataSource;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryPurgeDataOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryReviewSet;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryReviewSetQuery;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryReviewTag;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoverySearch;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoverySearchExportOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EdiscoveryTagOperation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\EscapedCase;
use MSPress\Includes\MSGraph\Kiota\Models\Security\FilePlanDescriptor;
use MSPress\Includes\MSGraph\Kiota\Models\Security\FilePlanDescriptorTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\FilePlanReferenceTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HealthIssue;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Host;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HostComponent;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HostCookie;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Hostname;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HostPair;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HostPort;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HostReputation;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HostSslCertificate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\HostTracker;
use MSPress\Includes\MSGraph\Kiota\Models\Security\IdentityAccounts;
use MSPress\Includes\MSGraph\Kiota\Models\Security\IdentityContainer;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Incident;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Indicator;
use MSPress\Includes\MSGraph\Kiota\Models\Security\IntelligenceProfile;
use MSPress\Includes\MSGraph\Kiota\Models\Security\IntelligenceProfileIndicator;
use MSPress\Includes\MSGraph\Kiota\Models\Security\IpAddress;
use MSPress\Includes\MSGraph\Kiota\Models\Security\LabelsRoot;
use MSPress\Includes\MSGraph\Kiota\Models\Security\NetworkAdapter;
use MSPress\Includes\MSGraph\Kiota\Models\Security\PassiveDnsRecord;
use MSPress\Includes\MSGraph\Kiota\Models\Security\RetentionEvent;
use MSPress\Includes\MSGraph\Kiota\Models\Security\RetentionEventType;
use MSPress\Includes\MSGraph\Kiota\Models\Security\RetentionLabel;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Search;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Security;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Sensor;
use MSPress\Includes\MSGraph\Kiota\Models\Security\SensorCandidate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\SensorCandidateActivationConfiguration;
use MSPress\Includes\MSGraph\Kiota\Models\Security\SettingsContainer;
use MSPress\Includes\MSGraph\Kiota\Models\Security\SiteSource;
use MSPress\Includes\MSGraph\Kiota\Models\Security\SslCertificate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\SubcategoryTemplate;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Subdomain;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Tag;
use MSPress\Includes\MSGraph\Kiota\Models\Security\ThreatIntelligence;
use MSPress\Includes\MSGraph\Kiota\Models\Security\TriggersRoot;
use MSPress\Includes\MSGraph\Kiota\Models\Security\TriggerTypesRoot;
use MSPress\Includes\MSGraph\Kiota\Models\Security\UnclassifiedArtifact;
use MSPress\Includes\MSGraph\Kiota\Models\Security\UnifiedGroupSource;
use MSPress\Includes\MSGraph\Kiota\Models\Security\User;
use MSPress\Includes\MSGraph\Kiota\Models\Security\UserSource;
use MSPress\Includes\MSGraph\Kiota\Models\Security\Vulnerability;
use MSPress\Includes\MSGraph\Kiota\Models\Security\VulnerabilityComponent;
use MSPress\Includes\MSGraph\Kiota\Models\Security\WhoisBaseRecord;
use MSPress\Includes\MSGraph\Kiota\Models\Security\WhoisHistoryRecord;
use MSPress\Includes\MSGraph\Kiota\Models\Security\WhoisRecord;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\NumberAssignment;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\PolicyIdentifierDetail;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\TeamsAdminRoot;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\TeamsPolicyAssignment;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\TeamsPolicyUserAssignment;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\TeamsUserConfiguration;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\TelephoneNumberLongRunningOperation;
use MSPress\Includes\MSGraph\Kiota\Models\TeamsAdministration\TelephoneNumberManagementRoot;
use MSPress\Includes\MSGraph\Kiota\Models\TermStore\Group;
use MSPress\Includes\MSGraph\Kiota\Models\TermStore\Relation;

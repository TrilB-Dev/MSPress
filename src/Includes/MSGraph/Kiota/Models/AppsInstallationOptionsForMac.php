...
class AppsInstallationOptionsForMac implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $isMicrosoft365AppsEnabled Specifies whether users can install Microsoft 365 apps on their MAC devices. The default value is true.
    */
    private ?bool $isMicrosoft365AppsEnabled = null;
    
    /**
     * @var bool|null $isSkypeForBusinessEnabled Specifies whether users can install Skype for Business on their MAC devices running OS X El Capitan 10.11 or later. The default value is true.
    */

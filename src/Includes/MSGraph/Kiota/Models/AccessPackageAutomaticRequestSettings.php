...
class AccessPackageAutomaticRequestSettings implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var DateInterval|null $gracePeriodBeforeAccessRemoval The duration for which access must be retained before the target's access is revoked once they leave the allowed target scope.
    */
    ...
    */
    ...
    /**
     * @var bool|null $removeAccessWhenTargetLeavesAllowedTargets Indicates whether automatic assignment must be removed for targets who move out of the allowed target scope.
    */

...
{
    /**
     * @var string|null $callId The unique identifier for the call that is related to this transcript. Read-only.
    */
    private ?string $callId = null;
    
    /**
     * @var StreamInterface|null $content The content of the transcript. Read-only.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime Date and time at which the transcript was created. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Read-only.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var DateTime|null $endDateTime Date and time at which the transcription ends. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Read-only.
    */
    private ?DateTime $endDateTime = null;
    
    /**
     * @var string|null $meetingId The unique identifier of the online meeting related to this transcript. Read-only.
    */
    private ?string $meetingId = null;
    
    /**
     * @var IdentitySet|null $meetingOrganizer The identity information of the organizer of the onlineMeeting related to this transcript. Read-only.
    */
    private ?IdentitySet $meetingOrganizer = null;
    
    /**
     * @var StreamInterface|null $metadataContent The time-aligned metadata of the utterances in the transcript. Read-only.
    */
    private ?StreamInterface $metadataContent = null;
    
    /**
     * @var string|null $transcriptContentUrl The URL that can be used to access the content of the transcript. Read-only.
    */
    private ?string $transcriptContentUrl = null;

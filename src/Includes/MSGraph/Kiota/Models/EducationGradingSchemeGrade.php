...
class EducationGradingSchemeGrade implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var float|null $defaultPercentage The midpoint of the grade range.
    */
    private ?float $defaultPercentage = null;
    
    /**
     * @var string|null $displayName The name of this individual grade.
    */
    private ?string $displayName = null;
    
    /**
     * @var float|null $minPercentage The minimum percentage of the total points needed to achieve this grade.
    */

...
class VirtualEventExternalRegistrationInformation implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var string|null $referrer A URL or string that represents the location from which the registrant registered. Optional.
    */
    private ?string $referrer = null;
    
    /**
     * @var string|null $registrationId The identifier for a virtualEventExternalRegistrationInformation object. Optional. If set, the maximum supported length is 256 characters.
    */

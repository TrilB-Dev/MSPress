...
class EventMessage extends Message implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isDelegated True if this meeting request is accessible to a delegate, false otherwise. The default is false.
    */
    ...
    */
    ...
    /**
     * @var MeetingMessageType|null $meetingMessageType The type of event message: none, meetingRequest, meetingCancelled, meetingAccepted, meetingTenativelyAccepted, meetingDeclined.
    */

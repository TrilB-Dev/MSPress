...
{
    /**
     * @var PrivilegedAccessGroupRelationships|null $accessId The identifier of the membership or ownership eligibility relationship to the group. Required. The possible values are: owner, member. Supports $filter (eq).
    */
    private ?PrivilegedAccessGroupRelationships $accessId = null;
    
    /**
     * @var string|null $eligibilityScheduleId The identifier of the privilegedAccessGroupEligibilitySchedule from which this instance was created. Required. Supports $filter (eq, ne).
    */
    private ?string $eligibilityScheduleId = null;
    
    /**
     * @var Group|null $group References the group that is the scope of the membership or ownership eligibility through PIM for Groups. Supports $expand.
    */
    private ?Group $group = null;
    
    /**
     * @var string|null $groupId The identifier of the group representing the scope of the membership or ownership eligibility through PIM for Groups. Required. Supports $filter (eq).
    */
    private ?string $groupId = null;
    
    /**
     * @var PrivilegedAccessGroupMemberType|null $memberType Indicates whether the assignment is derived from a group assignment. It can further imply whether the calling principal can manage the assignment schedule. Required. The possible values are: direct, group, unknownFutureValue. Supports $filter (eq).
    */
    private ?PrivilegedAccessGroupMemberType $memberType = null;
    
    /**
     * @var DirectoryObject|null $principal References the principal that's in the scope of the membership or ownership eligibility request through the group that's governed by PIM. Supports $expand.
    */
    private ?DirectoryObject $principal = null;
    
    /**
     * @var string|null $principalId The identifier of the principal whose membership or ownership eligibility to the group is managed through PIM for Groups. Required. Supports $filter (eq).
    */

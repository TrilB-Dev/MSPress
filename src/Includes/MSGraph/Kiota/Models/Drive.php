...
{
    /**
     * @var array<DriveItem>|null $bundles Collection of bundles (albums and multi-select-shared sets of items). Only in personal OneDrive.
    */
    private ?array $bundles = null;
    
    /**
     * @var string|null $driveType Describes the type of drive represented by this resource. OneDrive personal drives return personal. OneDrive for Business returns business. SharePoint document libraries return documentLibrary. Read-only.
    */
    ...
    */
    ...
    /**
     * @var SystemFacet|null $system If present, indicates that it's a system-managed drive. Read-only.
    */

...
class TimeCard extends ChangeTrackedEntity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var ConfirmedBy|null $confirmedBy Indicates whether this timeCard entry is confirmed. The possible values are: none, user, manager, unknownFutureValue.
    */
    ...
    */
    ...
    /**
     * @var TimeCardEntry|null $originalEntry The original timeCardEntry of the timeCard before it was edited.
    */
    private ?TimeCardEntry $originalEntry = null;
    
    /**
     * @var TimeCardState|null $state The current state of the timeCard during its life cycle. The possible values are: clockedIn, onBreak, clockedOut, unknownFutureValue.
    */

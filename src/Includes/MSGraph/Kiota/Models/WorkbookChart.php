...
class WorkbookChart extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var WorkbookChartDataLabels|null $dataLabels Represents the data labels on the chart. Read-only.
    */
    ...
    */
    ...
    /**
     * @var WorkbookChartTitle|null $title Represents the title of the specified chart, including the text, visibility, position and formatting of the title. Read-only.
    */

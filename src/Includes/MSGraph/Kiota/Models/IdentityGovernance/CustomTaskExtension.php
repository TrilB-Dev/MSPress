...
use MSPress\Includes\MSGraph\Kiota\Models\CustomCalloutExtension;
use MSPress\Includes\MSGraph\Kiota\Models\CustomExtensionCallbackConfiguration;
...
{
    /**
     * @var CustomExtensionCallbackConfiguration|null $callbackConfiguration The callback configuration for a custom task extension.
    */
    private ?CustomExtensionCallbackConfiguration $callbackConfiguration = null;
    
    /**
     * @var User|null $createdBy The unique identifier of the Microsoft Entra user that created the custom task extension.Supports $filter(eq, ne) and $expand.
    */
    ...
    */
    ...
    /**
     * @var User|null $lastModifiedBy The unique identifier of the Microsoft Entra user that modified the custom task extension last.Supports $filter(eq, ne) and $expand.
    */
    ...
    */
    ...
    /**
     * @var CustomTaskExtensionReplyMode|null $replyMode The replyMode property
    */
    private ?CustomTaskExtensionReplyMode $replyMode = null;

...
{
    /**
     * @var OpenShiftItem|null $draftOpenShift Draft changes in the openShift are only visible to managers until they're shared.
    */
    private ?OpenShiftItem $draftOpenShift = null;
    
    /**
     * @var bool|null $isStagedForDeletion The openShift is marked for deletion, a process that is finalized when the schedule is shared.
    */
    private ?bool $isStagedForDeletion = null;
    
    /**
     * @var string|null $schedulingGroupId The ID of the schedulingGroup that contains the openShift.
    */
    private ?string $schedulingGroupId = null;
    
    /**
     * @var OpenShiftItem|null $sharedOpenShift The shared version of this openShift that is viewable by both employees and managers.
    */

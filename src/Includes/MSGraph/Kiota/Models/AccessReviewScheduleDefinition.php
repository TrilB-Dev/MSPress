...
class AccessReviewScheduleDefinition extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $descriptionForReviewers Description provided  by review creators to provide more context of the review to reviewers. Reviewers see this description in the email sent to them requesting their review. Email notifications support up to 256 characters. Supports $select.
    */

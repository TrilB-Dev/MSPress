...
{
    /**
     * @var int|null $activeDeviceCount The health score of the application. Valid values 0 to 100. Supports: $filter, $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    private ?int $activeDeviceCount = null;
    
    /**
     * @var int|null $appCrashCount The number of crashes for the application. Valid values 0 to 2147483647. Supports: $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    private ?int $appCrashCount = null;
    
    /**
     * @var string|null $appDisplayName The friendly name of the application. The possible values are: Outlook, Excel. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $appDisplayName = null;
    
    /**
     * @var int|null $appHangCount The number of hangs for the application. Supports: $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    private ?int $appHangCount = null;
    
    /**
     * @var float|null $appHealthScore The health score of the application. Valid values 0 to 100. Supports: $filter, $select, $OrderBy. Read-only. Valid values -1.79769313486232E+308 to 1.79769313486232E+308
    */
    private ?float $appHealthScore = null;
    
    /**
     * @var string|null $appName The name of the application. The possible values are: outlook.exe, excel.exe. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $appName = null;
    
    /**
     * @var string|null $appPublisher The publisher of the application. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $appPublisher = null;
    
    /**
     * @var int|null $appUsageDuration The total usage time of the application in minutes. Valid values 0 to 2147483647. Supports: $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    private ?int $appUsageDuration = null;
    
    /**
     * @var int|null $meanTimeToFailureInMinutes The mean time to failure for the application in minutes. Valid values 0 to 2147483647. Supports: $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */

...
class PasswordProfile implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $forceChangePasswordNextSignIn true if the user must change their password on the next sign-in; otherwise false.
    */
    ...
    */
    ...
    /**
     * @var string|null $password The password for the user. This property is required when a user is created. It can be updated, but the user will be required to change the password on the next sign-in. The password must satisfy minimum requirements as specified by the user's passwordPolicies property. By default, a strong password is required.
    */

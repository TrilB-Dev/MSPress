...
{
    /**
     * @var string|null $appDisplayName The friendly name of the application for which the event occurred. The possible values are: outlook.exe, excel.exe. Supports: $select, $OrderBy. Read-only.
    */
    ...
    */
    ...
    /**
     * @var string|null $appVersion The version of the application. The possible values are: 1.0.0.1, 75.65.23.9. Supports: $select, $OrderBy. Read-only.
    */

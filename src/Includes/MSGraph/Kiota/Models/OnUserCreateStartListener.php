...
{
    /**
     * @var OnUserCreateStartHandler|null $handler Required. Configuration for what to invoke if the event resolves to this listener. This lets us define potential handler configurations per-event.
    */
    private ?OnUserCreateStartHandler $handler = null;

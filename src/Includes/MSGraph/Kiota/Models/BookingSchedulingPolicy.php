...
class BookingSchedulingPolicy implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $allowStaffSelection True to allow customers to choose a specific person for the booking.
    */
    private ?bool $allowStaffSelection = null;
    
    /**
     * @var array<BookingsAvailabilityWindow>|null $customAvailabilities Custom availability of the service in a given time frame.
    */
    private ?array $customAvailabilities = null;
    
    /**
     * @var BookingsAvailability|null $generalAvailability General availability of the service defined by the scheduling policy.
    */
    private ?BookingsAvailability $generalAvailability = null;
    
    /**
     * @var bool|null $isMeetingInviteToCustomersEnabled Indicates whether the meeting invite is sent to the customers. The default value is false.
    */
    private ?bool $isMeetingInviteToCustomersEnabled = null;
    ...
    */
    public function setCustomAvailabilities(?array $value): void {
        $this->customAvailabilities = $value;
    }
    ...
    */
    public function setGeneralAvailability(?BookingsAvailability $value): void {
        $this->generalAvailability = $value;
    }
    ...
    */
    public function setIsMeetingInviteToCustomersEnabled(?bool $value): void {
        $this->isMeetingInviteToCustomersEnabled = $value;
    }

...
{
    /**
     * @var string|null $groupId The ID of the target group for the assignment.
    */
    private ?string $groupId = null;
    
    /**
     * @var string|null $servicePlanId The unique identifier for the service plan that indicates which size of the Cloud PC to provision for the user. Use a null value, when the provisioningType is dedicated.
    */

...
class RecycleBinSettings implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var int|null $retentionPeriodOverrideDays Recycle bin retention period override in days for deleted content. The default value is 93; the value range is 7 to 180. The setting applies to newly deleted content only. Setting this property to null reverts to its default value. Read-write.
    */
    private ?int $retentionPeriodOverrideDays = null;
    ...
    */
    public function setRetentionPeriodOverrideDays(?int $value): void {
        $this->retentionPeriodOverrideDays = $value;
    }

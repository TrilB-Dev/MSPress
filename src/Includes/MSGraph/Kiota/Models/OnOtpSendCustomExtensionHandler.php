...
{
    /**
     * @var CustomExtensionOverwriteConfiguration|null $configuration Configuration regarding properties of the custom extension that are can be overwritten for the onEmailOtpSendListener event listener.
    */
    private ?CustomExtensionOverwriteConfiguration $configuration = null;
    
    /**
     * @var OnOtpSendCustomExtension|null $customExtension The customExtension property
    */
    private ?OnOtpSendCustomExtension $customExtension = null;

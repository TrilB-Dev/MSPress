...
class BitLockerRemovableDrivePolicy implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var BitLockerEncryptionMethod|null $encryptionMethod Select the encryption method for removable  drives. The possible values are: aesCbc128, aesCbc256, xtsAes128, xtsAes256.
    */

...
class WorkbookChartLegend extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $overlay Indicates whether the chart legend should overlap with the main body of the chart.
    */
    ...
    */
    ...
    /**
     * @var bool|null $visible Indicates whether the chart legend is visible.
    */

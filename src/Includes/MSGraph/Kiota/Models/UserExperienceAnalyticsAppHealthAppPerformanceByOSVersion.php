...
{
    /**
     * @var int|null $activeDeviceCount The number of devices where the application has been active. Valid values 0 to 2147483647. Supports: $select, $OrderBy. Read-only. Valid values -2147483648 to 2147483647
    */
    ...
    */
    ...
    /**
     * @var string|null $osBuildNumber The OS build number of the application. Supports: $select, $OrderBy. Read-only.
    */
    private ?string $osBuildNumber = null;
    
    /**
     * @var string|null $osVersion The OS version of the application. Supports: $select, $OrderBy. Read-only.
    */

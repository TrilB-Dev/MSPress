...
class LearningProvider extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isCourseActivitySyncEnabled Indicates whether a provider can ingest learning course activity records. The default value is false. Set to true to make learningCourseActivities available for this provider.
    */
    private ?bool $isCourseActivitySyncEnabled = null;
    ...
    */
    ...
    /**
     * @var string|null $longLogoWebUrlForDarkTheme The long logo URL for the dark mode that needs to be a publicly accessible image. This image would be saved to the blob storage of Viva Learning for rendering within the Viva Learning app. Required.
    */
    private ?string $longLogoWebUrlForDarkTheme = null;
    
    /**
     * @var string|null $longLogoWebUrlForLightTheme The long logo URL for the light mode that needs to be a publicly accessible image. This image would be saved to the blob storage of Viva Learning for rendering within the Viva Learning app. Required.
    */
    private ?string $longLogoWebUrlForLightTheme = null;
    
    /**
     * @var string|null $squareLogoWebUrlForDarkTheme The square logo URL for the dark mode that needs to be a publicly accessible image. This image would be saved to the blob storage of Viva Learning for rendering within the Viva Learning app. Required.
    */
    private ?string $squareLogoWebUrlForDarkTheme = null;
    
    /**
     * @var string|null $squareLogoWebUrlForLightTheme The square logo URL for the light mode that needs to be a publicly accessible image. This image would be saved to the blob storage of Viva Learning for rendering within the Viva Learning app. Required.
    */

...
class ConditionalAccessFilter implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $rule Rule syntax is similar to that used for membership rules for groups in Microsoft Entra ID. For details, see rules with multiple expressions
    */

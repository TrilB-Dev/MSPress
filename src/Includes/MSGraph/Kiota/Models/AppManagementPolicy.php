...
{
    /**
     * @var array<DirectoryObject>|null $appliesTo Collection of applications and service principals to which the policy is applied.
    */
    private ?array $appliesTo = null;
    
    /**
     * @var bool|null $isEnabled Denotes whether the policy is enabled.
    */
    private ?bool $isEnabled = null;
    
    /**
     * @var CustomAppManagementConfiguration|null $restrictions Restrictions that apply to an application or service principal object.
    */
    private ?CustomAppManagementConfiguration $restrictions = null;

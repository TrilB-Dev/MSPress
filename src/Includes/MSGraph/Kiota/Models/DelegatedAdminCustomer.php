...
{
    /**
     * @var string|null $displayName The Microsoft Entra ID display name of the customer tenant. Read-only. Supports $orderby.
    */
    ...
    */
    ...
    /**
     * @var string|null $tenantId The Microsoft Entra ID-assigned tenant ID of the customer. Read-only.
    */

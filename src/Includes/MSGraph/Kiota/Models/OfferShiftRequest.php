...
{
    /**
     * @var DateTime|null $recipientActionDateTime The date and time when the recipient approved or declined the request.
    */
    private ?DateTime $recipientActionDateTime = null;
    
    /**
     * @var string|null $recipientActionMessage The message sent by the recipient regarding the request.
    */
    private ?string $recipientActionMessage = null;
    
    /**
     * @var string|null $recipientUserId The recipient's user ID.
    */
    private ?string $recipientUserId = null;
    
    /**
     * @var string|null $senderShiftId The sender's shift ID.
    */

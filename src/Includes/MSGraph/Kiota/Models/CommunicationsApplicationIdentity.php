...
{
    /**
     * @var string|null $applicationType First-party Microsoft application that presents this identity.
    */
    private ?string $applicationType = null;
    
    /**
     * @var bool|null $hidden True if the participant shouldn't be shown in other participants' rosters.
    */

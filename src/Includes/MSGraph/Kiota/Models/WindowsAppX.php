...
class WindowsAppX extends MobileLobApp implements Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $identityName The identity name of the uploaded app package. For example: 'Contoso.DemoApp'.
    */
    private ?string $identityName = null;
    
    /**
     * @var string|null $identityPublisherHash The identity publisher hash of the uploaded app package. This is the hash of the publisher from the manifest. For example: 'AB82CD0XYZ'.
    */
    private ?string $identityPublisherHash = null;
    
    /**
     * @var string|null $identityResourceIdentifier The identity resource identifier of the uploaded app package. For example: 'TestResourceId'.
    */
    private ?string $identityResourceIdentifier = null;
    
    /**
     * @var string|null $identityVersion The identity version of the uploaded app package. For example: '1.0.0.0'.
    */
    private ?string $identityVersion = null;
    
    /**
     * @var bool|null $isBundle When TRUE, indicates that the app is a bundle. When FALSE, indicates that the app is not a bundle. By default, property is set to FALSE.
    */

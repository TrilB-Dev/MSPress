...
class ObjectMappingMetadataEntry implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var ObjectMappingMetadata|null $key The possible values are: EscrowBehavior, DisableMonitoringForChanges, OriginalJoiningProperty, Disposition, IsCustomerDefined, ExcludeFromReporting, Unsynchronized.
    */
    private ?ObjectMappingMetadata $key = null;

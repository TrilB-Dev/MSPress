...
class MailboxSettings implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var DelegateMeetingMessageDeliveryOptions|null $delegateMeetingMessageDeliveryOptions If the user has a calendar delegate, this specifies whether the delegate, mailbox owner, or both receive meeting messages and meeting responses. The possible values are: sendToDelegateAndInformationToPrincipal, sendToDelegateAndPrincipal, sendToDelegateOnly.
    */
    ...
    */
    ...
    /**
     * @var UserPurpose|null $userPurpose The purpose of the mailbox. Differentiates a mailbox for a single user from a shared mailbox and equipment mailbox in Exchange Online. The possible values are: user, linked, shared, room, equipment, others, unknownFutureValue. Read-only.
    */

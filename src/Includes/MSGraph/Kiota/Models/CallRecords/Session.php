...
class Session extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isTest Specifies whether the session is a test.
    */
    private ?bool $isTest = null;
    
    /**
     * @var array<Modality>|null $modalities List of modalities present in the session. The possible values are: unknown, audio, video, videoBasedScreenSharing, data, screenSharing, unknownFutureValue.
    */

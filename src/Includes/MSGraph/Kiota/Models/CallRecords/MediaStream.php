...
class MediaStream implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var AudioCodec|null $audioCodec Codec name used to encode audio for transmission on the network. The possible values are: unknown, invalid, cn, pcma, pcmu, amrWide, g722, g7221, g7221c, g729, multiChannelAudio, muchv2, opus, satin, satinFullband, rtAudio8, rtAudio16, silk, silkNarrow, silkWide, siren, xmsRta, unknownFutureValue.
    */
    ...
    */
    ...
    /**
     * @var DateInterval|null $averageFreezeDuration Average duration of the received freezing time in the video stream.
    */
    private ?DateInterval $averageFreezeDuration = null;
    ...
    */
    ...
    /**
     * @var DateTime|null $endDateTime UTC time when the stream ended. The DateTimeOffset type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. This field is only available for streams that use the SIP protocol.
    */
    private ?DateTime $endDateTime = null;
    
    /**
     * @var bool|null $isAudioForwardErrorCorrectionUsed Indicates whether the forward error correction (FEC) was used at some point during the session. The default value is null.
    */
    private ?bool $isAudioForwardErrorCorrectionUsed = null;
    ...
    */
    ...
    /**
     * @var DateInterval|null $rmsFreezeDuration Average duration of the received freezing time in the video stream represented in root mean square.
    */
    private ?DateInterval $rmsFreezeDuration = null;
    
    /**
     * @var DateTime|null $startDateTime UTC time when the stream started. The DateTimeOffset type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. This field is only available for streams that use the SIP protocol.
    */
    ...
    */
    ...
    /**
     * @var VideoCodec|null $videoCodec Codec name used to encode video for transmission on the network. The possible values are: unknown, invalid, av1, h263, h264, h264s, h264uc, h265, rtvc1, rtVideo, xrtvc1, unknownFutureValue.
    */

...
class NetworkInfo implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $basicServiceSetIdentifier The wireless LAN basic service set identifier of the media endpoint used to connect to the network. This property isn't available if the user disables precise location sharing in their operating system or Microsoft Teams app settings.
    */
    ...
    */
    ...
    /**
     * @var string|null $macAddress The media access control (MAC) address of the media endpoint's network device. This value may be missing or shown as 02:00:00:00:00:00 due to operating system privacy policies.
    */

...
{
    /**
     * @var DateTime|null $endDateTime The date and time the time off ends in ISO 8601 format and in UTC time.
    */
    private ?DateTime $endDateTime = null;
    
    /**
     * @var DateTime|null $startDateTime The date and time the time off starts in ISO 8601 format and in UTC time.
    */

...
class ConditionalAccessGuestsOrExternalUsers implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ConditionalAccessExternalTenants|null $externalTenants The tenant IDs of the selected types of external users. Either all B2B tenant or a collection of tenant IDs. External tenants can be specified only when the property guestOrExternalUserTypes isn't null or an empty String.
    */

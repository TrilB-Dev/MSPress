...
{
    /**
     * @var DateTime|null $completionDateTime The completion date and time of the training. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $completionDateTime = null;
    
    /**
     * @var array<MicrosoftTrainingAssignmentMapping>|null $trainingAssignmentMappings The mapping details of the associated training.
    */
    private ?array $trainingAssignmentMappings = null;

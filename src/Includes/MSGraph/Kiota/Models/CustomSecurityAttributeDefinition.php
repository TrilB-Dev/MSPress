...
class CustomSecurityAttributeDefinition extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $isSearchable Indicates whether custom security attribute values are indexed for searching on objects that are assigned attribute values. Cannot be changed later.
    */

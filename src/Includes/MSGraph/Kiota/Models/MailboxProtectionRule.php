...
{
    /**
     * @var string|null $mailboxExpression Contains a mailbox expression. For examples, see mailboxExpression examples.
    */
    private ?string $mailboxExpression = null;

...
class ConditionalAccessExternalTenants implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ConditionalAccessExternalTenantsMembershipKind|null $membershipKind The membership kind. The possible values are: all, enumerated, unknownFutureValue. The enumerated member references an conditionalAccessEnumeratedExternalTenants object.
    */

...
class ResourceVisualization implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $mediaType The item's media type. Can be used for filtering for a specific type of file based on supported IANA Media Mime Types. Not all Media Mime Types are supported.
    */
    ...
    */
    ...
    /**
     * @var string|null $type The item's media type. Can be used for filtering for a specific file based on a specific type. See the section Type property values for supported types.
    */

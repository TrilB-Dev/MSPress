...
class SiteArchivalDetails implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var SiteArchiveStatus|null $archiveStatus Represents the current archive status of the site collection. Requires $select to retrieve. The possible values are: recentlyArchived, fullyArchived, reactivating, unknownFutureValue.
    */
    private ?SiteArchiveStatus $archiveStatus = null;

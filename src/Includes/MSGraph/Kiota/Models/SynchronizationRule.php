...
class SynchronizationRule implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ContainerFilter|null $containerFilter The containerFilter property
    */
    private ?ContainerFilter $containerFilter = null;
    
    /**
     * @var bool|null $editable true if the synchronization rule can be customized; false if this rule is read-only and shouldn't be changed.
    */
    private ?bool $editable = null;
    
    /**
     * @var GroupFilter|null $groupFilter The groupFilter property
    */
    ...
    */
    ...
    /**
     * @var array<StringKeyStringValuePair>|null $metadata Additional extension properties. Unless instructed explicitly by the support team, metadata values shouldn't be changed.
    */

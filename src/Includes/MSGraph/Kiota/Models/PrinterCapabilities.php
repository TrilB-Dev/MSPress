...
class PrinterCapabilities implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var array<string>|null $mediaColors The media (for example, paper) colors supported by the printer.
    */
    private ?array $mediaColors = null;
    
    /**
     * @var array<string>|null $mediaSizes The media sizes supported by the printer. Supports standard size names for ISO and ANSI media sizes. For the list of supported values, see mediaSizes values.
    */

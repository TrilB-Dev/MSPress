...
class OnlineMeetingRestricted implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var OnlineMeetingContentSharingDisabledReason|null $contentSharingDisabled Specifies the reason shared content from this participant is disabled. The possible values are: watermarkProtection, unknownFutureValue.
    */
    private ?OnlineMeetingContentSharingDisabledReason $contentSharingDisabled = null;
    ...
    */
    ...
    /**
     * @var OnlineMeetingVideoDisabledReason|null $videoDisabled Specifies the reason video from this participant is disabled. The possible values are: watermarkProtection, unknownFutureValue.
    */
    private ?OnlineMeetingVideoDisabledReason $videoDisabled = null;

...
class CloudPcOnPremisesConnection extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var CloudPcOnPremisesConnectionStatusDetail|null $healthCheckStatusDetail Indicates the results of health checks performed on the on-premises connection. Read-only. Requires $select to retrieve. For an example that shows how to get the inUse property, see Example 2: Get the selected properties of an Azure network connection, including healthCheckStatusDetail. Read-only.
    */
    private ?CloudPcOnPremisesConnectionStatusDetail $healthCheckStatusDetail = null;
    
    /**
     * @var bool|null $inUse When true, the Azure network connection is in use. When false, the connection isn't in use. You can't delete a connection that’s in use. Returned only on $select. For an example that shows how to get the inUse property, see Example 2: Get the selected properties of an Azure network connection, including healthCheckStatusDetail. Read-only.
    */
    private ?bool $inUse = null;
    
    /**
     * @var bool|null $inUseByCloudPc Indicates whether a Cloud PC is using this on-premises network connection. true if at least one Cloud PC is using it. Otherwise, false. Read-only. Default is false.
    */
    private ?bool $inUseByCloudPc = null;
    
    /**
     * @var string|null $organizationalUnit The organizational unit (OU) in which the computer account is created. If left null, the OU configured as the default (a well-known computer object container) in the tenant's Active Directory domain (OU) is used. Optional.
    */
    private ?string $organizationalUnit = null;
    
    /**
     * @var string|null $resourceGroupId The unique identifier of the target resource group used associated with the on-premises network connectivity for Cloud PCs. Required format: '/subscriptions/{subscription-id}/resourceGroups/{resourceGroupName}'
    */
    private ?string $resourceGroupId = null;
    
    /**
     * @var array<string>|null $scopeIds The scope IDs of the corresponding permission. Currently, it's the Intune scope tag ID.
    */
    private ?array $scopeIds = null;
    
    /**
     * @var string|null $subnetId The unique identifier of the target subnet used associated with the on-premises network connectivity for Cloud PCs. Required format: '/subscriptions/{subscription-id}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkId}/subnets/{subnetName}'
    */
    private ?string $subnetId = null;
    
    /**
     * @var string|null $subscriptionId The unique identifier of the Azure subscription associated with the tenant.
    */
    private ?string $subscriptionId = null;
    
    /**
     * @var string|null $subscriptionName The name of the Azure subscription is used to create an Azure network connection. Read-only.
    */
    private ?string $subscriptionName = null;
    
    /**
     * @var string|null $virtualNetworkId The unique identifier of the target virtual network used associated with the on-premises network connectivity for Cloud PCs. Required format: '/subscriptions/{subscription-id}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}'
    */
    private ?string $virtualNetworkId = null;
    
    /**
     * @var string|null $virtualNetworkLocation Indicates the resource location of the target virtual network. For example, the location can be eastus2, westeurope, etc. Read-only (computed value).
    */
    private ?string $virtualNetworkLocation = null;
    ...
    */
    public function setHealthCheckStatusDetail(?CloudPcOnPremisesConnectionStatusDetail $value): void {
        $this->healthCheckStatusDetail = $value;
    }

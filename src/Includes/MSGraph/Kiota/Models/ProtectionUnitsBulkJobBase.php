...
{
    /**
     * @var IdentitySet|null $createdBy The identity of person who created the job.
    */
    private ?IdentitySet $createdBy = null;
    
    /**
     * @var DateTime|null $createdDateTime The time of creation of the job.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var string|null $displayName The name of the protection units bulk addition job.
    */
    private ?string $displayName = null;
    
    /**
     * @var PublicError|null $error Error details containing resource resolution failures, if any.
    */
    private ?PublicError $error = null;
    
    /**
     * @var IdentitySet|null $lastModifiedBy The identity of the person who last modified the job.
    */
    private ?IdentitySet $lastModifiedBy = null;
    
    /**
     * @var DateTime|null $lastModifiedDateTime Timestamp of the last modification made to the job.
    */
    private ?DateTime $lastModifiedDateTime = null;
    
    /**
     * @var ProtectionUnitsBulkJobStatus|null $status The status property
    */
    private ?ProtectionUnitsBulkJobStatus $status = null;

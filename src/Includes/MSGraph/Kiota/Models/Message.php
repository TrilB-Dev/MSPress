...
class Message extends OutlookItem implements Parsable 
{
    ...
    */
    ...
    /**
     * @var FollowupFlag|null $flag Indicates the status, start date, due date, or completion date for the message.
    */
    ...
    */
    ...
    /**
     * @var Importance|null $importance The importance of the message. The possible values are: low, normal, and high.
    */
    private ?Importance $importance = null;
    
    /**
     * @var InferenceClassificationType|null $inferenceClassification The classification of the message for the user, based on inferred relevance or importance, or on an explicit override. The possible values are: focused or other.
    */
    ...
    */
    ...
    /**
     * @var Recipient|null $sender The account that is used to generate the message. In most cases, this value is the same as the from property. You can set this property to a different value when sending a message from a shared mailbox, for a shared calendar, or as a delegate. In any case, the value must correspond to the actual mailbox used. Find out more about setting the from and sender properties of a message.
    */
    ...
    */
    ...
    /**
     * @var ItemBody|null $uniqueBody The part of the body of the message that is unique to the current message. uniqueBody is not returned by default but can be retrieved for a given message by use of the ?$select=uniqueBody query. It can be in HTML or text format.
    */

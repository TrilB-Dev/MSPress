...
class ItemReference implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var string|null $driveId Unique identifier of the drive instance that contains the driveItem. Only returned if the item is located in a drive. Read-only.
    */
    private ?string $driveId = null;
    
    /**
     * @var string|null $driveType Identifies the type of drive. Only returned if the item is located in a drive. See drive resource for values.
    */
    private ?string $driveType = null;
    
    /**
     * @var string|null $id Unique identifier of the driveItem in the drive or a listItem in a list. Read-only.
    */
    ...
    */
    ...
    /**
     * @var string|null $path Percent-encoded path that can be used to navigate to the item. Read-only.
    */

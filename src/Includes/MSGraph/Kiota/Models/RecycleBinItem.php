...
{
    /**
     * @var DateTime|null $deletedDateTime Date and time when the item was deleted. The timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
    */
    private ?DateTime $deletedDateTime = null;
    
    /**
     * @var string|null $deletedFromLocation Relative URL of the list or folder that originally contained the item.
    */
    private ?string $deletedFromLocation = null;
    
    /**
     * @var int|null $size Size of the item in bytes.
    */

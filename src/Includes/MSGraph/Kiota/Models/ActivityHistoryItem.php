...
class ActivityHistoryItem extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var DateTime|null $expirationDateTime Optional. UTC DateTime when the activityHistoryItem will undergo hard-delete. Can be set by the client.
    */
    private ?DateTime $expirationDateTime = null;
    
    /**
     * @var DateTime|null $lastActiveDateTime Optional. UTC DateTime when the activityHistoryItem (activity session) was last understood as active or finished - if null, activityHistoryItem status should be Ongoing.
    */
    ...
    */
    ...
    /**
     * @var DateTime|null $startedDateTime Required. UTC DateTime when the activityHistoryItem (activity session) was started. Required for timeline history.
    */

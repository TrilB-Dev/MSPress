...
{
    /**
     * @var AssignedLabel|null $assignedSensitivityLabel Sensitivity label assigned to the fileStorageContainer. Read-write.
    */
    private ?AssignedLabel $assignedSensitivityLabel = null;
    
    /**
     * @var array<ColumnDefinition>|null $columns The set of custom structured metadata supported by the fileStorageContainer. Read-write.
    */
    private ?array $columns = null;
    
    /**
     * @var string|null $containerTypeId Container type ID of the fileStorageContainer. For details about container types, see Container Types. Each container must have only one container type. Read-only.
    */
    private ?string $containerTypeId = null;
    
    /**
     * @var DateTime|null $createdDateTime Date and time of the fileStorageContainer creation. Read-only.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var FileStorageContainerCustomPropertyDictionary|null $customProperties Custom property collection for the fileStorageContainer. Read-write.
    */
    private ?FileStorageContainerCustomPropertyDictionary $customProperties = null;
    
    /**
     * @var string|null $description Provides a user-visible description of the fileStorageContainer. Read-write.
    */
    private ?string $description = null;
    
    /**
     * @var string|null $displayName The display name of the fileStorageContainer. Read-write.
    */
    private ?string $displayName = null;
    
    /**
     * @var Drive|null $drive The drive of the resource fileStorageContainer. Read-only.
    */
    private ?Drive $drive = null;
    
    /**
     * @var SiteLockState|null $lockState Indicates the lock state of the fileStorageContainer. The possible values are unlocked and lockedReadOnly. Read-only.
    */
    private ?SiteLockState $lockState = null;
    
    /**
     * @var array<SharePointMigrationJob>|null $migrationJobs The collection of sharePointMigrationJob objects local to the container. Read-write.
    */
    private ?array $migrationJobs = null;
    
    /**
     * @var array<Permission>|null $permissions The set of permissions for users in the fileStorageContainer. Permission for each user is set by the roles property. The possible values are: reader, writer, manager, and owner. Read-write.
    */
    private ?array $permissions = null;
    
    /**
     * @var RecycleBin|null $recycleBin Recycle bin of the fileStorageContainer. Read-only.
    */
    private ?RecycleBin $recycleBin = null;
    
    /**
     * @var FileStorageContainerSettings|null $settings The settings property
    */
    private ?FileStorageContainerSettings $settings = null;
    
    /**
     * @var array<SharePointGroup>|null $sharePointGroups The collection of sharePointGroup objects local to the container. Read-write.
    */
    private ?array $sharePointGroups = null;
    
    /**
     * @var FileStorageContainerStatus|null $status Status of the fileStorageContainer. Containers are created as inactive and require activation. Inactive containers are subjected to automatic deletion in 24 hours. The possible values are: inactive, active. Read-only.
    */
    private ?FileStorageContainerStatus $status = null;
    
    /**
     * @var FileStorageContainerViewpoint|null $viewpoint Data specific to the current user. Read-only.
    */
    private ?FileStorageContainerViewpoint $viewpoint = null;
    ...
    */
    public function getAssignedSensitivityLabel(): ?AssignedLabel {
        return $this->assignedSensitivityLabel;
    }
    ...
    */
    public function setAssignedSensitivityLabel(?AssignedLabel $value): void {
        $this->assignedSensitivityLabel = $value;
    }

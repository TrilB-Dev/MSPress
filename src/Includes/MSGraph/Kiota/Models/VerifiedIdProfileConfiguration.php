...
class VerifiedIdProfileConfiguration implements AdditionalDataHolder, Parsable 
{
    /**
     * @var string|null $acceptedIssuer Trusted Verified ID issuer.
    */
    private ?string $acceptedIssuer = null;
    ...
    */
    ...
    /**
     * @var array<ClaimBinding>|null $claimBindings Claim bindings from Verified ID to source attributes.
    */
    private ?array $claimBindings = null;
    
    /**
     * @var ClaimBindingSource|null $claimBindingSource The claimBindingSource property
    */
    private ?ClaimBindingSource $claimBindingSource = null;
    
    /**
     * @var ClaimValidation|null $claimValidation The claimValidation property
    */
    ...
    */
    ...
    /**
     * @var string|null $type Verified ID type.
    */
    ...
    */
    public function getClaimBindingSource(): ?ClaimBindingSource {
        return $this->claimBindingSource;
    }

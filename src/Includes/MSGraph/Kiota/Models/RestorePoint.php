...
{
    /**
     * @var DateTime|null $expirationDateTime Expiration date time of the restore point.
    */
    private ?DateTime $expirationDateTime = null;
    
    /**
     * @var DateTime|null $protectionDateTime Date time when the restore point was created.
    */
    private ?DateTime $protectionDateTime = null;
    
    /**
     * @var ProtectionUnitBase|null $protectionUnit The site, drive, or mailbox units that are protected under a protection policy.
    */
    private ?ProtectionUnitBase $protectionUnit = null;

...
{
    /**
     * @var array<string>|null $accountTargetEmails List of user emails targeted for an attack simulation training campaign.
    */
    private ?array $accountTargetEmails = null;

...
{
    /**
     * @var string|null $assignedUserEmailAddress The email address of the user to whom the desk is assigned.
    */
    private ?string $assignedUserEmailAddress = null;
    
    /**
     * @var string|null $assignedUserId The user ID of the user to whom the desk is assigned.
    */
    ...
    */
    public function getAssignedUserEmailAddress(): ?string {
        return $this->assignedUserEmailAddress;
    }
    ...
    */
    public function setAssignedUserEmailAddress(?string $value): void {
        $this->assignedUserEmailAddress = $value;
    }

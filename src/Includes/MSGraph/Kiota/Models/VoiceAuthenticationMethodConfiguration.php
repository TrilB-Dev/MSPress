...
{
    /**
     * @var array<AuthenticationMethodTarget>|null $includeTargets A collection of groups that are enabled to use the authentication method. Expanded by default.
    */
    private ?array $includeTargets = null;
    
    /**
     * @var bool|null $isOfficePhoneAllowed true if users can register office phones, otherwise, false.
    */
    private ?bool $isOfficePhoneAllowed = null;

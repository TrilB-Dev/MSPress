...
class OnPremisesDirectorySynchronizationFeature implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var bool|null $allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled When true, allows on-premises directory sync clients to update the onPremisesObjectIdentifier property.
    */
    private ?bool $allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled = null;
    
    /**
     * @var bool|null $blockCloudObjectTakeoverThroughHardMatchEnabled Used to block cloud object takeover via source anchor hard match if enabled.
    */
    private ?bool $blockCloudObjectTakeoverThroughHardMatchEnabled = null;
    
    /**
     * @var bool|null $blockSoftMatchEnabled Use to block soft match for all objects if enabled for the  tenant. Customers are encouraged to enable this feature and keep it enabled until soft matching is required again for their tenancy. This flag should be enabled again after any soft matching has been completed and is no longer needed.
    */
    private ?bool $blockSoftMatchEnabled = null;
    
    /**
     * @var bool|null $bypassDirSyncOverridesEnabled When true, persists the values of Mobile and OtherMobile in on-premises AD during sync cycles instead of values of MobilePhone or AlternateMobilePhones in Microsoft Entra ID.
    */
    private ?bool $bypassDirSyncOverridesEnabled = null;
    
    /**
     * @var bool|null $cloudPasswordPolicyForPasswordSyncedUsersEnabled Used to indicate that cloud password policy applies to users whose passwords are synchronized from on-premises.
    */
    private ?bool $cloudPasswordPolicyForPasswordSyncedUsersEnabled = null;
    
    /**
     * @var bool|null $concurrentCredentialUpdateEnabled Used to enable concurrent user credentials update in OrgId.
    */
    private ?bool $concurrentCredentialUpdateEnabled = null;
    
    /**
     * @var bool|null $concurrentOrgIdProvisioningEnabled Used to enable concurrent user creation in OrgId.
    */
    private ?bool $concurrentOrgIdProvisioningEnabled = null;
    
    /**
     * @var bool|null $deviceWritebackEnabled Used to indicate that device write-back is enabled.
    */
    private ?bool $deviceWritebackEnabled = null;
    
    /**
     * @var bool|null $directoryExtensionsEnabled Used to indicate that directory extensions are being synced from on-premises AD to Microsoft Entra ID.
    */
    private ?bool $directoryExtensionsEnabled = null;
    
    /**
     * @var bool|null $fopeConflictResolutionEnabled Used to indicate that for a Microsoft Forefront Online Protection for Exchange (FOPE) migrated tenant, the conflicting proxy address should be migrated over.
    */
    private ?bool $fopeConflictResolutionEnabled = null;
    
    /**
     * @var bool|null $groupWriteBackEnabled Used to enable object-level group writeback feature for additional group types.
    */
    ...
    */
    ...
    /**
     * @var bool|null $passwordSyncEnabled Used to indicate on-premise password synchronization is enabled.
    */
    private ?bool $passwordSyncEnabled = null;
    
    /**
     * @var bool|null $passwordWritebackEnabled Used to indicate that writeback of password resets from Microsoft Entra ID to on-premises AD is enabled. This property isn't in use and updating it isn't supported.
    */
    private ?bool $passwordWritebackEnabled = null;
    
    /**
     * @var bool|null $quarantineUponProxyAddressesConflictEnabled Used to indicate that we should quarantine objects with conflicting proxy address.
    */
    private ?bool $quarantineUponProxyAddressesConflictEnabled = null;
    
    /**
     * @var bool|null $quarantineUponUpnConflictEnabled Used to indicate that we should quarantine objects conflicting with duplicate userPrincipalName.
    */
    private ?bool $quarantineUponUpnConflictEnabled = null;
    
    /**
     * @var bool|null $softMatchOnUpnEnabled Used to indicate that we should soft match objects based on userPrincipalName.
    */
    private ?bool $softMatchOnUpnEnabled = null;
    
    /**
     * @var bool|null $synchronizeUpnForManagedUsersEnabled Used to indicate that we should synchronize userPrincipalName objects for managed users with licenses.
    */
    private ?bool $synchronizeUpnForManagedUsersEnabled = null;
    
    /**
     * @var bool|null $unifiedGroupWritebackEnabled Used to indicate that Microsoft 365 Group write-back is enabled.
    */
    private ?bool $unifiedGroupWritebackEnabled = null;
    
    /**
     * @var bool|null $userForcePasswordChangeOnLogonEnabled Used to indicate that feature to force password change for a user on logon is enabled while synchronizing on-premise credentials.
    */
    private ?bool $userForcePasswordChangeOnLogonEnabled = null;
    
    /**
     * @var bool|null $userWritebackEnabled Used to indicate that user writeback is enabled.
    */
    ...
    */
    public function getAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled(): ?bool {
        return $this->allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled;
    }
    ...
    */
    public function setAllowOnPremUpdateOfOnPremisesObjectIdentifierEnabled(?bool $value): void {
        $this->allowOnPremUpdateOfOnPremisesObjectIdentifierEnabled = $value;
    }

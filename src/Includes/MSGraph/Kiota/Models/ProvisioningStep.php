...
class ProvisioningStep implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var ProvisioningStepType|null $provisioningStepType Type of step. The possible values are: import, scoping, matching, processing, referenceResolution, export, unknownFutureValue.
    */
    private ?ProvisioningStepType $provisioningStepType = null;
    
    /**
     * @var ProvisioningResult|null $status Status of the step. The possible values are: success, warning,  failure, skipped, unknownFutureValue.
    */

...
class ExternalGroup extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var array<Identity>|null $members A member added to an externalGroup. You can add Microsoft Entra users, Microsoft Entra groups, or an externalGroup as members.
    */

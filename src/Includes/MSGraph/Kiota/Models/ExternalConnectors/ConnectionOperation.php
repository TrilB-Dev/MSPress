...
use MSPress\Includes\MSGraph\Kiota\Models\PublicError;
...
class ConnectionOperation extends Entity implements Parsable 
{
    ...
    */
    ...
    /**
     * @var ConnectionOperationStatus|null $status Indicates the status of the asynchronous operation. The possible values are: unspecified, inprogress, completed, failed, unknownFutureValue.
    */

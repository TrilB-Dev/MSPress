...
class ApplicationRiskScore implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var float|null $compliance Specifies the compliance risk score based on the application's alignment with regulatory standards and industry certifications such as HIPAA, CSA, and PCI-DSS.
    */
    private ?float $compliance = null;
    
    /**
     * @var float|null $legal Specifies the legal risk score based on data protection practices, privacy policy transparency, and jurisdictional compliance to regulations and policies such as DMCA and data retention policy.
    */
    private ?float $legal = null;
    ...
    */
    ...
    /**
     * @var float|null $provider Specifies the provider risk score based on vendor credibility, operational maturity, and trustworthiness.
    */
    private ?float $provider = null;
    
    /**
     * @var float|null $security Specifies the security risk score based on authentication strength, encryption, vulnerability management, and overall security hygiene.
    */
    private ?float $security = null;
    
    /**
     * @var float|null $total Represents the composite risk score derived from all risk categories.
    */

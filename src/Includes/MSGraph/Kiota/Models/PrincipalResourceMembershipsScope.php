...
{
    /**
     * @var array<AccessReviewScope>|null $principalScopes Defines the scopes of the principals whose access to resources are reviewed in the access review. Use an accessReviewPrincipalScope object to select a well-known population of principals, such as all guest users.
    */
    private ?array $principalScopes = null;
    
    /**
     * @var array<AccessReviewScope>|null $resourceScopes Defines the scopes of the resources for which access is reviewed. Use an accessReviewResourceScope object to identify the resource, or an accessReviewAccessPackageAssignmentPolicyScope object when the resource is an access package assignment policy.
    */

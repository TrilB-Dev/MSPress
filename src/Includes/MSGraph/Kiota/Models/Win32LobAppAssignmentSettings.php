...
{
    /**
     * @var Win32LobAppAutoUpdateSettings|null $autoUpdateSettings The auto-update settings to apply for this app assignment.
    */
    private ?Win32LobAppAutoUpdateSettings $autoUpdateSettings = null;

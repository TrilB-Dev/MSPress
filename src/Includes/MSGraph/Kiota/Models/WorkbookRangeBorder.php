...
{
    /**
     * @var string|null $color The HTML color code that represents the color of the border line. Can either be of the form #RRGGBB, for example 'FFA500', or a named HTML color, for example 'orange'.
    */
    private ?string $color = null;
    
    /**
     * @var string|null $sideIndex Indicates the specific side of the border. The possible values are: EdgeTop, EdgeBottom, EdgeLeft, EdgeRight, InsideVertical, InsideHorizontal, DiagonalDown, DiagonalUp. Read-only.
    */
    private ?string $sideIndex = null;
    
    /**
     * @var string|null $style Indicates the line style for the border. The possible values are: None, Continuous, Dash, DashDot, DashDotDot, Dot, Double, SlantDashDot.
    */
    private ?string $style = null;
    
    /**
     * @var string|null $weight The weight of the border around a range. The possible values are: Hairline, Thin, Medium, Thick.
    */

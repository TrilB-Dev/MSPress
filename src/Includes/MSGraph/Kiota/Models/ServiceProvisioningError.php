...
class ServiceProvisioningError implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var DateTime|null $createdDateTime The date and time at which the error occurred.
    */
    private ?DateTime $createdDateTime = null;
    
    /**
     * @var bool|null $isResolved Indicates whether the error has been attended to.
    */
    ...
    */
    ...
    /**
     * @var string|null $serviceInstance Qualified service instance (for example, 'SharePoint/Dublin') that published the service error information.
    */
